...
run: function() {
    ...
    getRefInfo: function(h) {
        ...
        if (k = this.getParameter(h.tagParamName || "ADTAG", c.URL)) a = "ADTAG",
           d = k;
        k = e.indexOf("://");
    ...
    getExtendEnvInfo: function() {
        ...
        try {
            ...
            if (d.addBehavior) d.addBehavior("#default#clientCaps"),
               c = d.connectionType;
            h += "&ct=" + c
        } catch(f) {} finally {
            return h
    ...
    getElementPos: function(a) {
        ...
        else if (document.getBoxObjectFor) b = document.getBoxObjectFor(a),
             f = [b.x - (a.style.borderLeftWidth ? Math.floor(a.style.borderLeftWidth) : 0), b.y - (a.style.borderTopWidth ? Math.floor(a.style.borderTopWidth) : 0)];
        else {
            f = [a.offsetLeft, a.offsetTop];
            c = a.offsetParent;
            if (c != a) for (; c;) f[0] += c.offsetLeft,
               f[1] += c.offsetTop,
                   c = c.offsetParent;
            if (b.indexOf("opera") > -1 || b.indexOf("safari") > -1 && a.style.position == "absolute") f[0] -= document.body.offsetLeft,
               f[1] -= document.body.offsetTop
        }
        for (c = a.parentNode ? a.parentNode: null; c && c.tagName != "BODY" && c.tagName != "HTML";) f[0] -= c.scrollLeft,
            f[1] -= c.scrollTop,
...
var n = {
    ...
    f = {
        ...
        save: function() {
            ...
            for (var b = "",
                    c = this.sck.length,
                    f = 0; f < c; f++) b += this.sck[f] + "=" + this.sco[this.sck[f]] + "&";
...
window.pgvSendClick = function(b) { (new a(b)).sendClick()
};
window.pgvWatchClick = function(b) { (new a(b)).watchClick()
}
})();
Jx().$package("alloy.flashUploadManager",
        function(a) {
            ...
            function l() {
                for (var a = Array.prototype.slice.call(arguments), b = 0, c = a.length; b < c; b++) C.push(a[b]),
                    q(B.ADDED_TO_QUEUE, E[a[b]]);
                p()
            }
            function p() {
                var a, b;
            ...
            function r(a) {
                ...
                if (a.fileName.replace(/[^\x00-\xff]/g, "xx").length > D) return a.status = x.FAIL_VERIFY,
                   q(B.FILE_NAME_LENGTH_EXCEED_LIMIT, a, D),
                       1;
                else if (a.fileSize > b) return a.status = x.FAIL_VERIFY,
                     q(B.FILE_SIZE_EXCEED_SINGLE_LIMIT, a, b),
                         1;
                else if (a.fileSize === 0) return a.status = x.FAIL_VERIFY,
                     q(B.FILE_SIZE_ZERO, a),
                         1;
                return 0
            }
            function u(a, b, c) {
                ...
                for (e = b.length; h < e; h++) {
                    ...
                    E[f.fileId] = f;
                    if (r(f) === 0) m.push(f.fileId),
                       f._info.flashId = b[h].id,
                           f.flashInstanceId = b[h].flashInstanceId,
                               f.folderId = c.folderId,
                               K[b[h].id] = f.fileId
                }
                l.apply(this, m);
                return 0
            ...
            m.flashEventListener = function(b, c, e) {
                ...
                switch (b) {
                    ...
                    case 4:
                        ...
                        else if (k = c.res.indexOf('"code":"ok"'), k >= 0) e = !0,
                            c = a.json.parse(c.res),
                                b.ks_fileid = c.fileId,
                                    h.notifyObservers(m, "FileUploadComplete", b);
                        if (e) {
                            var A = P[f.fileId];
                            f.directUpload ? A && A.uploadSuccess() : (e = {},
                                    c = {},
                                    b.cur_size = b.size, e.obj = b, c.data = e, c.onSuccess = function(a) {
                                        if (a.retcode == 0 && a.result && a.result.code == 0) f.serverPath = f._info.file_path,
                                f._uploadedBytes = f.fileSize,
                                f.status = x.FINISHED,
                                q(B.FINISH_UPLOAD, f),
                                p(),
                                w(),
                        ...
                        } else d(B.FAIL_UPLOAD, f, x.FAIL_UPLOAD),
                           alloy.layout.alert("\u4f20\u8f93\u6587\u4ef6\u6570\u636e\u5230\u5b58\u50a8\u786c\u76d8\u5931\u8d25\uff01");
                        break;
                    case 5:
            ...
            m.checkBeforeUpload = function() {
                if (a.platform.iPad) alloy.layout.alert("\u60a8\u5f53\u524d\u4f7f\u7528\u7684\u5e73\u53f0\u6682\u4e0d\u652f\u6301\u8be5\u529f\u80fd\uff01");
                    ...
                    var b = alloy.layout.confirm('<div class="flashInstallAlert">\u9700\u8981\u5b89\u88c5<a href="http://get.adobe.com/cn/flashplayer/" target="_blank">Flash Player</a>\u624d\u80fd\u4e0a\u4f20\u6587\u4ef6\u3002</div>',
                            function() {
...
Jet().$package(function(a) {
    ...
    b.addObserver(this, "Beforedestroy",
            function() {
    ...
    b.addObserver(this._popupBox, "hide",
            function() {
                f.hideSubmenu();
    ...
    this._itemArr = [];
    this._key2Item = {};
    if (n.items) this._items_config = n.items,
       this.addItems(n.items);
    if (n.triggers) {
    ...
    n.afterShow && b.addObserver(this, "onShow", n.afterShow)
        ...
        addItems: function(a) {
            for (var b = 0,
                    c = a.length; b < c; b++) this.addItem(a[b])
        },
        refresh: function() {
            this._items_config && (this.clearItems(), this.addItems(this._items_config))
        },
        clearItems: function() {
            for (var a = this._itemArr.shift(); a;) a.destroy(),
            a = this._itemArr.shift()
        },
...
var r = a.ui.ContextMenuItem = new a.Class({
    ...
    argument: a.argument
        ...
        var w = a.ui.ContextMenuSeparator = new a.Class({
            init: function() { (this._el = c.node("li", {
...
window.onerror = function(b, c, j) {
    try {
        alloy.util.report2h("js_error", "start"),
            a.error("js\u5f02\u5e38\uff1a[\u63cf\u8ff0]:" + b + ", [Url]\uff1a" + c + ", [\u884c\u53f7]\uff1a" + j + "\r\n", "js_error")
    } catch(l) {}
    return ! 0
};
c.init = function() {
...
padEventProxy = function(a, c) {
    ...
    if (d.tagName == "IFRAME" && b) {
        ...
        if (g) {
            d = b.offsetLeft;
            for (var g = b.offsetTop,
                    l = b; l = l.offsetParent;) d += l.offsetLeft,
                g += l.offsetTop;
...
this.setPngForIE6 = function(b, c) {
    if (a.browser.ie == 6) b.style.background = "none",
...
this.formatFileSize = function(b, c) {
    for (var c = a.isUndefined(c) ? 1 : c, d = 0; b >= 1024;) b /= 1024,
        ++d;
...
this.setHomePage = function() { (!a.browser.ie && !a.browser.firefox || a.browser.ie == "9.0") && alert("\u4e0d\u597d\u610f\u601d\uff0c\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u6b64\u64cd\u4f5c\u3002");
...
function() {
    ...
    this.report = function(b) {
        for (var c = !1,
                d = "http://isdspeed.qq.com/cgi-bin/r.cgi?flag1=7723&flag2=2&flag3=1&flag4=" + alloy.portal.getUin(), e = 0; e < b.length; e++) {
                    var f = b[e];
...
s.prototype = {
    ...
    checkUrlLength: function(a, b, c) {
        ...
        e[0] > d.maxBytes && (b = {},
                b[a] = [e[0], {}], this.report(b), d.reportUrlLength[a] = [0, {}])
    },
    ...
    report: function(a) {
        ...
        b.forEach(b.queue,
                function(e) {
                    a[e] && a[e][0] && (e == "isd" ? (c = b.config.reportUrl.isd + "&flag4=" + (alloy.portal.getUin() || 0) + "&" + b.queue[e].join("&"), w(c), b.queue[e] = [], a[e] = [0, {}]) : e == "qstatic" && (b.forEach(b.queue[e],
                                function(a) {
                                    if (a == "m") {
                                        var c = [];
                                        b.forEach(b.queue[e][a],
                                            function(a, b) {
                                                c.push(b[a] + "$" + a)
                                            });
...
this.getTargetLessFormEl = function(a, b) {
    ...
    if (Object.prototype.toString.call(c.data).indexOf("String") > -1) {
        ...
        e.name = c.data;
        d.appendChild(e)
    } else for (var f in c.data) e = document.createElement("input"),
       e.type = "text",
           e.name = f,
               e.value = c.data[f],
               d.appendChild(e);
...
this.setTimingRpt = function(a, b, c, d) {
    ...
    if ((f = f ? f: window.performance) && (e = f.timing)) {
        ...
        for (var d = e[g[0]], A = 1, z = g.length; A < z; A++) f = (f = e[g[A]]) ? f - d: 0,
            f > 0 && n.push(A + "=" + f);
...
var f = function() {
    alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/time.do", {
        ...
        onError: function() {++u > 2 ? (d.notifyObservers(c.svrDate, "timeError"), l = 0) : setTimeout(f, 1E3)
        },
        onTimeout: function() {++u > 2 ? (d.notifyObservers(c.svrDate, "timeError"), l = 0) : setTimeout(f, 1E3)
        }
    })
};
c.svrDate = function() {
...
c.getLocaleTime = function(b, c) {
    var c = c || !1,
        d = new Date; ! a.isUndefined(b) && b != "" && (c && a.isNumber(b) && (b *= 1E3), d = new Date(b));
    var f = d.getFullYear(),
        e = d.getMonth() + 1,
        d = d.getDate();
    return f.toString() + "-" + (e > 9 ? e: "0" + e) + "-" + (d > 9 ? d: "0" + d) + " " + (new Date(b)).toLocaleTimeString()
}
});Jet().$package("qqweb.util.group",
    function(a) {
        var c = a.http,
    b = !1;
this.loadGroupClass = function(a, g) {
    if (b) return typeof a != "undefined" && a(g),
    !0;
...
});Jet().$package("qqweb.util.loclist",
    function(a) {
        var c = a.http,
    b = !1;
...
var g = a.browser.version,
    ...
    l; (l = j.match(/Maxthon[\s|\/]([\d.]*)/)) ? (d = "maxthon", g = l[1] ? c(l[1]) : 0) : j.match(/TheWorld/) ? (d = "theworld", g = 0) : (l = j.match(/SE\s([\d.]*)/)) ? (d = "sougou", g = l[1] ? c(l[1]) : 0) : (l = j.match(/QQBrowser\/([\d.]*)/)) ? (d = "qq", g = l[1] ? c(l[1]) : 0) : (l = j.match(/TencentTraveler\s([\d.]*)/)) ? (d = "tt", g = l[1] ? c(l[1]) : 0) : j.match(/360SE/) && (d = "360", g = 0);
d = {
    name: d,
    version: g
};
...
this.add2SetupAppList = function(e) {
    if (e.flag == 4 && alloy.portal.getPortalSelf("vipInfo") <= 0) return alloy.layout.confirm('                <div style="margin-top:25px;margin-left:50px;">                <img style="float:left;" src="' + qqweb.CONST.CDN_URL_0 + 'style/images/yellow_warning.png" alt="\u60a8\u8fd8\u672a\u5f00\u901a\u4f1a\u5458"/>                <div style="width:180px;height:60px; font-size:14px;float:left;margin-left:5px;">\u5bf9\u4e0d\u8d77\uff01\u60a8\u8fd8\u4e0d\u662fQQ\u4f1a\u5458\uff0c\u4e0d\u80fd\u4f18\u5148\u4f53\u9a8c\u4f1a\u5458\u4e13\u5c5e\u5e94\u7528</div >                </div>                ',
            function() {
       ...
       !1;
    if (c.getSetupAppList().length >= 200) return qqweb.layout.alert("\u5e94\u7528\u6dfb\u52a0\u91cf\u6700\u591a\u4e3a200\u4e2a,\u8bf7\u5220\u51cf\u90e8\u5206\u5e94\u7528\u540e\u518d\u6dfb\u52a0\u3002"),
       !1;
    else if (!c.isInSetupAppList(e.id) && !d.id("appAlert_category_select_" + e.id)) return a.profile("add2SetupAppList"),
         qqweb.appconfig.addAppConfig(e),
             c.getSetupAppList().unshift(e.id),
                 x(),
                 b.notifyObservers(c, "AddSetupAppList", e),
                 e.id < 1E5 && alloy.util.report2app("appbar|menu|addapp|" + e.id),
                 !0
};
...
this.removeSetupAppList = function(e, d, f) {
    ...
    if (e.cannotUninstall) return alloy.layout.alert("\u62b1\u6b49\uff0c\u6b64\u5e94\u7528\u3010" + e.appName + "\u3011\u4e0d\u80fd\u5220\u9664\uff01"),
       !1;
...
this.removeFromRunStatusList = function(b, e) {
    if (this.configList.runStatus) {
        ...
        for (var g in b) h = b[g],
            d[h] && (d[h] = null, delete d[h], f = !0);
        f && !e && (d = {
            data: {
                retype: 1,
          r: {
...
this.restoreConfig = function(a) {
    ...
    if (a.appConfig) e = !0,
       d.setupAppList = f,
           b.notifyObservers(c, "RestoreAppList");
    if (a.theme) e = !0,
       d.theme = l.id,
           d.wallpaper = p,
               d.appearance = t;
    if (a.desktopSetting) e = !0,
       d.dockLoca = "left",
           d.navTop = 1,
               d.defaultScreen = 3;
...
var A = function(a, e, d, h) {
    var k = e.items ? e.items: e.items = []; ! f(d) && d !== -1 ? k.splice(d, 0, a) : (k.push(a), d = k.length - 1);
...
this.deleteFile = function(a, b, c, e, d, k) {
    ...
    var q, y = !1;
    if (f(b)) {
        if (a = this.getFileInfoByFile(a)) y = a.file,
            q = a.parent,
                c = a.position
    } else if (q = this.getFolderById(b), f(c)) {
        if (a = this.getFileInfoByFile(a, q, !1)) y = a.file,
            q = a.parent,
                c = a.position
    } else y = q.items[c];
    if (q && y) {
...
this.isFileNameAvailable = function(a, b, e) {
    var f = "\u6587\u4ef6\u5939";
    b == g.FILE && (f = "\u6587\u4ef6");
    if (a.replace(/[\\/: *?"<>|]/g,"")!=a)return f+'\u540d\u79f0\u4e0d\u80fd\u5305\u542b\\/:*?" < >|\u7b49\u7279\u6b8a\u5b57\u7b26 ';if(a.replace(/\s/g,"")=="")return f+"\u540d\u79f0\u4e0d\u80fd\u53ea\u5305\u542b\u7a7a\u5b57\u7b26";else if(d.byteLength(a)>48)return f+"\u540d\u79f0\u8fc7\u957f\uff08\u5b57\u6570\u6700\u591a\u4e3a24\u4e2a\u6c49\u5b57\u621648\u4e2a\u5b57\u7b26\uff09";else if(c.isFileNameExist(a,b,e))return f+"\u540d\u79f0\u6709\u51b2\u7a81\uff0c\u8bf7\u8f93\u5165\u65b0\u7684\u540d\u79f0";
                return 0};this.getDefaultFolderName=function(){for(var a="\u6587\u4ef6\u5939",b=2;b<p;++b){if(!alloy.fileSystem.isFileNameExist(a,g.FOLDER))break;a="\u6587\u4ef6\u5939"+b+""}b==p&&(a=+new Date);return a};this.updateFile=function(a,b,c){h()&&(b=!1);var e=this.getFileInfoByFile(a);if(!e)return!1;a.on=e.file.n;if(b)P([a],e.parent.id,null,{fileList:[a],parent:e.parent});else return q(a,c)};this.updateFiles=function(a,b,c,e){h()&&(c=!1);var d=this.getFolderById(b);if(d)if(c)P(a,b,null,{fileList:a,parent:d});
                    else for(var f in a)this.updateFile(a[f],!1,e);else return!1};var C=function(b){if(alloy.portal.getLoginLevel()!=alloy.CONST.LOGIN_LEVEL_NONE){var b=b||{},c=b.data||{};c.vfwebqq=alloy.portal.getVfWebQQ();for(var e in c)if(a.isObject(c[e])||a.isArray(c[e]))c[e]=a.json.stringify(c[e]);b.data=c;b.method=b.method||"GET";b.onError=b.onError||H.onRequestError;b.onTimeout=b.onTimeout||H.onRequestTimeout;alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL+"cgi/top/"+b.action,b)}},E=function(a,e,d,h,k,q){!q&&
                        r?b.notifyObservers(c,"FileProcessing",a):(r=!0,e={objs:a,pid:e,ti:d<0?0:d},k=k||{},k.noProcessStatus=f(k.noProcessStatus)?q:k.noProcessStatus,k={data:e,arguments:k},k.onSuccess=h||H.onAddFileSuccess,k.onError=H.onAddFileError,k.onTimeout=H.onAddFileTimeout,k.action="create",k.method="POST",C(k),I(a,"create"))},G=function(a,e,d,h,k){if(!k&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var q=[],y;for(y in a){var m=a[y];if(!k&&Q(m,!0))return;q.push({t:m.t,id:m.id})}e={did:e,objs:q};h=h||{};h.noProcessStatus=
                            f(h.noProcessStatus)?k:h.noProcessStatus;h={data:e,arguments:h};h.onSuccess=d||H.onDeleteFileSuccess;h.action="remove";h.method="POST";C(h);I(a,"del")}},K=function(a,e,d,h,k,q,y,m){if(!m&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var g=[],z;for(z in a){var n=a[z];if(!m&&Q(n,!0))return;g.push({t:n.t,id:n.id})}y=y||{};y.noProcessStatus=f(y.noProcessStatus)?m:y.noProcessStatus;y={arguments:y};if(e==h)y.action="order",y.data={did:h,from:k,to:d,count:g.length};else if(y.action="move",y.data=
                                {objs:g,did:h,tid:e,ti:d<0?0:d},e===5)y.data.limit=5,y.data.ofd=h;y.onSuccess=q||H.onMoveFileSuccess;y.method="POST";C(y);I(a,"move")}},P=this.sendUpdateFiles=function(a,e,d,h,k){if(!k&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var y=[],q;for(q in a){var m=a[q];if(!k&&Q(m,!0))return;var g={t:m.t,id:m.id,n:m.n};if(!f(m.n))g.n=m.n,g.on=m.on;y.push(g)}e={did:e,objs:y};h=h||{};h.noProcessStatus=f(h.noProcessStatus)?k:h.noProcessStatus;h={data:e,arguments:h};h.onSuccess=d||H.onUpdateFileSuccess;
                                                                                                                                                                                                                                                                            h.action="modify";h.method="POST";C(h);I(a,"modify")}};this.sendUpdateProgress=function(a){a.action="update_progress";a.method="POST";C(a)};var J=this.sendCopyFile=function(a){a.action="copy_file";a.method="POST";C(a)};this.sendFileMove=function(a){a.action="file_move";a.method="POST";C(a)};var N=this.sendGetFolderItem=function(a){a.action="get_folder";a.method="POST";C(a)},I=function(a,b){var c=a[0];c.t==g.FOLDER?alloy.util.report2qqweb("file|"+b+"|folder"):c.t==g.APP?alloy.util.report2qqweb("file|"+
                                                                                                                                                                                                                                                                                b+"|app"):(c.t==g.BUDDY||c.t==g.GROUP)&&alloy.util.report2qqweb("file|"+b+"|contact")},V=function(){alloy.util.report2h("get_file_system","start");a.profile("getDesktopStart");typeof progress=="function"&&progress("get_file_system start");var b=0,c="pc";a.platform.iPad?c="pad":window.webTop&&(c="air");var e={onSuccess:H.onGetFileSystemConfigSuccess,context:this,data:{from:c},onError:function(){alloy.util.report2m(151396);alloy.util.report2qqweb("config|file|error");a.error("getDesktopError");typeof progress==
                                                                                                                                                                                                                                                                                    "function"&&progress("get_file_system error",0);b==0?(O(e),b++):timeoutConfirm("\u8bfb\u53d6\u6587\u4ef6\u4fe1\u606f\u51fa\u9519\uff0c\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002")||(s=!0,alloy.config.offlineSetupAppList(),L())},onTimeout:function(){alloy.util.report2m(151395);alloy.util.report2qqweb("config|file|timeout");a.error("getDesktopTimeout");typeof progress=="function"&&progress("get_file_system timeout",0);b==0?(O(e),
                                                                                                                                                                                                                                                                                        b++):timeoutConfirm("\u8bfb\u53d6\u6587\u4ef6\u4fe1\u606f\u8d85\u65f6\uff0c\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002")||(s=!0,alloy.config.offlineSetupAppList(),L())}};O(e)},O=function(a){a.action="get_desk";a.method="GET";C(a)},H={onBeforeGetUAC:function(){t=!1},onSimpleUACReady:function(a){a.uacLoaded?(s=!0,w=!1):(s=!1,w=!0);w&&alloy.portal.getLoginLevel()>alloy.CONST.LOGIN_LEVEL_NONE?alloy.config.isNewUser?(alloy.config.restoreConfig({appConfig:1}),
                                                                                                                                                                                                                                                                                            L()):V():(s=!0,L())},onGetFileSystemConfigSuccess:function(b){if(b&&b.retcode==0)if(alloy.util.report2h("get_file_system","end","ok"),a.profile("getDesktopSuccess"),b=b.result.values,f(b)||alloy.config.setDesktopList(b),b=alloy.config.getDesktopList(),b.length<5)alloy.util.report2m(151401),a.error("getDesktopFail : desktop data part missing"),timeoutConfirm("\u8bfb\u53d6\u5230\u7684\u684c\u9762\u6570\u636e\u90e8\u5206\u6570\u636e\u4e22\u5931, \u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002")||
                                                                                                                                                                                                                                                                                                (s=!0,alloy.config.offlineSetupAppList(),alloy.config.setDesktopList(alloy.config.getDefaultDesktopList()),L());else{var c=0,e;for(e in b)b[e].items&&b[e].items.length&&(c+=b[e].items.length);c?(w&&(s=!1),L()):(alloy.util.report2m(151398),a.error("getDesktopFail : empty desktop"),timeoutConfirm("\u8bfb\u53d6\u5230\u7684\u684c\u9762\u6570\u636e\u4e0d\u6b63\u786e, \u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002")||(s=!0,alloy.config.offlineSetupAppList(),
                                                                                                                                                                                                                                                                                                        alloy.config.setDesktopList(alloy.config.getDefaultDesktopList()),L()))}else alloy.util.report2m(151397),alloy.util.report2h("get_file_system","end","error"),a.error("getDesktopFail : retcode="+b.retcode),timeoutConfirm("\u8bfb\u53d6\u684c\u9762\u6570\u636e\u51fa\u9519\uff0c\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002")||(s=!0,alloy.config.offlineSetupAppList(),L())},onAddSetupAppList:function(a){var b=a.folderId;c.getFolderById(b);
                                                                                                                                                                                                                                                                                                            c.addFile({t:g.APP,id:a.id},b,-1,!0)},onRemoveSetupAppList:function(a){c.deleteFile({t:g.APP,id:a.id},null,null,!1,!a.noSave)},onRestoreAppList:function(){var a=alloy.config.getDefaultDesktopList(),b=[g.APP,g.BUDDY,g.GROUP,g.FOLDER,g.FILE],c=[],e;for(e in a)c.push(a[e].items);C({data:{objects:c,types:b},onSuccess:void 0,action:"reset",method:"POST"})},onRequestError:function(e){r=!1;var d=e.arguments.fileList,f;for(f in d)Q(d[f],!1);a.error("FileOperateError");e.arguments.noProcessStatus||b.notifyObservers(c,
                                                                                                                                                                                                                                                                                                                "FileOperateError",e.arguments)},onRequestTimeout:function(e){r=!1;var d=e.arguments.fileList,f;for(f in d)Q(d[f],!1);a.error("FileOperateTimeout");e.arguments.noProcessStatus||b.notifyObservers(c,"FileOperateTimeout",e.arguments);d=e.arguments;delete e.arguments;alloy.rpcService.sendFileErrorReport({request:d,response:e})},onAddFileError:function(e){a.error("AddFileError");r=!1;e.arguments.noProcessStatus||b.notifyObservers(c,"FileOperateError",e.arguments)},onAddFileTimeout:function(e){a.error("AddFileTimeout");
                                                                                                                                                                                                                                                                                                                    r=!1;e.arguments.noProcessStatus||b.notifyObservers(c,"FileOperateTimeout",e.arguments);var d=e.arguments;delete e.arguments;alloy.rpcService.sendFileErrorReport({request:d,response:e})},onAddFileSuccess:function(e){r=!1;if(e.retcode==0&&e.result&&e.result.code==0){var d=e.result.objs||[],e=e.arguments,h=f(e.position)?e.parent.items.length:e.position,k;for(k in d){var y=d[k];if(y.t==g.FILE)y.upload=1;A(y,e.parent,h);h+=1;a.isFunction(e.callback)&&e.callback(y)}}else a.error("AddFileFail"),e.arguments.noProcessStatus||
                                                                                                                                                                                                                                                                                                                        b.notifyObservers(c,"AddFileFail",e),e.arguments.fileList&&e.arguments.fileList[0]&&(y=e.arguments.fileList[0],y.t==g.FOLDER?alloy.util.report2m(151383):y.t==g.APP?alloy.util.report2m(151387):(y.t==g.BUDDY||y.t==g.GROUP)&&alloy.util.report2m(151391)),d=e.arguments,delete e.arguments,alloy.rpcService.sendFileErrorReport({request:d,response:e})},onDeleteFileSuccess:function(e){r=!1;if(e.retcode==0&&e.result&&e.result.code==0){var e=e.arguments,d=e.fileList,f;for(f in d){var h=d[f];Q(h,!1);z(h,e.parent,
                                                                                                                                                                                                                                                                                                                            e.position,e.isCascade)}}else a.error("DeleteFileFail"),F(e.arguments.fileList,!1),e.arguments.noProcessStatus||b.notifyObservers(c,"DeleteFileFail",e.arguments),e.arguments.fileList&&e.arguments.fileList[0]&&(h=e.arguments.fileList[0],h.t==g.FOLDER?alloy.util.report2m(151385):h.t==g.APP?alloy.util.report2m(151389):(h.t==g.BUDDY||h.t==g.GROUP)&&alloy.util.report2m(151393)),f=e.arguments,delete e.arguments,alloy.rpcService.sendFileErrorReport({request:f,response:e})},onMoveFileSuccess:function(e){r=
                                                                                                                                                                                                                                                                                                                                !1;if(e.retcode==0&&e.result&&e.result.code==0){var e=e.arguments,d=e.fileList,f=e.targetFolder.id,h;for(h in d){var k=d[h];Q(k,!1);f==5&&f!=e.sourceFolder.id&&T(!1);v(k,e.targetFolder,e.targetPosition,e.sourceFolder,e.sourcePosition)}}else a.error("MoveFileFail"),F(e.arguments.fileList,!1),e.arguments.noProcessStatus||b.notifyObservers(c,"MoveFileFail",e.arguments),e.arguments.fileList&&e.arguments.fileList[0]&&(k=e.arguments.fileList[0],k.t==g.FOLDER?alloy.util.report2m(151384):k.t==g.APP?alloy.util.report2m(151388):
                                                                                                                                                                                                                                                                                                                                    (k.t==g.BUDDY||k.t==g.GROUP)&&alloy.util.report2m(151392)),h=e.arguments,delete e.arguments,alloy.rpcService.sendFileErrorReport({request:h,response:e})},onCopyFileSuccess:function(a){if(a.retcode==0&&a.result&&a.result.code==0){var e=a.arguments,a=a.result.objs,d;for(d in a){var f=a[d];Q(f,!1);alloy.storage.useSpace(f.s,f.size);A(f,e.parent,null,null)}}else F(a.arguments.fileList,!1),a.arguments.noProcessStatus||b.notifyObservers(c,"CopyFileFail",a.arguments),e=a.arguments,delete a.arguments,alloy.rpcService.sendFileErrorReport({request:e,
                                                                                                                                                                                                                                                                                                                                        response:a})},onGetFolderItemSuccess:function(a){a.retcode==0&&a.result&&a.result.code==0?b.notifyObservers(c,"GetFolderItemSuccess",a):b.notifyObservers(c,"GetFolderItemFail",a)},onCleanFilesSuccess:function(a){if(a.retcode==0&&a.result&&a.result.code==0){var e=j[g.FILE],d;for(d in e){var f=e[d];f.s===a.arguments.provider&&c.deleteFile(f,null,null,null,!1,!1)}b.notifyObservers(c,"CleanFilesSuccess",a.arguments.provider)}else alloy.layout.alert("\u89e3\u9664\u7ed1\u5b9a\u5931\u8d25\uff01")},onUpdateFileSuccess:function(e){r=
                                                                                                                                                                                                                                                                                                                                            !1;if(e.retcode==0&&e.result&&e.result.code==0){var e=e.arguments.fileList,d;for(d in e){var f=e[d];Q(f,!1);q(f)}}else a.error("UpdateFileFail"),F(e.arguments.fileList,!1),e.arguments.noProcessStatus||b.notifyObservers(c,"UpdateFileFail",e.arguments),e.arguments.fileList&&e.arguments.fileList[0]&&(f=e.arguments.fileList[0],f.t==g.FOLDER?alloy.util.report2m(151386):f.t==g.APP?alloy.util.report2m(151390):(f.t==g.BUDDY||f.t==g.GROUP)&&alloy.util.report2m(151394)),d=e.arguments,delete e.arguments,alloy.rpcService.sendFileErrorReport({request:d,
                                                                                                                                                                                                                                                                                                                                                response:e})}},T=function(a){var b=alloy.fileSystem.getFolderById(5);if(b.items.length>=5)for(var e=alloy.desktopManager.getCurrentDesktopIndex(),b=b.items;b.length>=5;){var d=b.length-1;c.moveFile(b[d],e,null,5,d,!!a)}},Q=function(a,e){if(e){if(a.processing)return b.notifyObservers(c,"FileProcessing",a),!0;a.processing=!0;b.notifyObservers(c,"FileBeforeProcess",a)}else delete a.processing,b.notifyObservers(c,"FileProcessed",a)},F=function(b,e){if(a.isArray(b))for(var c in b)Q(b[c],e);else Q(b,e)},
                                                                                                                                                                                                                                                                                                                                            L=function(){m();j={};j[g.FOLDER]={};j[g.FILE]={};j[g.APP]={};j[g.BUDDY]={};j[g.GROUP]={};l={};l[g.FOLDER]=0;l[g.FILE]=0;l[g.APP]=0;l[g.BUDDY]=0;l[g.GROUP]=0;e();h()||y();t=!0;b.notifyObservers(c,"FileSystemReady");b.notifyObservers(alloy.portal,"UACReady")},S=[],W=function(){},M=function(b){r=!1;if(!(b.retcode==0&&b.result&&b.result.code==0)){a.error("AddFileFail");var e=b.arguments;delete b.arguments;alloy.rpcService.sendFileErrorReport({request:e,response:b})}},U=function(a){S.push(a)},X=function(){for(var a;a=
                                                                                                                                                                                                                                                                                                                                                    S.shift();)setTimeout(a,500)},y=function(){var b=alloy.config.getSetupAppList(),e=alloy.config.configList.defaultScreen,e=f(e)?2:e-1,d=c.getFolderById(e),h=c.getFolderById(5),k=[],y,q=!1,m=alloy.config.getMustInstallAppList(),z;for(z in m){var n=Number(z);alloy.config.isInSetupAppList(n)||(q=!0,y={t:g.APP,id:n},b.push(n),c.getFileByFile(y)||(k.push(y),c.addFile(y,5,0,!1,!0)))}if(q&&(a.profile("forceInstallApp"),alloy.config.sendSetSetupAppList(),k.length)){var x=h.items.length,F=k.concat();U(function(){E(F,
                                                                                                                                                                                                                                                                                                                                                        5,x,M,{fileList:F},!0)})}k=[];if(h.items.length>5)for(y=h.items;y.length>5;)n=y.length-1,k.push(y[n]),c.moveFile(y[n],e,null,5,n,!1,!0);if(k.length&&(a.profile("checkDock"),!q)){var ia=k.concat();U(function(){K(ia,e,0,5,null,W,{fileList:ia},!0)})}k=[];q=c.getFilesByType(g.APP);for(z in b)q[b[z]]||(y={t:g.APP,id:b[z]},k.push(y));if(k.length){a.profile("addMissApp");c.addFiles(k,e,-1,!1,!0);var v=k.concat(),o=d.items.length;U(function(){E(v,e,o,M,{fileList:v},!0)})}var d={},k=!1,j;for(j in q)if((n=
                                                                                                                                                                                                                                                                                                                                                            Number(q[j].id))&&a.array.indexOf(b,n)==-1)k=!0,y=q[j],z=c.getFileInfoByFile(y),d[z.parent.id]||(d[z.parent.id]={}),d[z.parent.id][y.id]=y,c.deleteFile(y,null,null,!1,!1,!0);if(k){a.profile("removeSurplusApp");for(var l in d){b=[];j=Number(l);for(var r in d[l])b.push(d[l][r]);U(a.bind(function(a){G(a.fileList,a.folderId,W,null,!0)},c,{fileList:b,folderId:j}))}}X()};this.createRecentContactFolder=function(a){if(!h()){var b=c.getFolderByName("\u5e38\u7528\u8054\u7cfb\u4eba");if(b){if(a.length){var e=
                                                                                                                                                                                                                                                                                                                                                                16-b.items.length;a.length>e&&a.splice(e);c.addFiles(a,b.id,null,!1);E(a,b.id,0,M,null,!0)}alloy.config.setPortalConfig("hasRecentFolder",1)}else b={t:g.FOLDER,n:"\u5e38\u7528\u8054\u7cfb\u4eba"},c.createFile(b,alloy.config.configList.defaultScreen-1,null,function(b){alloy.config.setPortalConfig("hasRecentFolder",1);a.length&&(c.addFiles(a,b.id,null,!1),E(a,b.id,0,M,null,!0))},!0)}};this.isFileSystemReady=function(){return t};this.init=function(){b.addObserver(alloy.portal,"SimpleUACReady",H.onSimpleUACReady);
                                                                                                                                                                                                                                                                                                                                                                    b.addObserver(alloy.config,"BeforeGetUAC",H.onBeforeGetUAC);b.addObserver(alloy.config,"AddSetupAppList",H.onAddSetupAppList);b.addObserver(alloy.config,"RemoveSetupAppList",H.onRemoveSetupAppList);b.addObserver(alloy.config,"RestoreAppList",H.onRestoreAppList)}});
                                                                                                                                                                                                                                                                                                                                                                    Jx().$package("alloy.storage.rpcService",function(a){var c={onRequestError:function(){},onRequestTimeout:function(){}},b=function(b){if(alloy.portal.getLoginLevel()!=alloy.CONST.LOGIN_LEVEL_NONE){var b=b||{},g=b.data||{};g.vfwebqq=alloy.portal.getVfWebQQ();for(var j in g)if(a.isObject(g[j])||a.isArray(g[j]))g[j]=a.json.stringify(g[j]);b.data=g;b.method=b.method||"GET";b.onError=b.onError||c.onRequestError;b.onTimeout=b.onTimeout||c.onRequestTimeout;alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL+
                                                                                                                                                                                                                                                                                                                                                                                "cloud/cs/"+b.action,b)}};this.copyFile=function(a){a.action="copy_file";a.method="POST";b(a)};this.fileMove=function(a){a.action="file_move";a.method="POST";b(a)};this.createUser=function(a){a.action="create_user";a.method="POST";b(a)};this.fileRename=function(a){a.action="file_rename";a.method="POST";b(a)};this.createDir=function(a){a.action="create_dir";a.method="POST";b(a)};this.fileContUpload=function(){};this.queryUser=function(a){a.action="query_user";a.method="POST";b(a)};this.fileRemove=
                                                                                                                                                                                                                                                                                                                                                                        function(a){a.action="file_remove";a.method="POST";b(a)};this.queryFile=function(){};this.fileUpload=function(a){a.action="file_upload";a.method="POST";b(a)};this.fileDownload=function(a){a.action="file_download";b(a)};this.updateFileLength=function(){};this.getHomeKey=function(){};this.queryDir=function(a){a.action="query_dir";a.method="POST";b(a)};this.checkPassword=function(a){a.action="check_pass";a.method="POST";b(a)}});
                                                                                                                                                                                                                                                                                                                                                                    Jx().$package("alloy.storage",function(a){var c=this,b=alloy.storage.rpcService,d=a.event,g=a.dom,d=a.event,j=a.string,l=null,p=[],t=[],r=this.DISK={QQDISK:"qqdisk",KINGSOFT:"kingsoft"},u=c.diskConfig={qqdisk:{id:0,key:r.QQDISK,icon:"./module/diskexplorer/images/qqdisk.png",name:"QQ\u7f51\u76d8",userUsedSpace:0,userTotalSpace:1073741824,isPwdOpen:0,isLocked:0,dataReady:!1},kingsoft:{id:1,key:r.KINGSOFT,icon:"./module/diskexplorer/images/kingsoft.png",name:"\u91d1\u5c71\u5feb\u76d8",userUsedSpace:0,
                                                                                                                                                                                                                                                                                                                                                                        userTotalSpace:5368709120,isPwdOpen:0,isLocked:0,dataReady:!1}},w=[];(function(){var a,b=0;for(a in u)u.hasOwnProperty(a)&&(w[b++]=u[a])})();this.getTotalUsedSpace=function(){for(var a=0,b=0;b<p.length;b++)a+=u[p[b]].userUsedSpace;return a};this.getTotalSpace=function(){for(var a=0,b=0;b<p.length;b++)a+=u[p[b]].userTotalSpace;return a};this.getTotalSpaceById=function(a){if(a==r.QQDISK)switch(alloy.portal.getPortalSelf().vip){case 1:return 3221225472;case 2:return 4294967296;case 3:return 5368709120;
                                                                                                                                                                                                                                                                                                                                                                            case 4:return 6442450944;case 5:return 7516192768;case 6:return 8589934592;case 7:return 10737418240;default:return 1073741824}else if(a==r.KINGSOFT)return 5368709120};this.getFreeSpaceById=function(a){return u[a].userTotalSpace-u[a].userUsedSpace};this.getDiskById=function(a){return u[a]};this.getBoundDisk=function(){return p};this.addBoundDisk=function(b){a.array.indexOf(p,b)<0&&p.push(b);t=this.getUnBoundDisk()};this.removeBoundDisk=function(b){a.array.remove(p,b);t=this.getUnBoundDisk()};this.sendSetBoundDisk=
                                                                                                                                                                                                                                                                                                                                                                                   function(a){alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{diskList:a}}}})};this.getUnBoundDisk=function(){t=[];for(var a={},b=0;b<p.length;b++)a[p[b]]=1;for(b=0;b<w.length;b++)a[w[b].key]||t.push(w[b].key);return t};this.setDefaultDisk=function(a){l=a};this.sendSetBoundAndDefaultDisk=function(a,b){a=a||alloy.storage.getBoundDisk();b=b||l;alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{defaultDisk:b,diskList:a}}}})};this.getDefaultDisk=function(){l=l||"qqdisk";return u[l]};this.useSpace=
                                                                                                                                                                                                                                                                                                                                                                        function(b,h){a.isNumber(h)&&(u[b].userUsedSpace+=h,d.notifyObservers(c,"StorageSpaceChanged",b))};this.releaseSpace=function(b,h){if(a.isNumber(h))u[b].userUsedSpace-=h,u[b].userUsedSpace=u[b].userUsedSpace>0?u[b].userUsedSpace:0,d.notifyObservers(c,"StorageSpaceChanged",b)};this.receiveFile=function(b){b.cookie_name&&a.cookie.set(b.cookie_name,b.cookie_value,alloy.CONST.MAIN_DOMAIN,"",0.5);var c=g.id("fs_download");if(typeof c=="undefined"||c==null)c=document.createElement("IFRAME"),c.id="fs_download",
                                                                                                                                                                                                                                                                                                                                                                            c.name="fs_download",c.src=alloy.CONST.MAIN_URL+"domain.html",c.style.display="none",document.body.appendChild(c);c.src=b.url};this.fileDownload=function(a,d){b.fileDownload({data:{target:d,obj:a},onSuccess:function(a){a.retcode==0&&a.result&&a.result.code==0&&c.receiveFile(a.result)}})};this.fileView=function(c,d){b.fileDownload({data:{target:d,obj:c},onSuccess:function(b){if(b.retcode==0&&b.result&&b.result.code==0){var d=a.extend({},c,b.result,b.result.obj);alloy.fileSystem.openFile(d,b.result.url)}}})};
                                                                                                                                                                                                                                                                                                                                                                    this.openFile=function(a,b){var c=alloy.util.getFileExt(a.n).toLowerCase();alloy.system.isOpenFile(c)&&this.fileView(a,b)};this.createFile=function(a,h){var g=this.getExplorerInstance(),n=g.getCurFolder(),j=g.getCurDisk(),g=a.fileSize;alloy.storage.getFreeSpaceById(j)<g?alloy.storage.storageFullAlert(j):(n={target:j,file:{t:alloy.fileSystem.FILE_TYPE.FILE,n:a.fileName,size:g,md5:"",sha:""},parent:n},n.parent=="root"&&delete n.parent,b.fileUpload({data:n,onSuccess:function(a){a.retcode==0&&a.result&&
                                                                                                                                                                                                                                                                                                                                                                        a.result.code==0?(a=a.result.obj,a.upload=1,c.useSpace(j,a.size),d.notifyObservers(c,"ExplorerFileAdd",a),h&&h(a)):a.retcode==0&&a.result&&a.result.code==30001?alloy.storage.storageFullAlert():alloy.layout.alert("\u4e0a\u4f20\u6587\u4ef6\u5931\u8d25\uff01")}}))};this.createDir=function(){var a={},b={},g=this.getExplorerInstance();a.target=g.getCurDisk();a.obj=g.getCurFolder();a.obj=="root"&&delete a.obj;b.data=a;b.onSuccess=function(a){a.retcode==0&&a.result&&a.result.code==0?d.notifyObservers(c,
                                                                                                                                                                                                                                                                                                                                                                    "ExplorerFileAdd",a.result.obj):alloy.layout.alert("\u521b\u5efa\u6587\u4ef6\u5939\u5931\u8d25\uff01")};alloy.storage.rpcService.createDir(b)};var s=function(a){if(a.replace(/[\\/:*?"<>|]/g,"")!=a)return'\u540d\u79f0\u4e0d\u80fd\u5305\u542b\\ / :*?"<>|\u7b49\u7279\u6b8a\u5b57\u7b26';else if(j.byteLength(a)>48)return"\u6587\u4ef6\u5939\u540d\u79f0\u8fc7\u957f\uff08\u5b57\u6570\u6700\u591a\u4e3a24\u4e2a\u6c49\u5b57\u621648\u4e2a\u5b57\u7b26\uff09 ";return 0};this.fileRename=function(a,b){var g=s(b);if(g==
                                                                                                                                                                                                                                                                                                                                                                        0){var g={},n={},j=this.getExplorerInstance();g.target=j.getCurDisk();a.n=b;g.obj=a;n.data=g;n.arguments={obj:a};n.onSuccess=function(a){a.retcode==0&&a.result&&a.result.code==0?d.notifyObservers(c,"ExplorerFileRename ",a.arguments.obj):a.result.code==33333?alloy.layout.alert("\u7cfb\u7edf\u6587\u4ef6\u5939\u4e0d\u5141\u8bb8\u91cd\u547d\u540d "):alloy.layout.alert("\u91cd\u547d\u540d\u5931\u8d25\uff01 ")};alloy.storage.rpcService.fileRename(n)}else alloy.layout.alert(g,null,{title:"\u91cd\u547d\u540d "})};
                                                                                                                                                                                                                                                                                                                                                                            this.fileRemove=function(a){var b={},g={},n=this.getExplorerInstance().getCurDisk();b.obj=a;b.target=n;g.data=b;g.arguments={obj:a};g.onSuccess=function(a){a.retcode==0&&a.result&&a.result.code==0?(a=a.arguments.obj,c.releaseSpace(n,a.size),d.notifyObservers(c,"ExplorerFileRemove ",a)):a.result.code==33333?alloy.layout.alert("\u7cfb\u7edf\u6587\u4ef6\u5939\u4e0d\u5141\u8bb8\u5220\u9664 "):alloy.layout.alert("\u5220\u9664\u5931\u8d25\uff01 ")};alloy.storage.rpcService.fileRemove(g)};this.fileCopy=function(a,
                                                                                                                                                                                                                                                                                                                                                                                b){var g={},n={},j=this.getExplorerInstance();g.target=j.getCurDisk();g.obj=a;g.dest=j.getCurFolder();g.dest=="root "&&delete g.dest;n.data=g;n.onSuccess=function(a){a.retcode==0&&a.result&&a.result.code==0?(a=a.result.obj,c.useSpace(b,a.size),d.notifyObservers(c,"ExplorerFileCopy ",a)):a.retcode==0&&a.result&&a.result.code==30001?alloy.storage.storageFullAlert():alloy.layout.alert("\u590d\u5236\u5931\u8d25\uff01 ")};alloy.storage.rpcService.copyFile(n)};this.fileMove=function(a){var b={},g={},n=this.getExplorerInstance();
                                                                                                                                                                                                                                                                                                                                                                                    b.target=n.getCurDisk();b.obj=a;b.dest=n.getCurFolder();b.dest=="root "&&delete b.dest;g.data=b;g.onSuccess=function(a){a.retcode==0&&a.result&&a.result.code==0?d.notifyObservers(c,"ExplorerFileMove ",a.result.obj):a.result.code==33333?alloy.layout.alert("\u7cfb\u7edf\u6587\u4ef6\u5939\u4e0d\u5141\u8bb8\u79fb\u52a8 "):alloy.layout.alert("\u7c98\u8d34\u5931\u8d25\uff01 ")};alloy.storage.rpcService.fileMove(g)};this.isDiskReady=function(){return!1};this.storageFullAlert=function(a){a?alloy.layout.alert("\u60a8\u7684 "+
                                                                                                                                                                                                                                                                                                                                                                                        u[a].name+"\u5269\u4f59\u7a7a\u95f4\u4e0d\u8db3\uff0c\u8bf7\u4fee\u6539\u9ed8\u8ba4\u786c\u76d8\u540e\u91cd\u65b0\u4e0a\u4f20 ",function(){alloy.system.runApp("diskExplorer ")}):alloy.layout.alert("\u78c1\u76d8\u7a7a\u95f4\u5df2\u6ee1\uff0c\u8bf7\u7ed1\u5b9a\u6216\u4f7f\u7528\u65b0\u7684\u786c\u76d8 ")};this.checkPassword=function(a,b){var g={},n={};this.getExplorerInstance();var j=function(){c._passwordErrorWin=null};g.target=a;g.pass_md5=b;n.data=g;n.onSuccess=function(b){if(b.retcode==0&&b.result&&
                                                                                                                                                                                                                                                                                                                                                                                        b.result.code==0)d.notifyObservers(c,"ExploreCheckPassword ",{target:a,code:1});else if(!c._passwordErrorWin)c._passwordErrorWin=alloy.layout.alert("\u5bc6\u7801\u9519\u8bef\uff0c\u8bf7\u91cd\u8bd5\uff01 ",j,null,j);d.notifyObservers(c,"ExploreCheckPasswordDone ")};alloy.storage.rpcService.checkPassword(n)};this.getExplorerInstance=function(){if(alloy.app.diskExplorer)return alloy.app.diskExplorer.getInstance()};var n={onPortalReady:function(){var b=alloy.config.getDiskList();l=alloy.config.getDefaultDisk();
                                                                                                                                                                                                                                                                                                                                                                                            if(u[l])u[l].isDefault=!0;b&&(p=b);t=c.getUnBoundDisk();for(var h=0,b=0;b<p.length;b++){var g={};g.data={target:p[b]};g.arguments={target:p[b]};g.onSuccess=function(b){if(b.retcode==0&&b.result&&b.result.code==0){var f=b.arguments.target,e=b.result.config||{},k=parseInt(b.result.userUsedSpaceBytes),b=parseInt(b.result.userTotalSpaceBytes);u[f].userUsedSpace=k>b?b:k;u[f].userTotalSpace=b;u[f].dataReady=!0;u[f].isPwdOpen=a.isUndefined(e.is_pwd_open)?0:e.is_pwd_open;u[f].isLocked=u[f].isPwdOpen==0?0:
                                                                                                                                                                                                                                                                                                                                                                                                1;h++;d.notifyObservers(c,"StorageSpaceChanged ",f)}else a.out("\u52a0\u8f7d\u4e91\u5b58\u50a8\u4fe1\u606f\u9519\u8bef\uff01 "),d.notifyObservers(c,"StorageError ")};alloy.storage.rpcService.queryUser(g)}p.length==0&&d.notifyObservers(c,"StorageReady ")},onMessageUpdate:function(b){if((Number(b.appid)||Number(b.aid))==400011741){var b=a.json.parse(a.string.decodeHtmlSimple(b.m)),h=alloy.storage.getDiskById(b.source);if(h){var g=parseInt(b.userUsedSpaceBytes),n=parseInt(b.userTotalSpaceBytes);h.userUsedSpace=
                                                                                                                                                                                                                                                                                                                                                                                                    g>n?n:g;h.userTotalSpace=n;d.notifyObservers(c,"StorageSpaceChanged ",b.source)}}}};this.init=function(){d.addObserver(alloy.portal,"portalReady ",n.onPortalReady);d.addObserver(alloy.portal,"message ",n.onMessageUpdate)}});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.desktopContact ",function(a){var c=this,b=a.event,b=a.event,d=alloy.fileSystem.FILE_TYPE,g=!1,j={onBuddySelected:function(a,b){var c=b;c==-1&&(c=alloy.desktopManager.getCurrentDesktopIndex());var g=[],j;for(j in a){var l=a[j],e;l.gcode?(e=Number(l.gcode),l={id:l.gcode,n:l.name,t:alloy.fileSystem.FILE_TYPE.GROUP,gid:l.gid||0}):(e=Number(l.uin),l={id:l.uin,n:l.name,t:alloy.fileSystem.FILE_TYPE.BUDDY});isNaN(e)||alloy.fileSystem.getFileByFile(l)||g.push(l)}g.length&&(j=alloy.fileSystem.getFileAmount(d.BUDDY),
                                                                                                                                                                                                                                                                                                                                                                                e=alloy.fileSystem.getFileAmount(d.GROUP),j+e+g.length>=200?alloy.layout.alert("\u684c\u9762\u8054\u7cfb\u4eba\u5df2\u8d85\u8fc7200\u4eba\u4e0a\u9650\uff0c\u8bf7\u5220\u51cf\u540e\u518d\u521b\u5efa\u3002 "):alloy.fileSystem.getFolderById(c)?alloy.fileSystem.addFiles(g,c,null,!0):alloy.layout.alert("\u6587\u4ef6\u5939\u5df2\u7ecf\u4e0d\u5b58\u5728\uff0c\u6dfb\u52a0\u5931\u8d25\u3002 "));qqweb.util.report2qqweb("deskcontact | create | context ")},onBeforeGetRecentList:function(){b.addObserver(EQQ.Model.BuddyList,
                                                                                                                                                                                                                                                                                                                                                                                "RecentListChange ",j.onRecentListChange)},onEQQLoginSuccess:function(){b.removeObserver(EQQ.Model.BuddyList,"BuddyStateChange ",j.onBuddyStateChange);b.addObserver(EQQ.Model.BuddyList,"BuddyStateChange ",j.onBuddyStateChange);g||(alloy.notifier.register("desktopContact ",j.onMessageReceive,j.onMessageHandled),g=!0);w();var a=alloy.fileSystem.getFilesByType(d.BUDDY),c;for(c in a)s(a[c].id);alloy.system.reportAppState("50 ",1)},onDockLocationChanged:function(){},onBuddyStateChange:function(a){s(a)},onLoginLevelChange:function(a){if(a==
                                                                                                                                                                                                                                                                                                                                                                                    2&&a<alloy.portal.getOldLoginLevel()){var b=alloy.fileSystem.getFilesByType(d.BUDDY),c;for(c in b)b[c].notifyNumber=0,alloy.iconFactory.updateNotifyNumber(b[c]);var b=alloy.fileSystem.getFilesByType(d.GROUP),g;for(g in b)b[g].notifyNumber=0,alloy.iconFactory.updateNotifyNumber(b[g])}a<3&&alloy.portal.getOldLoginLevel()==3&&alloy.system.reportAppState("50 ",2)},onFileAddFail:function(){},onMessageReceive:function(a){var b;b=alloy.config.configList.isNoContactNotify?!1:a.from!=50?!1:a.body.extra.isChatBoxOpen?
                                                                                                                                                                                                                                                                                                                                                                                        !1:!0;if(b){b=a.body;var c;a.type=="SingleChat "?(a=b.uin,c=d.BUDDY):(a=b.code,c=d.GROUP);alloy.iconFactory.updateNotifyNumber({id:a,t:c,notifyNumber:b.count})}},onMessageHandled:function(a){var b=a.body;a.type=="SingleChat "?(a=b.uin,b=d.BUDDY):(a=b.code,b=d.GROUP);alloy.iconFactory.updateNotifyNumber({id:a,t:b,notifyNumber:0})},onRecentListChange:function(){b.removeObserver(EQQ.Model.BuddyList,"RecentListChange ",j.onRecentListChange);if(alloy.fileSystem.isFileSystemReady())l();else{var a=function(){l();
                                                                                                                                                                                                                                                                                                                                                                                            b.removeObserver(alloy.fileSystem,"FileSystemReady ",a)};b.addObserver(alloy.fileSystem,"FileSystemReady ",a)}}},l=function(){if(!alloy.config.configList.hasRecentFolder){for(var a=EQQ.Model.BuddyList.getRecentList(),b=[],c,g,j=0;j<a.length;j++){if(b.length>=16)break;c=null;if(a[j].type==0)(g=EQQ.Model.BuddyList.getBuddyByUin(a[j].uin))&&(c={t:d.BUDDY,id:a[j].uin,n:g.showName});else if(a[j].type==1)(g=EQQ.Model.BuddyList.getGroupByGid(a[j].uin))&&(c={t:d.GROUP,id:g.code,n:g.showName,gid:a[j].uin});
                                                                                                                                                                                                                                                                                                                                                                                                else continue;c&&!alloy.fileSystem.getFileByFile(c)&&b.push(c)}alloy.fileSystem.createRecentContactFolder(b)}},p=[],t=function(){},r=function(a){p.push(a)},u=function(){for(var a;a=p.shift();)setTimeout(a,500)},w=function(){var b=alloy.fileSystem.getFilesByType(d.BUDDY),f,h,g=!1,j={},l,e,k;for(k in b){f=b[k];if((h=EQQ.Model.BuddyList.getUserByUin(f.id))&&f.n!==h.showName)g=!0,f.n=h.showName,h=alloy.fileSystem.getFolderIdByFile(f),j[h]||(j[h]={}),j[h][f.id]=f;e=alloy.iconFactory.getIcons(f.id,d.BUDDY)||
                                                                                                                                                                                                                                                                                                                                                                                                    [];h=0;for(l=e.length;h<l;h++)e[h].refreshIcon(),e[h].setText(f.n)}var b=alloy.fileSystem.getFilesByType(d.GROUP),s;for(s in b){f=b[s];if((k=EQQ.Model.BuddyList.getGroupByCode(f.id))&&f.n!==k.showName)g=!0,f.n=k.showName,h=alloy.fileSystem.getFolderIdByFile(f),j[h]||(j[h]={}),j[h][f.id]=f;e=alloy.iconFactory.getIcons(f.id,d.GROUP)||[];h=0;for(l=e.length;h<l;h++)e[h].refreshIcon(),e[h].setText(f.n)}if(g)for(var x in j){f=[];var g=Number(x),p;for(p in j[x])f.push(j[x][p]);r(a.bind(function(a){alloy.fileSystem.sendUpdateFiles(a.fileList,
                                                                                                                                                                                                                                                                                                                                                                                                                a.folderId,t,null,!0)},c,{fileList:f,folderId:g}))}u()},s=this.updateContactIconState=function(a,b,c){var b=alloy.iconFactory.getIcons(a,d.BUDDY),g;if(b)if(c=c||EQQ.Model.BuddyList.getState(a)){a=0;for(g=b.length;a<g;a++)b[a].showState(c)}else{a=0;for(g=b.length;a<g;a++)b[a].hideState()}};this.init=function(){b.addObserver(alloy.portal,"EQQLoginSuccess ",j.onEQQLoginSuccess);b.addObserver(alloy.portal,"BeforeGetRecentList ",j.onBeforeGetRecentList);b.addObserver(alloy.portal,"loginLevelChange ",j.onLoginLevelChange)};
                                                                                                                                                                                                                                                                                                                                                                        this.addContactIcon=function(a,b,c){var g=alloy.fileSystem.getFileInfoByFile(a);if(g)a=g.parent.id,a==5?b="\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e\u201c\u5e94\u7528\u7801\u5934\u201d\u3002 ":a>=0&&a<5?b="\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e "+("\u201c\u684c\u9762 "+(a+1)+"\u201d ")+"\u3002 ":a==b?b="\u8be5\u8054\u7cfb\u4eba\u5df2\u4f4d\u4e8e\u8be5\u6587\u4ef6\u5939\u3002 ":(b="\u6587\u4ef6\u5939\u201c "+(g.parent.n||g.parent.id)+"\u201d ",b="\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e "+
                                                                                                                                                                                                                                                                                                                                                                            b+"\u3002 "),alloy.layout.alert(b);else{var g=alloy.fileSystem.getFileAmount(d.BUDDY),j=alloy.fileSystem.getFileAmount(d.GROUP);g+j>=200?alloy.layout.alert("\u684c\u9762\u8054\u7cfb\u4eba\u5df2\u8d85\u8fc7200\u4eba\u4e0a\u9650\uff0c\u8bf7\u5220\u51cf\u540e\u518d\u521b\u5efa\u3002 "):(b=b||alloy.desktopManager.getCurrentDesktopIndex(),g=a.t==d.BUDDY?EQQ.Model.BuddyList.getUserByUin(a.id):EQQ.Model.BuddyList.getGroupByCode(a.id),a.n=g.showName,alloy.fileSystem.addFile(a,b,c,!0))}};this.deleteContactIcon=
                                                                                                                                                                                                                                                                                                                                                                            function(a){alloy.fileSystem.deleteFile(a,null,null,!1,!0)};this.getCurrentContacts=function(){var a={},b,c=alloy.fileSystem.getFilesByType(d.BUDDY),g;for(g in c)b=c[g],a[b.id]={type:b.t,uin:b.id,name:b.n};c=alloy.fileSystem.getFilesByType(d.GROUP);for(g in c)b=c[g],a[b.id]={type:b.t,uin:b.gid,name:b.n,gcode:b.id};return a};this.showSelectBuddyBox=function(a){typeof a=="undefined "&&(a=-1);if(alloy.portal.getLoginLevel()==alloy.CONST.LOGIN_LEVEL_NONE)alloy.layout.showLoginWindow("selectBuddy ");else{var b=
                                                                                                                                                                                                                                                                                                                                                                                c.getCurrentContacts();alloy.portal.runApp("selectBuddy ",{id:"desktopContact ",title:"\u6dfb\u52a0\u684c\u9762\u8054\u7cfb\u4eba ",isAddSelf:!1,maxBuddy:0,initList:b,lockInitList:!0,onlyNewMember:!0,groupDisplayType:"group ",cbParam:a,onSelected:j.onBuddySelected})}}});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.desktopFolder ",function(a){var c=a.event,b=a.dom,c=a.event,d=a.string,g=alloy.fileSystem.MAX_FOLDER_AMOUNT,j=alloy.fileSystem.FILE_TYPE,l={onFileUpdate:function(a){var b=alloy.iconFactory.getIcons(a.id,a.t);if(b)for(var c=0,d=b.length;c<d;c++)b[c].setText(a.n),b[c].file.n=a.n},onFileCreateSuccess:function(a){var b=alloy.iconFactory.getIcons(a.id,a.t);if(b)for(var c=0,g=b.length;c<g;c++)b[c].setText(d.encodeHtml(a.n))},onFileAdd:function(a){if(a=alloy.iconFactory.getIcons(a.parent.id,
                                                                                                                                                                                                                                                                                                                                                                                        a.parent.type))for(var b=0,c=a.length;b<c;b++)a[b].update()},onFileDelete:function(a){if(a=alloy.iconFactory.getIcons(a.parent.id,a.parent.type))for(var b=0,c=a.length;b<c;b++)a[b].update()},onFileMove:function(a){var b=a.targetId,a=a.sourceId,c=alloy.iconFactory.getIcons(b,j.FOLDER);if(c)for(var d=0,g=c.length;d<g;d++)c[d].update();if(c=alloy.iconFactory.getIcons(a,j.FOLDER)){d=0;for(g=c.length;d<g;d++)c[d].update()}alloy.iconFactory.updateNotifyNumber(alloy.fileSystem.getFolderById(a));alloy.iconFactory.updateNotifyNumber(alloy.fileSystem.getFolderById(b))}};
                                                                                                                                                                                                                                                                                                                                                                        this.init=function(){c.addObserver(alloy.fileSystem,"FileUpdate ",l.onFileUpdate);c.addObserver(alloy.fileSystem,"FileAdd ",l.onFileAdd);c.addObserver(alloy.fileSystem,"FileDelete ",l.onFileDelete);c.addObserver(alloy.fileSystem,"FileMove ",l.onFileMove)};this.createFolder=function(){alloy.fileSystem.getFileAmount(j.FOLDER)>=g?alloy.layout.alert("\u6587\u4ef6\u5939\u5df2\u8d85\u8fc7 "+g+"\u4e2a\u4e0a\u9650\uff0c\u8bf7\u5220\u51cf\u540e\u518d\u521b\u5efa\u3002 "):alloy.system.getLoginLevel()>1?new t({callback:function(a){var b=
                                                                                                                                                                                                                                                                                                                                                                            alloy.desktopManager.getCurrentDesktopIndex();alloy.fileSystem.createFile({t:alloy.fileSystem.FILE_TYPE.FOLDER,n:a.n,c:a.c},b,null,l.onFileCreateSuccess)}}):alloy.layout.showLoginWindow("")};this.deleteFolder=function(a){var b=alloy.fileSystem.getFolderById(a.id).items,c=!1,d=!1;b.length?alloy.layout.confirm("\u60a8\u786e\u5b9a\u5220\u9664\u6587\u4ef6\u5939\u7684\u6240\u6709\u5185\u5bb9\u5417\uff1f ",function(){for(var g=[],f=b.length-1;f>=0;f--){var h=b[f];if(h.t==j.APP){var l=alloy.appconfig.getAppConfig(h.id);
                                                                                                                                                                                                                                                                                                                                                                                if(l)l.noSave=!0,alloy.config.removeSetupAppList(l,!1,!0)===!1?d=!0:(g.push(h),c=!0)}else g.push(h)}c&&alloy.config.sendSetSetupAppList();d?g.length&&alloy.fileSystem.deleteFiles(g,a.id,!0):alloy.fileSystem.deleteFile(a,null,null,!0,!0)},{title:"\u5220\u9664\u6587\u4ef6\u5939 "}):alloy.fileSystem.deleteFile(a,null,null,!1,!0)};var p=function(b){var c=alloy.CONST.CDN_URL+"style / images / filesys / "+b+".png ",d=alloy.CONST.CDN_URL+"style / images / transparent.gif ";return a.browser.ie==6?'<img class="fcDropdown_img " src="'+
                                                                                                                                                                                                                                                                                                                                                                                    d+'" style="'+("background:node;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+c+"', sizingMethod='scale ')")+'" idx="'+b+'" />':'<img class="fcDropdown_img " src="'+c+'" idx="'+b+'" />'},t=new a.Class({init:function(d){var g=this,d=d||{};d.id=d.id||+new Date;d.callback=d.callback||function(){};g.option=d;var l=g.folderWindow=alloy.windowFactory.createWindow("Window ",{title:"\u65b0\u5efa\u6587\u4ef6\u5939 ",modeSwitch:!0,dragable:!0,width:380,height:120,hasCloseButton:!0,hasOkButton:!0,
                                                                                                                                                                                                                                                                                                                                                                            hasCancelButton:!0,doubleClickModeSwitch:!1,isSetCentered:!0}),s='\t\t\t\t<div class="folderCreator " id="folderCreator_ '+d.id+'">\t\t\t\t\t<a class="folderSelector " id="folderSelector_ '+d.id+'">'+p("folder ")+'</a>\t\t\t\t\t<div class="folderNameTxt ">\u8bf7\u8f93\u5165\u6587\u4ef6\u5939\u540d\u79f0\uff1a</div>\t\t\t\t\t<div class="folderInput "><input class="folderName " id="folderName_ '+d.id+'"></input></div>\t\t\t\t\t<div class="folderNameError " id="folderNameError_ '+d.id+'"></div>\t\t\t\t</div>\t\t\t';
                                                                                                                                                                                                                                                                                                                                                                        l.setHtml(s);g.container=b.id("folderCreator_ "+d.id);g.selector=b.id("folderSelector_ "+d.id);g.folderName=b.id("folderName_ "+d.id);g.folderNameError=b.id("folderNameError_ "+d.id);s='\t\t\t\t<div class="fcDropdown_title " id="fcDropdown_title_ '+d.id+'">\u56fe\u6807</div>\t\t\t\t<div class="fcDropdown_body " id ="fcDropdown_body_ '+d.id+'">\t\t\t\t\t<a class="fcDropdown_item " title="\u9ed8\u8ba4 ">'+p("folder ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u8054\u7cfb\u4eba ">'+p("contact ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u6587\u672c ">'+
                                                                                                                                                                                                                                                                                                                                                                            p("doc ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u6e38\u620f ">'+p("game ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u751f\u6d3b ">'+p("life ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u97f3\u4e50 ">'+p("music ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u5de5\u5177 ">'+p("tool ")+'</a>\t\t\t\t\t<a class="fcDropdown_item " title="\u89c6\u9891 ">'+p("video ")+" < /a>\t\t\t\t</div > \t\t\t ";g.dropdown=b.node("div ",{id:"fcDropdown_ "+d.id,"class ":"folderCreatorDropdown "});g.dropdown.innerHTML=
                                                                                                                                                                                                                                                                                                                                                                            s;document.body.appendChild(g.dropdown);g.dropdownTitle=b.id("fcDropdown_title_ "+d.id);g.dropdownBody=b.id("fcDropdown_body_ "+d.id);g.folderType=b.id("folderType_ "+d.id);g.folderSelector=b.id("folderSelector_ "+d.id);b.hide(g.dropdown);g.dropdownPanel=new a.ui.PopupBox({noCatchMouseUp:!0,container:g.dropdown});g.folderName.value=alloy.fileSystem.getDefaultFolderName();g.folderName.select();var n={onClick:function(a){a.preventDefault();a.stopPropagation();g.showDropDown()},onKeyDown:function(a){b.hide(g.folderNameError);
                                                                                                                                                                                                                                                                                                                                                                                a.keyCode==13&&n.onClickOkButton()&&l.close()},onDropdownClick:function(a){a=a.target.getAttribute("idx ");g._selectedCate=a;g.folderSelector.innerHTML=p(a)},onClickOkButton:function(){var a=g.getFolderByName(),c=g.getSelectedCate(),l=alloy.fileSystem.isFileNameAvailable(a,j.FOLDER);if(l!=0)return b.show(g.folderNameError),g.folderNameError.innerHTML=l,!1;d.callback({c:c,n:a});return!0},onDragStart:function(){g.hideDropDown()},onWindowClose:function(){document.body.removeChild(g.dropdown)}};c.on(g.selector,
                                                                                                                                                                                                                                                                                                                                                                                        "click ",n.onClick);c.on(g.folderName,"keydown ",n.onKeyDown);c.on(g.dropdownBody,"click ",n.onDropdownClick);c.addObserver(l,"clickOkButton ",n.onClickOkButton);c.addObserver(l,"dragStart ",n.onDragStart);c.addObserver(l,"close ",n.onWindowClose);this._selectedCate="folder "},getSelectedCate:function(){return this._selectedCate},getFolderByName:function(){return this.folderName.value},showDropDown:function(){var a=b.getXY(this.selector);this.dropdownPanel.show();var c=alloy.layout.themeManager.getCurrentSkin().currentWindow.ie6WindowCenterBackground||
                                                                                                                                                                                                                                                                                                                                                                                            "##B6EAFD ";b.setStyle(this.dropdownTitle,"backgroundColor ",c);b.setStyle(this.dropdown,"zIndex ",alloy.layout.getTopZIndex(1));b.setXY(this.dropdown,a[0]+"px ",a[1]+57+"px ")},hideDropDown:function(){this.dropdownPanel.hide()},destroy:function(){}})});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.desktopFile ",function(a){var c={onFileCreateSuccess:function(){}};this.init=function(){};this.createFile=function(b,d){if(alloy.system.getLoginLevel()>1){var g=b.folderId,j=alloy.storage.getDefaultDisk().key;alloy.storage.getFreeSpaceById(j)<b.fileSize?alloy.storage.storageFullAlert(j):(g==-1&&(g=alloy.desktopManager.getCurrentDesktopIndex()),alloy.fileSystem.createFile({t:alloy.fileSystem.FILE_TYPE.FILE,n:b.fileName,size:b.fileSize,md5:"",sha:"",s:j},g,null,a.bind(function(a){c.onFileCreateSuccess(a);
                                                                                                                                                                                                                                                                                                                                                                            alloy.storage.useSpace(a.s,a.size);d&&d(a)},this)))}else alloy.layout.showLoginWindow("")};this.deleteFile=function(a){alloy.fileSystem.deleteFile(a,null,null,!1,!0);alloy.storage.releaseSpace(a.s,a.size)}});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.windowFactory ",function(a){var c=this,b=a.dom,d=a.event,g,j,l,p,t,r={onDesktopResize:function(){var a,b=alloy.windowManager.getWindowList(),c;for(c in b){a=b[c];var d=a.getBoxStatus();if(d=="max "||d=="fullscreen ")a:{var g=void 0,j=void 0,l=void 0,e=d=void 0,e=j=g=d=l=void 0,e=a.getBoxStatus(),l=alloy.layout.getAreaWidth("left "),d=alloy.layout.getAreaHeight("top "),g=alloy.layout.getClientWidth(),j=alloy.layout.getClientHeight();if(e=="fullscreen ")e=5,g+=e*2,j+=e*2,l=-l-e,d=-d-
                                                                                                                                                                                                                                                                                                                                                                            e;else if(e=="max ")e=10,g+=e*2,j+=e*2,l=-l-e,d=-d-e;else break a;(a.windowType=="window "||a.windowType=="chatbox "||a.windowType=="messagebox ")&&a.adjustSize(g,j,l,d)}else a.getY()<0&&a.setY(0)}},onWindowSetCenter:function(){var a=alloy.layout.getClientWidth(),b=alloy.layout.getClientHeight(),a=a>this.getWidth()?(a-this.getWidth())/2:0,b=b>this.getHeight()?(b-this.getHeight())/2:0;this.setXY(a,b)},onWindowSetCurrent:function(){alloy.windowManager.setCurrentWindow(this);w(this);this.subMode==1&&this.isSubWinFloat&&
                                                                                                                                                                                                                                                                                                                                                                                this.subWin&&w(this.subWin)},onWindowTitleBarClick:function(){g&&g.focus()},onWindowDestroy:function(){alloy.app.gravity&&alloy.app.gravity.removeBox(this);j&&b.hide(j);a.platform.iPad||g&&g.focus()},onWindowResize:function(){alloy.app.gravity&&alloy.app.gravity.resizeBox(this);if(this.subMode==1&&this.isSubWinFloat&&this.subWin&&this.isShow()){a.info("subWindowResize ","subWindow ");var c=b.getRelativeXY(this._subBodyOuter,this.container.parentNode);this.subWin.setXY(c[0],c[1]+(a.browser.ie?2:0))}},
                                                                                                                                                                                                                                                                                                                                                                            onWindowMax:function(){var a=alloy.layout.getClientWidth(),b=alloy.layout.getClientHeight(),c=alloy.layout.getAreaWidth("left "),d=alloy.layout.getAreaHeight("top ");this.setXY(-c-10,-d-10);this.setWinWidth(a+20);this.setWinHeight(b+20)},onWindowRestore:function(){},onWindowFullscreen:function(){var c=alloy.layout.getClientWidth(),d=alloy.layout.getClientHeight(),f=alloy.layout.getAreaWidth("left "),g=alloy.layout.getAreaHeight("top ");this.setXY(-f-5,-g-5);this.setWinWidth(c+10);this.setWinHeight(d+
                                                                                                                                                                                                                                                                                                                                                                                10);this.setZIndexLevel(3);w(this);a.browser.mobileSafari||(j||(j=b.node("div ",{id:"fullscreen_tip ","class ":"fullscreen_tip "}),document.body.appendChild(j)),b.setStyle(j,"zIndex ",alloy.layout.getTopZIndex(3)),b.show(j),this.subMode==1&&this.isSubWinFloat&&this.subWin&&this.isShow()&&(this.subWin.setZIndexLevel(3),w(this.subWin)),setTimeout(function(){b.hide(j)},3E3))},onWindowRestoreFull:function(){this.setZIndexLevel(0);w(this);this.subMode==1&&this.isSubWinFloat&&this.subWin&&this.isShow()&&(this.subWin.setZIndexLevel(0),
                                                                                                                                                                                                                                                                                                                                                                                    w(this.subWin))},onWindowHide:function(){this.subMode==1&&this.isSubWinFloat&&this.subWin&&this.subWin.hide(!0)},onWindowShow:function(){if(this.subMode==1&&this.isSubWinFloat&&this.subWin){var c=b.getRelativeXY(this._subBodyOuter,this.container.parentNode);this.subWin.setXY(c[0],c[1]+(a.browser.ie?2:0));this.subWin.show()}},onWindowSetRight:function(){var a=this.getBodySize()[0];this.setX(alloy.layout.getClientWidth()-a)},onWindowBeforeDragStart:function(){var a=-10-alloy.layout.getAreaHeight("top "),
                                                                                                                                                                                                                                                                                                                                                                                        b=-this.getTitleBarHeight()-this.getHeight();this.setDragLimite({topMargin:a,bottomMargin:b})}},u=function(b){if(b){var c=b.option||{};c.isSetCurrent?b.setCurrent({fromInit:!0}):b.setNotCurrent({fromInit:!0});var d=alloy.layout.getAvailableWidth(),g=alloy.layout.getAvailableHeight(),j=b.getWidth(),l=b.getHeight();b.getX();b.getY();l>g&&(l=g);j>d&&(j=d);if(b.windowType=="window "||b.windowType=="chatbox "||b.windowType=="messagebox ")b.setWinWidth(j),b.setWinHeight(l);a.isUndefined(c.defaultMode)||b.restore();
                                                                                                                                                                                                                                                                                                                                                                                            switch(c.defaultMode){case "max ":b.max();b._restoreWidth=c.defaultWidth;b._restoreHeight=c.defaultHeight;break;case "min ":b.min();break;case "fullscreen ":b.fullscreen()}if(alloy.app.gravity)b.b2Box=alloy.app.gravity.createBox(b);c.isSetCentered&&b.setWindowCentered()}},w=function(a){if(!a.isLockZIndex()){var b=a.getZIndexLevel()||0,b=alloy.layout.getTopZIndex(b);a.setZIndex(b)}};this.init=function(){l={};p=0;t=!1;g||(g=b.node("input ",{id:"qqweb_focus_input "}),g.setAttribute("type ","text "),document.body.appendChild(g));
                                                                                                                                                                                                                                                                                                                                                                                                d.addObserver(alloy.layout,"desktopResize ",r.onDesktopResize);d.addObserver(alloy.dock,"DockLocationChanged ",r.onDesktopResize)};this.createWindow=function(g,j,f){var h=l[g],j=a.clone(j);j.level=j.level?parseInt(j.level):0;j.dragProxy=j.dragProxy||t;j.zIndex=j.zIndex||alloy.layout.getTopZIndex();j.topMargin=j.bottomMargin=0;if(h){if(!j.appendTo){if(a.isUndefined(j.desktopIndex))j.desktopIndex=alloy.desktopManager.getCurrentDesktopIndex();g=alloy.desktopManager.getDesktop(j.desktopIndex).getElement();
                                                                                                                                                                                                                                                                                                                                                                                                    j.appendTo=g}j.windowId=j.windowId||p++;h=new h(j);d.notifyObservers(c,"WindowCreate ",h);h.setZIndexLevel(j.level);h.setLockZIndex(j.lockZIndex||!1);d.addObserver(h,"setCenter ",r.onWindowSetCenter);d.addObserver(h,"setCurrent ",r.onWindowSetCurrent);d.addObserver(h,"clickTitleBar ",r.onWindowTitleBarClick);d.addObserver(h,"destroy ",r.onWindowDestroy);d.addObserver(h,"resize ",r.onWindowResize);d.addObserver(h,"hide ",r.onWindowHide);d.addObserver(h,"show ",r.onWindowShow);d.addObserver(h,"beforeDragStart ",
                                                                                                                                                                                                                                                                                                                                                                                                        r.onWindowBeforeDragStart);d.addObserver(h,"SetRight ",r.onWindowSetRight);(h.windowType=="window "||h.windowType=="chatbox "||h.windowType=="messagebox ")&&d.addObserver(h,"max ",r.onWindowMax);if(a.isUndefined(j.x)&&a.isUndefined(j.y)){var m,o;o=m=0;var j=h.option.clientWidth||alloy.layout.getAvailableWidth(),g=h.option.clientHeight||alloy.layout.getAvailableHeight(),w=j-h.getWidth(),e=g-h.getHeight(),k=w>0?w/2:0,B=e>0?e/2:0,x=h.getId(),x=alloy.windowManager.getWindowList().length==1?0:x<0?0:x;m=(k+
                                                                                                                                                                                                                                                                                                                                                                                                            x*25)%w+m;o=(B+x*25)%e+o;m=m>0?m:0;o=o>0?o:0;m=m+parseInt(h.getWidth())>=j?0:m;o=o+parseInt(h.getHeight())>=g?0:o;h.setXY(m,o)}else o=alloy.layout.getAvailableWidth(),j=alloy.layout.getAvailableHeight(),e=h.getX()||0,g=h.getY()||0,e+h.getWidth()>o&&(o-=h.getWidth(),h.setX(o<0?0:o)),g+h.getHeight()>j&&(j-=h.getHeight(),h.setY(j<0?0:j)),h.subMode==1&&h.isSubWinFloat&&h.subWin&&(j=b.getRelativeXY(h._subBodyOuter,h.container.parentNode),h.subWin.setXY(j[0],j[1]+(a.browser.ie?2:0)),h.subWin.show());f||
                                                                                                                                                                                                                                                                                                                                                                                                            u(h);d.notifyObservers(c,"WindowCreated ",h);return h}else throw Error('WindowFactory: class "'+g+'" has not register!');};this.registerWindow=function(a,b){l[a]=b};this.initWindow=u});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.windowManager ",function(a){var c=a.event,b,d,g,j,l={onWidnowCreated:function(a){b.push(a);d[a.getId()]=a;a.windowType=="widget "?j.push(a):g.push(a);c.addObserver(a,"destroy ",l.onWindowDestroy)},onWindowDestroy:function(c){d[c.getId()]=null;c.windowType=="widget "?a.array.remove(j,c):a.array.remove(g,c);a.array.remove(b,c)}};this.init=function(){b=[];d={};g=[];j=[];c.addObserver(alloy.windowFactory,"WindowCreated ",l.onWidnowCreated)};this.getWindow=function(a){return d[a]};this.getWindowList=
                                                                                                                                                                                                                                                                                                                                                                            function(){return b};this.getOnlyWindowList=function(){return g};this.getOnlyWidgetList=function(){return j};this.setCurrentWindow=function(a){var b=alloy.desktopManager.getCurrentDesktop();a.desktopIndex!==b.getIndex()&&alloy.desktopManager.setCurrentDesktop(a.desktopIndex);b=alloy.desktopManager.getCurrentDesktop();b.getWindowManager().setCurrentWindow(a)};this.getCurrentWindow=function(){return alloy.desktopManager.getCurrentDesktop().getWindowManager().getCurrentWindow()}});
                                                                                                                                                                                                                                                                                                                                                                        Jx().$package("alloy.desktopManager ",function(a){var c=a.dom,b=a.event,d=a.fx.transitions,g={NORMAL:1,EDIT:2,DRAG:3,MANAGE:4},j,l,p,t,r,u,w,s,n,f,h=[],m={},o=[],D=[],e={},k=g.NORMAL,B=[],x=[],A,z,v,q=[0,0,0,0,0],C=alloy.fileSystem.FILE_TYPE,E=142,G=112,K=0,P=0,J=0,N=function(a){return a===null||typeof a==="undefined "},I=function(){alloy.navbar&&alloy.navbar.setZIndex(11);c.setStyle(alloy.layout.getArea("bottom "),"zIndex ",12)},V=function(){alloy.navbar&&alloy.navbar.setZIndex(10);c.setStyle(alloy.layout.getArea("bottom "),
                                                                                                                                                                                                                                                                                                                                                                                    "zIndex ",10)},O=[{text:"\u4e0a\u4f20\u6587\u4ef6 ",type:"flash ",icon:{className:"add_file_icon "},onClick:function(){}},{text:"\u6dfb\u52a0\u5e94\u7528 ",icon:{className:"add_app_icon "},onClick:function(){alloy.portal.runApp("appMarket ");qqweb.util.report2qqweb("screen | "+alloy.desktopManager.getCurrentDesktopIndex()+" | addapp ")}},{text:"\u6dfb\u52a0\u684c\u9762\u8054\u7cfb\u4eba ",icon:{className:"add_contact_icon "},onClick:function(){alloy.desktopContact.showSelectBuddyBox();qqweb.util.report2qqweb("add | desktop | adddeskcontanct ")}},
                                                                                                                                                                                                                                                                                                                                                                            {type:"separator "},{text:"\u65b0\u5efa\u6587\u4ef6\u5939 ",icon:{className:"add_folder_icon "},onClick:function(){alloy.desktopFolder.createFolder();qqweb.util.report2qqweb("add | desktop | addfolder ")}}],H={onWindowCreated:function(c){if(this.isWindowInDesktop(c)){this._windowArray.push(c);if(c.windowType!="widget "){var e=this,d=function(){this.getBoxStatus()==="max "&&(a.array.contains(e._maxWindowArray,this)||e._maxWindowArray.push(this),e._maxWindowArray.length>0&&V())},f=function(){a.array.remove(e._maxWindowArray,
                                                                                                                                                                                                                                                                                                                                                                                this);e._maxWindowArray.length==0&&I()};b.addObserver(c,"max ",d);b.addObserver(c,"show ",d);b.addObserver(c,"restore ",f);b.addObserver(c,"min ",f);d.apply(c)}b.addObserver(c,"destroy ",a.bind(H.onWindowDestroy,this))}},onWindowDestroy:function(b){if(b==this.getCurrentWindow()){this.setCurrentWindow(null);var c;if(!this._preCurrentWindow&&(c=this._windowArray[this._windowArray.length-1]))this._preCurrentWindow=c==b?this._windowArray[this._windowArray.length-2]||null:c;this._preCurrentWindow&&this._preCurrentWindow.isShow()&&
                                                                                                                                                                                                                                                                                                                                                                                    this._preCurrentWindow.setCurrent()}else if(b==this._preCurrentWindow)this._preCurrentWindow=null;a.array.remove(this._windowArray,b);b.windowType!="widget "&&(a.array.remove(this._maxWindowArray,b),this._maxWindowArray.length==0&&I())},onDesktopSwitch:function(a){this._desktopIndex==a&&(this._maxWindowArray.length==0?I():V())}},T=new a.Class({init:function(c){this._desktopIndex=c.desktopIndex;this._windowArray=[];this._preCurrentWindow=this._currentWindow=null;this._maxWindowArray=[];b.addObserver(alloy.windowFactory,
                                                                                                                                                                                                                                                                                                                                                                                            "WindowCreated ",a.bind(H.onWindowCreated,this));b.addObserver(alloy.portal,"DesktopSwitch ",a.bind(H.onDesktopSwitch,this))},isWindowInDesktop:function(a){if(N(a.desktopIndex))return this._desktopIndex==alloy.desktopManager.getCurrentDesktopIndex();else if(this._desktopIndex==a.desktopIndex)return!0;return!1},setCurrentWindow:function(a){if(a)if(this._currentWindow){if(this._currentWindow!=a)this._preCurrentWindow=this._currentWindow,this._currentWindow.setNotCurrent()}else this._preCurrentWindow=
                                                                                                                                                                                                                                                                                                                                                                                                null;this._currentWindow=a},getCurrentWindow:function(){return this._currentWindow}}),Q=new a.Class({init:function(e){var d=this._index=e.index,f=this._el=c.node("div ",{index:d,"class ":"desktopContainer "}),g=this._iconContainer=c.node("div ",{"class ":"appListContainer ",customAcceptDrop:1,index:d});b.addObserver(g,"dragmove ",F.onDesktopContainerDragMove);b.addObserver(g,"drop ",F.onDesktopContainerDrop);if(a.browser.mobileSafari)b.on(g,"touchstart ",F.onTouchStart);f.appendChild(g);if(a.browser.mobileSafari)c.setStyle(g,
                                                                                                                                                                                                                                                                                                                                                                                                    "overflow - y ","auto "),c.setStyle(g,"overflow - x ","hidden "),new a.ui.TouchScroller(g);else{var k=new a.ui.ScrollArea(g);k.update();B.push(k);c.setStyle(g,"overflow - y ","hidden ")}a.browser.engine.webkit&&c.setStyle(this._el,"left ",alloy.layout.getDesktopWidth()+"px ");c.hide(g);e.appendTo.appendChild(f);this._windowManager=new T({desktopIndex:d});if(a.browser.engine.webkit){c.addClass(l,"desktopsContainerEx ");var h=this;b.on(this._el,"webkitTransitionEnd ",function(){h._isCurrent||c.setClass(this,"desktopContainer ");
                                                                                                                                                                                                                                                                                                                                                                                                        q[h._index]--;a:{for(var a in q)if(q[a]>0)break a;c.addClass(l,"desktopsContainerEx ")}})}},getElement:function(){return this._el},getIconContainer:function(){return this._iconContainer},getIndex:function(){return this._index},getWindowManager:function(){return this._windowManager},setCurrent:function(b,e){this._isCurrent=!0;var d=this._el,f=this;c.setClass(d,"desktopContainer desktop_current ");if(e||k===g.DRAG)a.browser.engine.webkit&&(c.addClass(l,"desktopsContainerEx "),c.addClass(d,"desktop_current_noanimation "));
                                                                                                                                                                                                                                                                                                                                                                                                            else if(a.browser.engine.webkit&&(q[this._index]=2,c.removeClass(l,"desktopsContainerEx ")),a.browser.engine.webkit||a.browser.firefox)this._showAnimationTimer&&clearTimeout(this._showAnimationTimer),this._disappearAnimationTimer&&clearTimeout(this._disappearAnimationTimer),c.addClass(d,"desktop_show_prepare "+b),this._showAnimationTimer=setTimeout(function(){c.addClass(d,"desktop_show_animation "+b);f._showAnimationTimer=0},100)},setNotCurrent:function(b,e){c.removeClass(l,"desktopsContainerEx ");this._isCurrent=
                                                                                                                                                                                                                                                                                                                                                                                                                !1;var d=this._el,f=this;c.setClass(d,"desktopContainer ");if(!(e||k===g.DRAG))if(a.browser.engine.webkit)a.browser.engine.webkit&&(q[this._index]=1,c.removeClass(l,"desktopsContainerEx ")),c.addClass(d,"desktop_disappear_prepare "+b),c.addClass(d,"desktop_disappear_animation "+b);else if(a.browser.firefox)this._showAnimationTimer&&clearTimeout(this._showAnimationTimer),this._disappearAnimationTimer&&clearTimeout(this._disappearAnimationTimer),c.addClass(d,"desktop_disappear_prepare "+b),this._disappearAnimationTimer=
                                                                                                                                                                                                                                                                                                                                                                                                    setTimeout(function(){c.addClass(d,"desktop_disappear_animation "+b);f._disappearAnimationTimer=0},100)}}),F={onTouchStart:function(a){var e=a.target;if(c.hasClass(e,"appListContainer "))K=a.changedTouches[0].pageX,P=(new Date).getTime(),b.on(e,"touchmove ",F.onTouchMove),b.on(e,"touchend ",F.onTouchEnd)},onTouchMove:function(){},onTouchEnd:function(a){var c=a.target;b.off(c,"touchmove ",F.onTouchMove);b.off(c,"touchend ",F.onTouchEnd);J=a.changedTouches[0].pageX-K;a=(new Date).getTime()-P;a=J/a;a>50?W(!0):
                                                                                                                                                                                                                                                                                                                                                                                                        a<-50?S(!0):J>60?W(!0):J<-60?S(!0):J=0},onSwipe:function(){},onDesktopContainerDragMove:function(){},onDesktopContainerDrop:function(a){var b=a.pos,d=b.x,f=b.y;f+=this.scrollTop;var b=a.dragEl,a=this.getAttribute("index ")||t,g=c.getClientXY(this);d-=g[0];f-=g[1];d=Math.floor(d/E);f=Math.floor(f/G);d=f>=w?f*s+d:d*w+f;if(d>m[a].length)d=m[a].length;var k,h=b.getAttribute("type "),f={t:h},g=alloy.fileSystem.FILE_TYPE;k=parseInt(b.getAttribute("fileId "));if(!isNaN(k)){if(h==g.FILE){var y=alloy.iconFactory.getIcons(k,
                                                                                                                                                                                                                                                                                                                                                                                                            alloy.fileSystem.FILE_TYPE.FILE);i=0;for(len=y.length;i<len;i++)if(y[i].isUploading())return}f.id=k;if(h==g.GROUP)f.gid=parseInt(b.getAttribute("gid "));b=b.getAttribute("from ");k=m[a][d];b=="buddy "?(k&&e[k]&&e[k].type==g.FOLDER?alloy.fileSystem.moveFile(f,e[k].fileId,null,null,null,!0):alloy.desktopContact.addContactIcon(f,a,d),qqweb.util.report2qqweb("deskcontact | create | drag ")):alloy.fileSystem.isInFolder(f,alloy.fileSystem.getRootFolder(),!0)&&(k&&e[k]&&e[k].type==g.FOLDER&&f.t!=g.FOLDER?alloy.fileSystem.moveFile(f,
                                                                                                                                                                                                                                                                                                                                                                                                                    e[k].fileId,null,null,null,!0):alloy.fileSystem.moveFile(f,a,d,null,null,!0))}},onGetAppConfigComplete:function(){ba();u={};a.array.forEach(D,function(a){clearTimeout(a)});a.array.forEach(o,function(a){a&&a.stop()});o=[];D=[];var c=alloy.fileSystem.getRootFolder(),e=c.items,c=alloy.fileSystem.getFolderById(t,c);$(c.items,c.id,function(){b.notifyObservers(alloy.portal,"FirstScreenReady ");for(var a=0,c=1;a<5;++a)t!=e[a].id&&(function(a,b){D[a]=setTimeout(function(){$(e[a].items,e[a].id)},b*5E3)}(a,
                                                                                                                                                                                                                                                                                                                                                                                                                            c),c++)})},onClearDefaultApp:function(){ba()},onFileMove:function(a){if(a.targetId>=0&&a.targetId<5){if(a.targetId==a.sourceId)var b=Y(a.file.id,a.file.t);else a.sourceId>=0&&a.sourceId<5&&(b=Y(a.file.id,a.file.t))&&aa(b,a.sourceId,a.sourcePosition),b=y(a.file,p[a.targetId].getIconContainer(),a.targetId);b&&ja(b,a)}else a.sourceId>=0&&a.sourceId<5&&(b=Y(a.file.id,a.file.t))&&aa(b,a.sourceId,a.sourcePosition)},onFileAdd:function(a){var b=a.parent.id;if(b>=0&&b<5){var c={targetId:b,targetPosition:a.position,
                                                                                                                                                                                                                                                                                                                                                                                                                                sourceId:-1,sourcePosition:-1};(a=y(a.file,p[b].getIconContainer(),b))&&ja(a,c)}},onFileDelete:function(a){var b=a.parent.id;if(b>=0&&b<5){var c=Y(a.file.id,a.file.t);c&&aa(c,b,a.position)}},onFileOperateTimeout:function(){alloy.layout.alert("\u64cd\u4f5c\u8d85\u65f6\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onFileOperateError:function(){alloy.layout.alert("\u64cd\u4f5c\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onAddFileFail:function(a){a.retcode==0&&a.result&&a.result.code==30001?
                                                                                                                                                                                                                                                                                                                                                                                                                                    alloy.storage.storageFullAlert():alloy.layout.alert("\u6dfb\u52a0\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onCopyFileFail:function(a){a.retcode==0&&a.result&&a.result.code==30001?alloy.storage.storageFullAlert():alloy.layout.alert("\u590d\u5236\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onMoveFileFail:function(a){a.retcode==0&&a.result&&a.result.code==30001?alloy.storage.storageFullAlert():alloy.layout.alert("\u79fb\u52a8\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},
                                                                                                                                                                                                                                                                                                                                                                            onUpdateFileFail:function(){alloy.layout.alert("\u66f4\u65b0\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onDeleteFileFail:function(){alloy.layout.alert("\u5220\u9664\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onDesktopResize:function(){var b=alloy.layout.getAvailableWidth(),e=alloy.layout.getAvailableHeight(),b={width:b,height:e};if(b.width){var e=alloy.layout.getAreaWidth("left "),d=alloy.layout.getAreaWidth("right ");A=b.width;z=A+e+d;c.setStyle(l,"width ",A+"px ");for(var d=
                                                                                                                                                                                                                                                                                                                                                                                0,f=p.length;d<f;++d)e=p[d],c.setStyle(e.getIconContainer(),"width ",b.width-28+"px "),c.setStyle(e.getIconContainer(),"marginLeft ","28px "),a.browser.engine.webkit&&c.setStyle(e.getElement(),"left ",z+"px "),c.setStyle(e.getElement(),"width ",b.width+"px ")}if(b.height){v=b.height-alloy.layout.getAreaHeight("bottom ");c.setStyle(l,"height ",v+"px ");d=0;for(f=p.length;d<f;++d)c.setStyle(p[d].getIconContainer(),"height ",v-46+"px "),c.setStyle(p[d].getIconContainer(),"marginTop ","46px "),c.setStyle(p[d].getElement(),
                                                                                                                                                                                                                                                                                                                                                                                    "height ",v+"px ")}c.setStyle(j,"left ",alloy.layout.getAreaWidth("left ")+"px ");c.setStyle(j,"right ",alloy.layout.getAreaWidth("right ")+"px ");b=v-46;s=Math.floor((A-28)/E);w=Math.floor(b/G);ea()},onDockLocationChanged:function(){var a=alloy.layout.getAreaHeight("top ");c.setStyle(l,"top ",a+"px ");F.onDesktopResize()},onSortControllerDragEnd:function(a){alloy.util.report2qqweb("screen | screendrag ");k===g.DRAG&&M(g.NORMAL);var b=a.apperceiveEl,a=b.getAttribute("fileId "),b=b.getAttribute("type ");if(a&&b&&
                                                                                                                                                                                                                                                                                                                                                                                        (a={id:a,t:b},(a=alloy.fileSystem.getFileByFile(a))&&a.processing))if(a=alloy.iconFactory.getIcons(a.id,a.t))for(var b=0,c=a.length;b<c;b++)a[b].disable()},onSortControllerDragStart:function(){M(g.DRAG)},onUACReady:function(){L(fa()-1,!0);ha(ga())}},L=function(e,d){if(e===t||N(e)||!p[e])return!1;if(u&&!u[e]){var f=alloy.fileSystem.getFolderById(e);$(f.items,f.id)}f=e>t?1:2;N(t)||p[t].setNotCurrent(f,d);t=e;p[e].setCurrent(f,d);a.browser.ie==6&&c.setStyle(document.body,"height ",c.getStyle(document.body,
                                                                                                                                                                                                                                                                                                                                                                                                "height "));x[e]&&Z(e);b.notifyObservers(alloy.portal,"DesktopSwitch ",t);return!0},S=function(){var a=t+1;a>=p.length||L(a)},W=function(){var a=t-1;a<0?alloy.portal.isWebTop()&&alloy.portal.switchToDesktop():L(a)},M=function(a){a=a||g.NORMAL;if(a===g.EDIT){if(k===g.DRAG)return;c.addClass(j,"appButtonEditState ");for(var e=0,d=h.length;e<d;++e)h[e].setAttribute("title ","\u8fd4\u56de "),h[e].lastChild.firstChild.innerHTML="\u8fd4\u56de ";r.lock()}else if(a===g.NORMAL){c.removeClass(j,"appButtonEditState ");
                                                                                                                                                                                                                                                                                                                                                                                                    e=0;for(d=h.length;e<d;++e)h[e].setAttribute("title ","\u6dfb\u52a0 "),h[e].lastChild.firstChild.innerHTML="\u6dfb\u52a0 "}a!==g.EDIT&&r.isLock()&&r.unlock();k=a;b.notifyObservers(alloy.portal,"DesktopSwitchStatus ",{status:a});return a},U=document.createElement("div ");U.className="appButton addQuickLinkButton ";U.setAttribute("title ","\u6dfb\u52a0 ");U.innerHTML='<div class="addQuickLinkButtonInner "></div>        <div class="appButton_appName "><div class="appButton_appName_inner ">\u6dfb\u52a0</div><div class="appButton_appName_inner_right "></div></div>';
                                                                                                                                                                                                                                                                                                                                                                        var X=function(a){a.stopPropagation();k===g.EDIT?(M(g.NORMAL),alloy.util.report2qqweb("screen | ipad | edited ")):(alloy.layout.showContextMenu({x:a.clientX,y:a.clientY},{items:O}),alloy.util.report2qqweb("add | add | "+alloy.desktopManager.getCurrentDesktopIndex()))},y=function(b,c){var d={parentNode:c},f;if(b.t==C.APP){var g=b.id;f=alloy.appconfig.getAppConfig(g);if(!f)return a.profile('createFileIcon. id="'+g+'" appConfig is null',"DesktopManager "),alloy.fileSystem.deleteFile(b,null,null,null,!1),null;
                                                                                                                                                                                                                                                                                                                                                                            f=alloy.iconFactory.createIcon(b.t,d,f)}else if(b.t==C.BUDDY||b.t==C.GROUP)f=alloy.iconFactory.createIcon(b.t,d,b);else if(b.t==C.FOLDER||b.t==C.FILE)f=alloy.iconFactory.createIcon(b.t,d,b);f&&(e[f.getId()]=f,r.addDragClass(f.getElement()));return f},ja=function(a,b){var c=b.targetId,e=b.targetPosition,d=b.sourcePosition,f=-1;b.sourceId==c?(m[c].splice(d,1),m[c].splice(e,0,a.getId()),d>e?(f=d,d=e):f=e):(d=e,m[c].splice(e,0,a.getId()));Z(c,d,f)},$=function(b,e,f){typeof progress=="
                                                                                                                                                                                                                                                                                                                                                                                function "&&progress("screen: "+
                                                                                                                                                                                                                                                                                                                                                                                    e);if(!u[e]){u[e]=!0;var g=p[e].getIconContainer();c.hide(g);var k=new a.fx.Animation({element:g,property:"opacity ",from:0,to:1,unit:!1,duration:2E3,fps:30,transition:d.sinusoidal.easeOut});o[e]=new a.Chunk(b,function(a){a&&(a=y(a,g,e))&&m[e].push(a.getId())},this,!1,function(){ea();setTimeout(function(){a.browser.ie==7||a.browser.ie==6?c.show(g):(c.setStyle(g,"opacity ",0),c.show(g),k.start())},500);f&&f()})}},aa=function(a,b,c){m[b].splice(c,1);a=e[a.getId()];delete e[a.getId()];a.destroy();Z(b,
                                                                                                                                                                                                                                                                                                                                                                                        c)},ba=function(){for(var a=0,b=p.length;a<b;++a)m[a].length=0;for(a in e)b=e[a],e[a]=null,delete e[a],b.destroy&&b.destroy()},Y=function(a,b){typeof b!=="undefined "&&(a=b+"_ "+a);return e[a]},da={},ea=function(){for(var a=0,b=p.length;a<b;++a)da[""+a]||function(a){da[a]=setTimeout(function(){Z(a);da[""+a]=null},500)}(a)},ca=function(a,b,e){var d=n||(n=c.getWidth(a)),g=f||(f=c.getHeight(a)),b=(E-d)/2+b,e=(G-g)/2+e;c.setStyle(a,"left ",b+"px ");c.setStyle(a,"top ",e+"px ")},Z=function(a,b,c){var b=0,c=
                                                                                                                                                                                                                                                                                                                                                                                            -1,e=m[a],d=e.length;if(d==0)ca(h[a],0,0);else{b!==void 0?b>d-1&&(b=d-1):b=0;if(c==void 0||c==-1||c>d-1)c=d-1;var f=Math.floor(b/w)*E,g=b%w*G,k=w*s<=b+1;k&&(f=b%s*E,g=Math.floor(b/s)*G);for(;b<=c;b++)if(k=e[b],k!=void 0&&(k=Y(k)))ca(k.getElement(),f,g),(k=w*s<=b+1)?(b+1)%s==0?(f=0,g+=G):f+=E:(b+1)%w==0?(g=0,f+=E):g+=G;c==d-1&&ca(h[a],f,g);B[a]&&B[a].update(a);x[a]=0}},fa=function(){return alloy.config.configList.defaultScreen||3},ga=function(){return alloy.config.configList.desktopIconStyle||0},ha=
                                                                                                                                                                                                                                                                                                                                                                                            function(a,e,d){alloy.config.configList.desktopIconStyle=a;a==0?(E=142,G=112,c.removeClass(l,"desktopSmallIcon ")):(G=E=90,c.addClass(l,"desktopSmallIcon "));var g=v-46;s=Math.floor((A-28)/E);w=Math.floor(g/G);f=n=0;x=[1,1,1,1,1];Z(t);e&&alloy.portal.getLoginLevel()>alloy.CONST.LOGIN_LEVEL_NONE&&(d?alloy.rpcService.sendMSetConfigDelay({data:{0:{desktopIconStyle:a}},delay:d}):alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{desktopIconStyle:a}}}}));b.notifyObservers(alloy.desktopManager,"DesktopIconStyleChanged ",
                                                                                                                                                                                                                                                                                                                                                                                                    a)};this.init=function(e){var d=e.initializeLength||5,e=e.currentDesktopIndex||Math.floor(d/2);j=alloy.layout.getArea("main ");j.innerHTML='            <div id="desktopsContainer "></div>';l=c.id("desktopsContainer ");c.setClass(l,"desktopsContainer ");r=new a.ui.Sortables([],"id ");var f;p=[];for(var g=0;g<d;++g){f=new Q({index:g,appendTo:l});p.push(f);r.addDropTarget({el:f.getIconContainer(),level:0});m[g]=[];f=g;var k=U.cloneNode(!0);k.setAttribute("screen ",f);p[f].getIconContainer().appendChild(k);
                                                                                                                                                                                                                                                                                                                                                                                                        b.on(k,"click ",X);h.push(k)}L(e,!0);b.addObserver(r,"start ",F.onSortControllerDragStart);b.addObserver(r,"end ",F.onSortControllerDragEnd);b.addObserver(alloy.layout,"desktopResize ",F.onDesktopResize);b.addObserver(alloy.dock,"DockLocationChanged ",F.onDockLocationChanged);b.addObserver(alloy.appconfig,"GetAppConfigComplete ",F.onGetAppConfigComplete);b.addObserver(alloy.appconfig,"GetDefaultAppConfigComplete ",F.onGetAppConfigComplete);b.addObserver(alloy.appconfig,"ClearDefaultApp ",F.onClearDefaultApp);
                                                                                                                                                                                                                                                                                                                                                                                            b.addObserver(alloy.fileSystem,"FileMove ",F.onFileMove);b.addObserver(alloy.fileSystem,"FileAdd ",F.onFileAdd);b.addObserver(alloy.fileSystem,"FileDelete ",F.onFileDelete);b.addObserver(alloy.fileSystem,"FileOperateTimeout ",F.onFileOperateTimeout);b.addObserver(alloy.fileSystem,"FileOperateError ",F.onFileOperateError);b.addObserver(alloy.fileSystem,"AddFileFail ",F.onAddFileFail);b.addObserver(alloy.fileSystem,"CopyFileFail ",F.onCopyFileFail);b.addObserver(alloy.fileSystem,"DeleteFileFail ",F.onDeleteFileFail);
                                                                                                                                                                                                                                                                                                                                                                                            b.addObserver(alloy.fileSystem,"MoveFileFail ",F.onMoveFileFail);b.addObserver(alloy.fileSystem,"UpdateFileFail ",F.onUpdateFileFail);b.addObserver(alloy.portal,"UACReady ",F.onUACReady)};this.DESK_STATUS=g;this.setCurrentDesktop=L;this.goNextDesktop=S;this.goPrevDesktop=W;this.refreshDesktop=function(){r.refreshDropTarget()};this.getDesktop=function(a){return p[a]};this.getDesktopList=function(){return p};this.getCurrentDesktopIndex=function(){return t};this.getCurrentDesktop=function(){return p[t]};
                                                                                                                                                                                                                                                                                                                                                                            this.setDesktopStatus=M;this.getDesktopStatus=function(){return k};this.getDragController=function(){return r};this.getDefaultDesktop=fa;this.setDefaultDesktop=function(a,b,c){a=Number(a);if(b&&alloy.portal.getLoginLevel()>alloy.CONST.LOGIN_LEVEL_NONE)alloy.config.configList.defaultScreen=a,c?alloy.rpcService.sendMSetConfigDelay({data:{0:{defaultScreen:a}},delay:c}):alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{defaultScreen:a}}}})};this.getDesktopIconStyle=ga;this.setDesktopIconStyle=ha});
                                                                                                                                                                                                                                                                                                                                                                            Jx().$package("alloy.portal ",function(a){var c=this,b=a.dom,d=a.event,g=a.http,j=a.cookie,l,p=!1,t,r=alloy.CONST.LOGIN_LEVEL_NONE,u=0,w,s=1,n,f,h=!1,m=!1,o=0,D=0,e,k=!1,B="",x,A,z="",v="",q=null,C=0,E=!1,G,K,P,J,N=!1,I,V,O=[],H=[],T=0,Q="socket ",F,L=0,S={},W,M=null,U=!0;alloy.system=c;var X=[],y=["pgv_info ","ptisp ","uin ","skey ","ptwebqq "];c.saveAndDelLockCookie=function(){for(var a in y)X.push({name:y[a],value:j.get(y[a])}),j.remove(y[a],alloy.CONST.MAIN_DOMAIN)};c.revertLockCookie=function(){for(var a=
                                                                                                                                                                                                                                                                                                                                                                                        X.length-1;a>=0;a--)j.set(X[a].name,X[a].value,alloy.CONST.MAIN_DOMAIN," / ");X=[]};c.speedTest=alloy.util.speedTest;c.isWebTop=function(){return window.webTop?!0:!1};c.isWebTopAir=function(){return/AIR/.test(webTop.type)?!0:!1};c.isWebTopQT=function(){return/QT\//.test(webTop.type)?!0:!1};c.isWebTopWin=function(){return/WIN/.test(webTop.type)?!0:!1};this.setPortalSelf=function(b){c.self=c.self||{};c.self.uin=b.uin||c.getUin();c.self.allow=b.allow;c.self.age=b.age;c.self.nick=b.nick;c.self.vip=b.vip_info;
                                                                                                                                                                                                                                                                                                                                                                            c.self.vipRoam=null;c.self.htmlNick=a.string.encodeHtml(String(b.nick));c.self.titleNick=String(b.nick);c.self.country=b.country;c.self.province=b.province;c.self.city=b.city;c.self.gender=b.gender;c.self.face=b.face;c.self.phone=b.phone;c.self.mobile=b.mobile;c.self.email=b.email;c.self.uiuin=b.uiuin||b.uin};this.setPortalSelfItem=function(a,b){c.self[a]=b};this.getPortalSelf=function(a){return typeof c.self=="undefined "?{}:typeof a=="undefined "?c.self:c.self[a]};this.isNewUser=function(){return k};
                                                                                                                                                                                                                                                                                                                                                                            this.setIsNewUser=function(a){k=a};var ja=function(){a.profile("runCoreApps Start ! ","portal ! ");alloy.notifier.init();c.runApp("tips ",{callback:function(){a.profile("runCoreApps Finish ! ","portal ! ")}})},$=function(){var a=c.getLoginLevel(),b;a==1?b="panel ":a==2?b="go ":a==3&&(b="logined ");return b};this.setReRunAppList=function(a){O=a};this.getReRunAppList=function(){return O};var aa=function(){a.profile("reRunBeforeLoginApps Start ! ","portal ! ");if(O){for(var b=0;b<O.length;++b){var e,d;a.isArray(O[b])?
                                                                                                                                                                                                                                                                                                                                                                                (e=O[b][0],d=O[b][1],d=c.getUrlOption(e)||d,c.removeUrlOption(e)):e=O[b];var f=c.getApp(e);f&&!f.isRunning()&&(e==alloy.config.__eqqid?(e=$(),a.debug("run EQQ in [reRunBeforeLoginApps], level: "+c.getLoginLevel()+": "+e,"_plogin "),c.runApp(alloy.config.__eqqid,{loginMode:e})):d?c.runApp(e,d):c.runApp(e))}c.setReRunAppList([])}a.profile("reRunBeforeLoginApps Finish ! ","portal ! ")};this.getDefaultRunApps=function(){M=M==null?[]:M;return[].concat([],[],M)};var ba=function(){var b=decodeURIComponent(window.location.search);
                                                                                                                                                                                                                                                                                                                                                                                    if(b.indexOf("appUrl ")==-1&&(b=a.string.mapQuery(b).run||""))return a.json.parse(b)},Y=function(){var b=ba();if(a.isObject(b))for(var e in b)alloy.portal.runApp(e,c.getUrlOption(e)||{runFrom:"url "});window.location.search.indexOf("_APPBOX ")>-1&&alloy.util.report2qqweb("monitor | signin | fromqqclient ");window.location.search.indexOf("CLIENT.QQ.PROFILE ")>-1&&alloy.util.report2qqweb("monitor | signin | fromqqclientminicard ")},da=function(b){if(a.isObject(b))for(var c in b)if(a.isObject(b[c])||a.isArray(b[c])){if(!arguments.callee.call(this,
                                                                                                                                                                                                                                                                                                                                                                                            b[c]))return!1}else{if(!a.isNumber(b[c])&&/(\'|\")/g.test(b[c]))return a.error("urlApp option\u4e2dvalue\u503c\u7684\u5b57\u7b26\u4e32\u4e0d\u80fd\u5305\u542b\u5355\u53cc\u5f15\u53f7\uff01 "),!1}else if(a.isArray(b))for(var e=0;e<b.length;e++)if(a.isObject(b[e])||a.isArray(b[e])){if(!arguments.callee.call(this,b[e]))return!1}else{if(!a.isNumber(b[e])&&/(\'|\")/g.test(b[c]))return a.error("urlApp option\u4e2dvalue\u503c\u7684\u5b57\u7b26\u4e32\u4e0d\u80fd\u5305\u542b\u5355\u53cc\u5f15\u53f7\uff01 "),
                                                                                                                                                                                                                                                                                                                                                                                        !1}else return!1;return!0},ea=function(){var b=ba();if(a.isObject(b))for(var e in b)if(a.isObject(b[e]))da(b[e])?(b[e].runFrom="url ",f={},~~e!=0&&!c.getAllConfig(e)&&(f.appMarket={page:"introduce ",option:{appid:e},runFrom:"url "}),f[e]=b[e]):b[e].runFrom="url "};this.getUrlOption=function(a){return f&&f[a]||null};this.removeUrlOption=function(a){f&&delete f[a];f&&!a&&(f=null)};this.getIsAlloyJsReady=function(){return w};var ca=function(){a.profile("reset start ! ","portal ! ");if(w){var b=c.getRunningAppStatus();
                                                                                                                                                                                                                                                                                                                                                                                            if(b){N=!0;for(var e=0;e<b.appList.length;e++){var f=b.appList[e].appId;~~f&&(f="app "+f);(f=alloy.app[f])&&f.isRunning()&&f.exit()}N=!1}}h=!1;d.notifyObservers(alloy.portal,"reset ",c.getLoginLevel());a.profile("reset finish ! ","portal ! ")},Z=function(){I=n=!0;a.profile("tryLogin start, tryLoginLevel: "+r,"portal ! ");qqweb.util.report2h("pass_ptlogin ","start ");typeof progress=="
                                                                                                                                                                                                                                                                                                                                                                                                function "&&progress("pass_ptlogin ");if(r>alloy.CONST.LOGIN_LEVEL_NONE)if(alloy.util.report2h("get_vfwebqq ","start "),u=c.getCookieUin(),
                                                                                                                                                                                                                                                                                                                                                                                K){if(c.setUin(u),ga()?ca():I=!1,r==alloy.CONST.LOGIN_LEVEL_ALL){c.setLoginLevel(alloy.CONST.LOGIN_LEVEL_ALL);a.debug("run EQQ in [tryLogin], tryLoginLevel: "+r,"_plogin ");var b={directLogin:!0};if(c.getTryLoginState())b.loginState=c.getTryLoginState();c.runApp(alloy.config.__eqqid,b)}}else alloy.rpcService.sendGetSeftInfo(u);else u=0,c.setUin(u),fa();a.profile("tryLogin finish ! ","portal ! ")},fa=function(){d.notifyObservers(c,"SimpleUACReady ",{uacLoaded:3})},ga=function(){return c.getUin()===c.getOldUin()?
                                                                                                                                                                                                                                                                                                                                                                                    (a.debug("uin not change: "+c.getUin(),"_plogin "),!1):(a.debug("uin change: "+c.getOldUin()+" - >"+c.getUin(),"_plogin "),!0)},ha=function(){return s===t?(a.debug("loginLevel not change: "+s,"_plogin "),!1):(a.debug("loginLevel change: "+t+" - >"+s,"_plogin "),!0)},ia=function(){p||alloy.portal.recoverCookie()};this.longPoll=function(b){if(b)b=b.r,T=b.ssid,H=b.al;alloy.rpcService.psSend(alloy.CONST.PS_CGI_URL+"kl / poll ",{context:c,method:"GET ",timeout:61E3,data:{ssid:T},onSuccess:function(b){if(b.c==
                                                                                                                                                                                                                                                                                                                                                                                            0)for(var b=b.r,e=b.ml,d=0;d<e.length;++d)a.event.notifyObservers(qqweb.portal,"message ",e[d]);b.c!=22905?c.longPollIn():L<3&&(c.longPollLogin(),++L)},onError:function(){},onTimeout:function(){}})};this.longPollIn=function(){alloy.rpcService.psSend(alloy.CONST.PS_CGI_URL+"kl / poll ",{context:c,method:"GET ",timeout:61E3,data:{ssid:T},onSuccess:function(b){if(b.c==0)for(var b=b.r,e=b.ml,d=0;d<e.length;++d)a.event.notifyObservers(qqweb.portal,"message ",e[d]);b.c!=22905?c.longPollIn():L<3&&(c.longPollLogin(),
                                                                                                                                                                                                                                                                                                                                                                                                ++L)},onError:function(){},onTimeout:function(){}})};this.longPollLogin=function(){alloy.rpcService.psSend(alloy.CONST.PS_CGI_URL+"kl / login ",{context:c,method:"GET ",timeout:1E4,data:{ct:1,sl:0,ua:1},onSuccess:function(a){a.c==0?c.longPoll(a):L<3&&(c.longPollLogin(),++L)},onError:function(){},onTimeout:function(){}})};this.initPushService=function(){a.browser.plugins.flash?b.id("socketFlash ").innerHTML='<object style="position: absolute; left: 1px; top: 1px;
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var sa = function() {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                R = {
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            try {
                                                                                                                                                                                                                                                                                                                                                                                                typeof pgvMain == "function" && (window.webTop ? pgvMain("", {
                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                    virtualDomain: alloy.CONST.DEFAULT_DOMAIN
                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                       qqweb.util.report2h("portal", "end", "ok"),
                                                                                                                                                                                                                                                                                                                                                                                                       qqweb.portal.speedTest.sRTS(8, "end", new Date, !0)
                                                                                                                                                                                                                                                                                                                                                                                            } catch(e) {}
                                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    onGetLoginInfoSuccess: function(a) {
                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                        if (!a || !a.isSelfInfoLoad) alloy.util.report2h("get_selfinfo", "start"),
                                                                                                                                                                                                                                                                                                                                                                                           alloy.rpcService.sendGetUserInfo(alloy.portal.getUin())
                                                                                                                                                                                                                                                                                                                                                                                    },
                                                                                                                                                                                                                                                                                                                                                                                    onGetSelfInfoSuccess: function(b) {
                                                                                                                                                                                                                                                                                                                                                                                        if (b.retcode == 0) {
                                                                                                                                                                                                                                                                                                                                                                                            var c = b.arguments.uin,
                                                                                                                                                                                                                                                                                                                                                                                                e = b.result;
                                                                                                                                                                                                                                                                                                                                                                                            if (alloy.portal.getUin() == c) e.uiuin = alloy.portal.getCookiePTUiUin(),
                                                                                                                                                                                                                                                                                                                                                                                               alloy.portal.setPortalSelf(e),
                                                                                                                                                                                                                                                                                                                                                                                                   d.notifyObservers(alloy.portal, "selfInfoReady", alloy.portal.getPortalSelf()),
                                                                                                                                                                                                                                                                                                                                                                                                       qqweb.util.report2h("get_selfinfo", "end", ["ok"][b.retcode] || b.retcode),
                                                                                                                                                                                                                                                                                                                                                                                                       alloy.util.stat.report()
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    onAppRun: function(a) {
                                                                                                                                                                                                                                                                                                                                                                                        if (! (alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE || !alloy.portal.getVfWebQQ() || !Number(a))) if ((a = alloy.portal.getAllConfig(a)) && !(a.preview || a.windowType != "widget")) a = la(),
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    onAppExit: function(a) {
                                                                                                                                                                                                                                                                                                                                                                                        if (! (alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE || !alloy.portal.getVfWebQQ() || N || a.preview)) {
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            if (b && (a = Number(a.option.id)) && /(window)|(widget)/.test(b.windowType)) {
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                if (c) if (c.selfConfig = c.selfConfig || {},
                                                                                                                                                                                                                                                                                                                                                                                                        b.windowType == "widget") {
                                                                                                                                                                                                                                                                                                                                                                                                            var e = b.getX(),
                                                                                                                                                                                                                                                                                                                                                                                                            b = b.getY();
                                                                                                                                                                                                                                                                                                                                                                                                            c.selfConfig.x = e;
                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                            c = {};
                                                                                                                                                                                                                                                                                                                                                                                                            c.defaultMode = b;
                                                                                                                                                                                                                                                                                                                                                                                                            if (b != "fullscreen" && b != "max") c.width = e,
                                                                                                                                                                                                                                                                                                                                                                                                               c.height = d;
                                                                                                                                                                                                                                                                                                                                                                                                            alloy.rpcService.sendSetConfig({
                                                                                                                                                                                                                                                                                                                                                                                                                data: {
                                                                                                                                                                                                                                                                                                                                                                                                                    r: {
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var ma = 6E5,
                                                                                                                                                                                                                                                                                                                                                                                na = 6E6,
                                                                                                                                                                                                                                                                                                                                                                                oa = 42E6; this.changeCheckOpenKeyFrequency = function(b) {
                                                                                                                                                                                                                                                                                                                                                                                    ma = b.check * 1E3;
                                                                                                                                                                                                                                                                                                                                                                                    na = b.renewal * 1E3;
                                                                                                                                                                                                                                                                                                                                                                                    oa = b.reload * 1E3;
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var ta = function() {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                var c, e, d = !1,
                                                                                                                                                                                                                                                                                                                                                                                    f;
                                                                                                                                                                                                                                                                                                                                                                                for (f in S) if (e = Number(f)) d = !0,
                                                                                                                                                                                                                                                                                                                                                                                    c = S[f],
                                                                                                                                                                                                                                                                                                                                                                                        b - c.createTime >= oa ? (a.debug("\u8fc7\u671f\u91cd\u62c9(appId: " + e + "):" + (b - c.createTime) / 1E3, "OpenKey"), alloy.config.reRequestGrant({
                                                                                                                                                                                                                                                                                                                                                                                            appId: e
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (e.e == 0) if (a.isUndefined(e.appid)) {
                                                                                                                                                                                                                                                                                                                                                                                    if (e.sid) H = e.al,
                                                                                                                                                                                                                                                                                                                                                                                        alloy.util.report2qqweb("push|loginsuccess")
                                                                                                                                                                                                                                                                                                                                                                                } else a.event.notifyObservers(qqweb.portal, "message", e);
                                                                                                                                                                                                                                                                                                                                                                                else c.longPollLogin(),
                                                                                                                                                                                                                                                                                                                                                                                    Q = "longPoll",
                                                                                                                                                                                                                                                                                                                                                                                        a.error("PushService error: " + b),
                                                                                                                                                                                                                                                                                                                                                                                            alloy.util.report2qqweb("push|loginfail")
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (c.appid) a.event.notifyObservers(qqweb.portal, "message", c),
                                                                                                                                                                                                                                                                                                                                                                                   a.event.notifyObservers(qqweb.portal, "message" + c.appId, b);
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                A = x;
                                                                                                                                                                                                                                                                                                                                                                                return x = a
                                                                                                                                                                                                                                                                                                                                                                            }; this.recoverCookie = function() {}; this.validatePTLoginSuccess = function(b) {
                                                                                                                                                                                                                                                                                                                                                                                b = b || {};
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (Number(b.login2qq) === 1) {
                                                                                                                                                                                                                                                                                                                                                                                    r = 3;
                                                                                                                                                                                                                                                                                                                                                                                    if (b = b.webqq_type || 0) b = alloy.util.code2state(b),
                                                                                                                                                                                                                                                                                                                                                                                       alloy.portal.setTryLoginState(b);
                                                                                                                                                                                                                                                                                                                                                                                    alloy.portal.setTryLoginType(!0)
                                                                                                                                                                                                                                                                                                                                                                                } else r = 2,
                                                                                                                                                                                                                                                                                                                                                                                    alloy.portal.setTryLoginType(!1);
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var ua = function(a, b) {
                                                                                                                                                                                                                                                                                                                                                                                alloy.rpcService.getAppInfo(a, ["appName", "appType", "appUrl", "iconUrl", "id", "category", "exinfo", "al", "gaid"],
                                                                                                                                                                                                                                                                                                                                                                                        function(c) {
                                                                                                                                                                                                                                                                                                                                                                                            if (c.retcode === 0) c = c.result.resultData,
                                                                                                                                                                                                                                                                                                                                                                                    c.preview = !0,
                                                                                                                                                                                                                                                                                                                                                                                    alloy.appconfig.addAppConfigTemp(c),
                                                                                                                                                                                                                                                                                                                                                                                    alloy.portal.runApp(a, b)
                                                                                                                                                                                                                                                                                                                                                                                        })
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (w) {
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    if (!d) return a.out("id:" + b),
                                                                                                                                                                                                                                                                                                                                                                                       d = e.runFrom,
                                                                                                                                                                                                                                                                                                                                                                                           b = Number(b),
                                                                                                                                                                                                                                                                                                                                                                                             e.preview ? ua(b, e) : b != 19 && (h ? alloy.portal.runApp("appMarket", {
                                                                                                                                                                                                                                                                                                                                                                                                 page: "introduce",
                                                                                                                                                                                                                                                                                                                                                                                             option: {
                                                                                                                                                                                                                                                                                                                                                                                                 appid: b
                                                                                                                                                                                                                                                                                                                                                                                             },
                                                                                                                                                                                                                                                                                                                                                                                             runFrom: d
                                                                                                                                                                                                                                                                                                                                                                                             }) : alert("\u56e0\u7f51\u7edc\u73af\u5883\u95ee\u9898\u5bfc\u81f4\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5c1d\u8bd5\u91cd\u65b0\u767b\u5f55\u3002")),
                                                                                                                                                                                                                                                                                                                                                                                             !1;
                                                                                                                                                                                                                                                                                                                                                                                    if (b == "appMarket" && !h) return alert("\u56e0\u7f51\u7edc\u73af\u5883\u95ee\u9898\u5bfc\u81f4\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5c1d\u8bd5\u91cd\u65b0\u767b\u5f55\u3002"),
                                                                                                                                                                                                                                                                                                                                                                                       !1;
                                                                                                                                                                                                                                                                                                                                                                                    var f = this.getApp(b),
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (!this.getAppLoading(b.id)) {
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    var e = b.id,
                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                        f = d + (b.css || "style.css");
                                                                                                                                                                                                                                                                                                                                                                                    d += b.js || "main.js"; (b.css || a.isNumber(e)) && g.loadCss(f + "?" + alloy.CONST.UPDATE_TIME_STAMP);
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var pa = function(b) {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                if (b.retcode == 0 && b.result) {
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    var g = !0,
                                                                                                                                                                                                                                                                                                                                                                                        k;
                                                                                                                                                                                                                                                                                                                                                                                    for (k in f) f[k] in b || (g = !1),
                                                                                                                                                                                                                                                                                                                                                                                        (b[f[k]] === null || typeof b[f[k]] === "undefined") && delete b[f[k]];
                                                                                                                                                                                                                                                                                                                                                                                    e.selfConfig = g ? b: {}
                                                                                                                                                                                                                                                                                                                                                                                } else e.selfConfig = {};
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                var b;
                                                                                                                                                                                                                                                                                                                                                                                if (b = c.getApp(a)) b.isRunning() && b.exit(),
                                                                                                                                                                                                                                                                                                                                                                                   delete alloy.app["app" + a]
                                                                                                                                                                                                                                                                                                                                                                            }; this.setAppLoading = function(a, b) {
                                                                                                                                                                                                                                                                                                                                                                                return l[a] = b
                                                                                                                                                                                                                                                                                                                                                                            }; this.getAppLoading = function(a) {
                                                                                                                                                                                                                                                                                                                                                                                return l[a]
                                                                                                                                                                                                                                                                                                                                                                            };
                                                                                                                                                                                                                                                                                                                                                                            var ka = "\u60a8\u786e\u5b9a\u8981\u79bb\u5f00\u201cQ+ Web\u201d\u5417\uff1f"; this.setCloseHookMessage = function(a) {
                                                                                                                                                                                                                                                                                                                                                                                ka = a
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            var qa = function(b) {
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                this.getExitConfirm() > 0 ? P ? (P.setWindowCentered(), P.setCurrent()) : P = alloy.layout.confirm("\u60a8\u786e\u8ba4\u8981\u6ce8\u9500  Q+ Web \u5417\uff1f",
                                                                                                                                                                                                                                                                                                                                                                                        function() {
                                                                                                                                                                                                                                                                                                                                                                                            c.removeCloseHook();
                                                                                                                                                                                                                                                                                                                                                                                            pgvSendClick({
                                                                                                                                                                                                                                                                                                                                                                                                hottag: "web2qq.qqpanel.status.exitQQ"
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            }; c.getLoginState = c.getLoginLevel; c.isAppInstalled = function(b) {
                                                                                                                                                                                                                                                                                                                                                                                if (a.isArray(b.appId)) {
                                                                                                                                                                                                                                                                                                                                                                                    for (var c = {},
                                                                                                                                                                                                                                                                                                                                                                                            e = 0; e < b.appId.length; e++) c[b.appId[e]] = alloy.config.isInSetupAppList(b.appId[e]) ? !0 : !1;
                                                                                                                                                                                                                                                                                                                                                                                    return c
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                c.onError = b.onError;
                                                                                                                                                                                                                                                                                                                                                                                if (!a.isArray(b.appList)) c.appList = [],
                                                                                                                                                                                                                                                                                                                                                                                   c.appList.push(b.appList);
                                                                                                                                                                                                                                                                                                                                                                                alloy.rpcService.getAppInfoMulti(c)
                                                                                                                                                                                                                                                                                                                                                                            }; c.isLocked = function() {
                                                                                                                                                                                                                                                                                                                                                                                return qqweb.app.screenLocker && qqweb.app.screenLocker.isLocked() ? !0 : !1
                                                                                                                                                                                                                                                                                                                                                                            }; c.openURL = c.openInWebBrowser; c.search = function(a) {
                                                                                                                                                                                                                                                                                                                                                                                a = a.keyword;
                                                                                                                                                                                                                                                                                                                                                                                if (a == "") return ! 1;
...
Jet().$package("alloy.layout",
    ...
    E = {
        ...
        layout_window_closeall: function() {
            for (var a = alloy.windowManager.getWindowList(), b, c = a.length - 1; c >= 0; c--) b = a[c],
            b.windowType == "window" && b.close();
...
var J = function() {
    ...
    N = function(a) {
        if (alloy.hotkeyManager.isHotkeyEnable()) {
            ...
            if (G[b]) {
                var c = alloy.hotkeyManager.getHotkeyInfo(G[b].keyId); ! c.disable && (!alloy.hotkeyManager.isHotkeyLimited() || !c.limit) && G[b].action(a)
            }
        }
    },
    I = function(a) {
        ...
        if (c) for (var d = 0,
                f = b.length; d < f; d++) {
                    if (e = b[d], c == e) {
                        c = d; (e = b[c += a]) ? e.setCurrent() : c < 0 ? (e = b[b.length - 1], e.setCurrent()) : c >= b.length && (e = b[0], e.setCurrent());
                        break
                    }
...
var H = function(a) {
    ...
    T = function() {
        ...
        h.leftArea = q;
        h.rightArea = k;
        if (a.browser.mobileSafari) e = b.id("touchpad"),
           b.show(e),
               e.src = qqweb.CONST.MAIN_URL + "./touchpad.html?20101021001",
                   d.on(l, "touchmove",
                           function(a) {
...
this.showDesktop = function() {
    for (var a = [], b, c = alloy.windowManager.getCurrentWindow(), e = alloy.windowManager.getWindowList(), d = 0; d < e.length; d++) b = e[d],
        b.windowType !== "widget" && b.isShow && b.isShow() && (b.min(), a.push(b));
    if (a.length > 0) v = a,
       q = c;
    else {
...
this.setTitle = function(a, b) {
    ...
    b.speed = b.speed || 500;
    if (b.roll) {
        if (! (a.length < 1)) t = document.title,
            r && clearInterval(r),
...
this.setIe9IconOverLay = function(a) {
    ...
    if (a == 0) try {
        ...
        window.external.msSiteModeSetIconOverlay("http://" + b + "/" + c[a - 1] + ".ico", "overlay " + a),
            window.external.msSiteModeActivate()
    } catch(d) {} else if (a >= 10) try {
        window.external.msSiteModeSetIconOverlay("http://" + b + "/" + c[9] + ".ico", "overlay 10"),
            window.external.msSiteModeActivate()
    } catch(f) {}
};
...
this.showWebTopInstallBox = function() {
    if (a.platform.win) window.open("http://dl_dir.qq.com/qqfile/web/webqq/WebQQ_1.2.46.400.exe", "_blank");
        ...
        d.on(c, "click",
                function(a) {
                    var b = a.target.href;
                    if (b) return a.preventDefault(),
            window.open(b, "_blank"),
            !1
                });
        a.platform.linux && (c = b.id("airDownloadSelect"), d.on(c, "change",
                    function() {
    ...
    x = function() {
        ...
        e = alloy.iconFactory.createIcon("app", {
          ...
          onClick: function() {
              ...
              } else alloy.portal.runApp("appMarket"),
              alloy.util.report2qqweb("screen|appmarket");
              e.hideNotify();
              return ! 1
          }
        },
    ...
    z = {
        ...
        onQuickListContainerDrop: function(a) {
            ...
            if (!isNaN(a)) {
                ...
                c.getAttribute("from");
                var g; (g = alloy.fileSystem.getFileInfoByFile(e)) && alloy.fileSystem.moveFile(g.file, 5, d, g.parent.id, g.position, !0)
            }
        },
...
this.setDockLocation = function(a, c, e) {
    if ("left right top".indexOf(a) != -1) {
        ...
        if (c) {
            if (alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE) alloy.config.configList.dockLoca = a,
                e ? alloy.rpcService.sendMSetConfigDelay({
                    data: {
                        0 : {
                            dockLoca: a
                        }
...
var q = function(b, c) {
    ...
    a: {
        ...
        else if (b.t == d.FOLDER || b.t == d.FILE) e.file = b,
            e = alloy.iconFactory.createIcon(b.t, e, b);
        else {
            e = null;
            break a
        }
    ...
    E = function(a) {
        if (a = m[a.t + "_" + a.id]) m[a.getId()] = null,
        delete m[a.getId()],
            f--,
                a.destroy()
    },
...
Jx().$package("alloy.startMenu",
    ...
    s = {
        ...
        onStartMenuBodyClick: function(a) {
            ...
            if (b && b != "help") switch (l.hide(), a.preventDefault(), a.stopPropagation(), a = b.getAttribute("cmd"), a) {
                ...
                case "lock":
                    ...
                    pgvSendClick({
                        hottag:
                        "WEB2QQ.TASKBAR.SCREENLOCKER.LOGIN"
                    });
        ...
        onStartMenuBodyMouseover: function(a) {
            var c; ((c = a.target).tagName == "LI" || (c = a.target.parentNode).tagName == "LI") && b.setClass(c, "taskbar_start_menu_hover")
        },
        onStartMenuBodyMouseout: function(a) {
            var c; ((c = a.target).tagName == "LI" || (c = a.target.parentNode).tagName == "LI") && b.setClass(c, "")
        },
        onHelpMenuMouseover: function(a) { (a = alloy.util.getActionTarget(a, 2)) && b.setClass(a, "taskbar_help_menu_hover")
        },
        onHelpMenuMouseout: function(a) { (a = alloy.util.getActionTarget(a, 2)) && b.setClass(a, "")
        },
        onSelfInfoAreaClick: function(a) {
            a.preventDefault();
            if (alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE) alloy.layout.showLoginWindow(""),
               alloy.util.report2qqweb("taskbar|start|signin");
            else if (a = parseInt(this.getAttribute("uin"), 10)) alloy.portal.runApp("userDetails", a),
                 alloy.util.report2qqweb("taskbar|start|profile")
        },
    ...
    f = {
        ...
        onFolderContainerDrop: function(a) {
            ...
            if (!isNaN(f)) {
                ...
                c.getAttribute("from");
                var g; (g = alloy.fileSystem.getFileInfoByFile(e)) && alloy.fileSystem.moveFile(g.file, a, d, null, null, !0)
            }
        },
        onDockContainerDrop: function(a) {
            ...
            if (!isNaN(f)) {
                ...
                c.getAttribute("from");
                var g; (g = alloy.fileSystem.getFileInfoByFile(e)) && alloy.fileSystem.moveFile(g.file, a, d, g.parent.id, g.position, !0)
            }
        },
        onFileMove: function(a) {
            if (a.targetId >= 0 && a.targetId < 5) {
                ...
                } else if ((b = m(a.file.id, a.file.t)) && h(b, a.sourceId, a.sourcePosition), b = B([a.file], a.targetId)[0]) b = b.getElement(),
                    c = b.parentNode,
                        e = a.targetPosition,
                          c.childNodes[e] && c.insertBefore(b, c.childNodes[e]);
                j[a.targetId] && j[a.targetId].update();
                j[a.sourceId] && j[a.sourceId].update()
            } else if ((b = m(a.file.id, a.file.t)) && h(b, a.sourceId, a.sourcePosition), b = k([a.file], a.targetId)[0]) b = b.getElement(),
            c = b.parentNode,
                e = a.targetPosition + 1,
                  a.sourceId == 5 && c.removeChild(b),
                  c.childNodes[e] && c.insertBefore(b, c.childNodes[e])
        }
    },
    h = function(a) {
...
var D = function() {
    ...
    x = function(b, c) {
        ...
        if (b.t == d.APP) {
            ...
            if (!e) return a.profile('appManager createFolderIcon. id="' + b.id + '" appConfig is null', "appManager"),
               alloy.fileSystem.deleteFile(b, null, null, null, !1),
                   null;
            e = alloy.iconFactory.createIcon(b.t, c, e)
        } else if (b.t == d.BUDDY || b.t == d.GROUP) e = alloy.iconFactory.createIcon(b.t, c, b);
        else if (b.t == d.FOLDER || b.t == d.FILE) c.file = b,
            e = alloy.iconFactory.createIcon(b.t, c, b);
        w[e.getId()] = e;
...
var j = null,
    ...
    k = function(c) {
        ...
        if (c = b.mini(".taskItemIcon img", c)[0]) d.on(c, "error",
                function() {
                    this.src = w
                })
    },
    ...
    z = function(c) {
        ...
        this.setItemName = function(b, c) { ! a.isUndefined(o[b]) && o[b] && o[b].setName(c)
        };
        ...
        this.setCurrent = function(a) {
            if (!z) return ! 1;
            D = a; (a = this.getItem(a)) && a.setCurrent();
            b.addClass(z, "taskCurrent")
        };
        this.setNotCurrent = function(a) {
            if (!z) return ! 1; (a = this.getItem(a)) && a.setNotCurrent();
            b.removeClass(z, "taskCurrent")
        };
        this.jumpUp = function(a) {
            b.addClass(z, "taskJumpUp"); (a = this.getItem(a)) && a.jumpUp()
        };
        this.jumpDown = function() {
    ...
    v = {
        ...
        bindDom: function() {
            ...
            c;
            for (c in a) d.on(a[c], "click", this.onClick),
                d.on(a[c], "mouseup", this.onMouseUp),
                    d.on(a[c], "contextmenu", this.onRightClick)
        },
        unbindDom: function() {
            var a = b.mini(".taskItem", this._mainDom),
            c;
            for (c in a) d.off(a[c], "click"),
                d.off(a[c], "mouseup"),
                    d.off(a[c], "contextmenu")
        },
        ...
        setPage: function() {
            ...
            if (e > c) {
                if (!this._domPageUp) this._domPageUp = e = b.node("a", {
                    ...
                    d.on(e, "click", this.menuUp),
                        d.on(e, "mouseup",
                                function(a) {
                                    a.stopPropagation()
                                }),
                        this._mainDom.insertBefore(e, a.browser.ie && a.browser.ie < 9 ? this._mainDom.firstChild: this._mainDom.firstElementChild),
                        e = b.node("a", {
                            "class": "taskMenuDown",
                        href: "#",
                        hidefocus: "true"
                        }),
                        d.on(e, "click", this.menuDown),
                        d.on(e, "mouseup",
                                function(a) {
                                    a.stopPropagation()
                                }),
                        this._domPageDown = e,
                        this._mainDom.appendChild(e);
                b.setStyle(this._contentDom, "height", c + "px");
                a.platform.iPad && this.setIpad();
                this.downToBottom()
            } else this._domPageUp && (b.hide(this._domPageUp), b.hide(this._domPageDown), a.platform.iPad && this.removeIpad()),
               b.setStyle(this._contentDom, "height", e + "px")
        },
        resetPage: function() {
        ...
        setIpad: function() {
            ...
            a.addEventListener("touchmove",
                    function(a) {
                        ...
                        if (a < -5) {
                            if (b.isShow(v._domPageUp)) v.menuDown(null, -a),
                v._isMove = !0
                        } else if (a > 5) {
                            if (b.isShow(q._domPageDown)) v.menuUp(null, a),
                v._isMove = !0
                        } else return ! 1;
    ...
    q = {
        ...
        setDockMargin: function() {
            ...
            } else if (this._dockMarginWidth > 0) this._dockMarginWidth = -1,
            this.setBottomAreaWidth()
        },
        checkShowDockMargin: function() {
            ...
            if ((b.getClientHeight() - a) / 2 - 64 < 0) {
                if (this._dockMarginWidth == 0) a = q.getAvailableWidth(),
                    this._dockMarginWidth = b.getClientWidth() - a,
                        this.setBottomAreaWidth()
            } else this._dockMarginWidth = 0,
               this.setBottomAreaWidth()
        },
        ...
        setIpad: function() {
            ...
            a.addEventListener("touchmove",
                    function(a) {
                        ...
                        if (a > 50) {
                            if (b.isShow(q._preBox)) q.onPre(null, a),
                q._isMove = !0
                        } else if (a < -50) {
                            if (b.isShow(q._nextBox)) q.onNext(null, -a),
                q._isMove = !0
                        } else return ! 1;
    ...
    C = {
        onNewTaskItem: function(b) {
            ...
            e = o(c);
            if (a.isUndefined(e) || !e) e = new z(b),
               e.init(),
                   m[c] = e;
            e.addItem({
                id: b.id,
    ...
    E = function(b, e) {
        ...
        if (g == "app") {
            ...
            if (g == "single") h.id = k.uin,
               h.name = k.markName || k.nick,
                   h.title = h.name + " - " + EQQ.hash.onlineStatusText[k.state],
                       h.icon = alloy.util.getUserAvatar(k.uin);
            else if (g == "group") h.id = k.gid,
                 h.name = k.markName || k.name,
                     h.icon = alloy.util.getGroupAvatar(k.code);
            else if (g == "discu") h.id = k.did,
                 h.name = k.name,
                     h.icon = alloy.util.getDiscuAvatar(k.did);
            if (!p) h.groupId = h.appId,
               h.appId = h.appId + "_" + h.id;
            C.onNewTaskItem(h);
            g == "single" && S({
                id: k.uin,
              state: k.state
            ...
            if (!p) g.groupId = g.appId,
               g.appId = g.appId + "_" + g.id;
            C.onNewTaskItem(g)
        } else if (g == "diskAdmin") {
            g = b.option;
...
var S = function(b) {
    ...
    M = {
        _default: [{
            ...
            onClick: function(a, b, c) {
                a = c.getArgument(); (a = D(a.appId, a.id)) && a.winMax()
            }
        },
        {
            text: "\u6700\u5c0f\u5316",
            onClick: function(a, b, c) {
                a = c.getArgument(); (a = D(a.appId, a.id)) && a.winMin()
            }
        },
        {
            type: "separator"
        },
        {
            text: "\u5173\u95ed",
            onClick: function(a, b, c) {
                a = c.getArgument(); (a = D(a.appId, a.id)) && a.close()
            }
        }],
        _defaultNoMax: [{
            text: "\u6700\u5c0f\u5316",
    ...
    U = function(b, c) {
        ...
        var e = b,
            d = [];
        if (a.isUndefined(c)) d = M[e],
           a.isUndefined(d) && (d = M._defaultGroup);
...
Jx().$package("alloy.rpcService",
    ...
    if (d.method == "GET") {
        ...
        f && (b = b + "?" + f);
        d.data = null
    } else d.contentType = "application/x-www-form-urlencoded",
       b.indexOf("?");
    ...
    var j = function() {
        ...
        try {
            if (b.ajax) {
                ...
                for (var c = g._ajaxCallbacks,
                    b = 0,
                    e = c.length; b < e; b++) g.proxySend(c[b].url, c[b].option);
                g._ajaxCallbacks = []
            } else a.warn("ProxyRequest >>>>> ajaxProxy error: ajax is undefined!!!!", "ProxyRequest"),
               alloy.util.report2h("proxyrequest_error", "start")
        } catch(d) {
            a.error("ProxyRequest >>>>> ajaxProxy error: " + d.message + " !!!!", "ProxyRequest"),
    ...
    d.on(proxyIframe, "load",
        function() {
            ...
            for (var a = h._ajaxCallbacks,
                b = 0,
                c = a.length; b < c; b++) h.proxySend(a[b].url, a[b].option);
            h._ajaxCallbacks = []
        });
...
this.proxySend = function(a, b, c, d) {
    ...
    c += (/\?/.test(c) ? "&": "?") + "callback=1"; (d ? j.getCfProxy(c) : j.getProxy(c)).send(a, b)
};
    ...
    init: function(a) {
        if (this._isInit != !0) {
            ...
            for (var c = document.body,
                    d, f = 0; f < a; f++) d = b.node("div", {
                        "class": "RPCService_hDiv"
                    }),
                        b.hide(d),
                            d.innerHTML = '<iframe id="RPCService_hIframe_' + f + '" name="RPCService_hIframe_' + f + '" src="' + alloy.CONST.MAIN_URL + 'domain.html"></iframe>',
                            c.appendChild(d),
                            this._iframes[f] = [d, null, "RPCService_hIframe_" + f];
            this._isInit = !0
        }
    },
    take: function(a) {
...
this.formSend = function(a, c) {
    ...
    if (Object.prototype.toString.call(d.data).indexOf("String") > -1) {
        ...
        g.name = d.data;
        f.appendChild(g)
    } else for (var j in d.data) g = b.node("input"),
       g.type = "text",
           g.name = j,
               g.setAttribute("value", d.data[j]),
               f.appendChild(g);
    h.take(f);
    f.submit()
};
...
var m, o = function(c, f) {
    ...
    d.addObserver(m, "clickOkButton",
            function() {
                var a = j.value;
                if (a && l) return f(c, a, l),
        !1;
    j.focus();
...
this.sendGetUserInfo = function(a, f, g, h) {
    this.send(alloy.CONST.API_SERVER_URL + "get_friend_info2", {
        ...
        onSuccess: function(f) {
            ...
            0), h ? h.call(this, f) : d.notifyObservers(this, "GetUserInfoSuccess", f)) : f.retcode === 1E3 ? o(a,
            function(a, b, e) {
...
this.sendGetSingleInfo = function(a, f, g, h) { ! f || !g ? o(a,
        function(a, b, e) {
...
this.sendGetUserInfo_with_code = function(e, f, g, h, j) {
    ...
    this.send(alloy.CONST.API_SERVER_URL + "get_stranger_info2", {
        ...
        function(a) {
            ...
            0), h && h.call(this, a), d.notifyObservers(this, "GetUserInfoSuccess", a)) : a.retcode === 1E3 ? o(e,
            function(a, b, e) {
...
this.sendGetFriendUin2 = function(e, f, g, h, j, l) {
    this.send(alloy.CONST.API_SERVER_URL + "get_friend_uin2", {
        ...
        onSuccess: function(a) {
            ...
            0), g && g(a), d.notifyObservers(this, "GetFriendUinSuccess", a)) : a.retcode === 1E3 ? o(e,
            function(a, b, e) {
...
this.sendGetBuddyList = function(b, c, f) {
    ...
    this.send(alloy.CONST.API_SERVER_URL + "get_user_friends2", {
        ...
        function(b) {
            ...
            } else a.out("[sendGetBuddyList] error: " + b.retcode + "-" + b.errmsg),
...
Jx().$package("alloy.layout.themeManager",
        function(a) {
            var c = this,
    b = a.dom,
    d = a.event,
...
var h = {},
    ...
    D = function(a, b) {
        ...
        c = [],
        d = a.length;
        if (a.length) for (var e = function() {--d < 1 && (b(c), c = null)
        },
        f = function() {
    ...
    onInitHackLayer: function(a) { (this._zoomWallpaperContainer = b.id("zoomWallpaperGrid")) && document.body.removeChild(this._zoomWallpaperContainer);
        switch (a) {
            case "img":
            ...
            case "iframe":
                this._zoomWallpaperContainer = b.node("div", {
                    ...
                    this._zoomWallpaperContext = b.node("div"),
    ...
    onWallpaperLoaded: function(a) {
        ...
        switch (this._nMode) {
            ...
            case "fill":
                this.initHackLayer(),
                    this._mode = this._nMode,
                    this.isHackLayerNeeded() ? (b.setStyle(this._zoomWallpaperContainer, "display", "none"), this.zoomWallpaper(), b.setStyle(document.body, "background", "none")) : (b.setStyle(document.body, "backgroundImage", a), b.setStyle(document.body, "backgroundRepeat", "no-repeat"), b.addClass(document.body, "wallpaperCss3" + this._mode))
        }
    },
    ...
    skinRoot: ""
        ...
        if (a.isObject(b)) c.id = (new Date).getTime(),
           c.name = b.name || "",
               c.timeStamp = b.timeStamp || "",
                   c.window.ipadContainerBackColor = b.window.ipadContainerBackColor || "",
                   c.window.ie6WindowCenterBackground = b.window.ie6WindowCenterBackground || "",
                   c.currentWindow.ipadContainerBackColor = b.currentWindow.ipadContainerBackColor || "",
                   c.currentWindow.ie6WindowCenterBackground = b.currentWindow.ie6WindowCenterBackground || "",
                   c.skinRoot = b.skinRoot;
        else if (f[b]) {
            a.extend(c, f[b]);
            var d = h[b];
    ...
    applySkinStyle: function(a) {
        if (this._newStyleNode) this._oldStyleNode && b.getDocHead().removeChild(this._oldStyleNode),
    ...
    closeScene: function(a) {
        ...
        else if (a = b.id("sceneGrid")) b.id("iframeScene").src = "domain.html",
...
this.getAppConfig = function(b) {
    if ((b = u(b, this.appConfigList)) && (a.isUndefined(b.id) || a.isUndefined(b.appName))) b = null,
       alloy.util.report2m(151399);
    return b
};
this.getSystemConfig = function(a) {
...
var w = function(d) {
    ...
    s = function(f, h) {
        ...
        onSuccess: function(m) {
            if (m.retcode === 0) if (typeof progress == "function" && progress("get_appinfo end"), alloy.util.report2qqweb("config|appconfig|success"), g) alloy.util.report2h("get_def_appinfo", "end"),
        this.addAppConfigList(m),
        d.setItem("UPDATE_TIME_STAMP", alloy.CONST.UPDATE_TIME_STAMP),
        d.setItem("defaultAppConfig", a.json.stringify(c.getAppConfigList())),
        b.notifyObservers(c, "GetDefaultAppConfigComplete", this.getAppConfigList()),
...
Jx().$package("alloy.hotkeyManager",
        function(a) {
            var c = a.event,
    b = this,
    d = !0,
...
Jx().$package("alloy.hotkey",
    ...
    init: function() {
        ...
        } else if (a.browser.firefox) c = document.createElement("div"),
    b.addClass(c, "hidden_div"),
    c.innerHTML = '<embed id="hotkeyctrlid" type="application/tencent-WebQQ-hotkey" hidden="true"></embed>',
    document.body.appendChild(c),
    this.hotkeyctrl = document.getElementById("hotkeyctrlid");
        else if (a.browser.chrome) c = document.createElement("div"),
    b.addClass(c, "hidden_div"),
    c.innerHTML = '<embed id="hotkeyctrlid" type="application/tencent-webqq-hotkey" hidden="true"></embed>',
    document.body.appendChild(c),
    this.hotkeyctrl = document.getElementById("hotkeyctrlid")
    ...
    install: function() {
        if ((a.browser.ie || a.browser.firefox || a.browser.chrome) && this.detectPlugin()) {
            ...
            if (b) return this.regCallback(function() {
               ...
               alloy.layout.removeHotKeyAction("layout_screencaptrue"),
               !0;
...
Jx().$package(function(a) {
    var c = a.event;
    if (top.location.host != location.host) alloy.util.report2h("be_iframed", "start"),

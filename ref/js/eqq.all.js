...
(function() {
	WebqCore.register("EQQ.Extend", function() {
		...
		this.require = function(b, d) {
			for (var c = b.length, p = b.length, m = function() {
				c--;
				c == 0 && d()
			},
			h = 0; h < p; h++) b[h](m)
...
(function() {
	WebqCore.register("EQQ", function(b) {
		...
		this.init2 = function(i) {
			...
			p.addObserver(EQQ.RPCService, "NotLogin", D);
			...
			p.addObserver(EQQ.RPCService, "CheckProtectSuccess", G);
			...
			EQQ.Model.ChatMsg.init(); ! Number(b.cookie.get("hideusehttpstips")) && ! alloy.config.getHttpsSetting() && EQQ.Presenter.MainPanel.View.showUseHttpsTips();
		...
		t = function() {
			...
			try {
				b.cookie.set("uin", alloy.portal.getOriginalUin(), alloy.CONST.MAIN_DOMAIN),
				b.cookie.set("skey", alloy.portal.getSkey(), alloy.CONST.MAIN_DOMAIN),
				b.cookie.set("ptwebqq", alloy.portal.getPtwebqq(), alloy.CONST.MAIN_DOMAIN)
			} catch(e) {}
		...
		this.start = function() {
			...
			if (!h) h = ! 0,
			this.timer = window.setInterval(ha, 6E4)
		};
		...
		var i = function(i, e) {
			...
			case "single":
				...
				var B = WebqCore.api.__api.getChatBox(e),
				c = ! 1,
				k = ! 1;
				(c = !! B) && (k = B === EQQ.Presenter.ChatBox.getCurrent());
				if (j) if (B && B.isShow() && B.desktopIndex == alloy.desktopManager.getCurrentDesktopIndex() && alloy.layout.getIsFocusOnDesktop()) B.setCurrent(),
				B.shake();
				else if (!B && alloy.layout.getIsFocusOnDesktop()) {
		...
		l = function(i) {
			...
			case "SingleChat":
				...
				break;
			case "GroupChat":
				b.profile("EQQ.onNotifyHasHandled - group.code: " + e.code);
		...
		var ca = function() {
			...
			N % 2 == 0 && (p.notifyObservers(EQQ, "NotifyBeat_500"), N % 6 == 0 && p.notifyObservers(EQQ, "NotifyBeat_1000"), N % 10 == 0 && (p.notifyObservers(EQQ, "NotifyBeat_3000"), N % 20 == 0 && p.notifyObservers(EQQ, "NotifyBeat_5000")));
			N++
		};
		...
		this.videoNotify = function(i) {
			...
			case "msg":
				...
				break;
			case "setVideoId":
				b.profile("setVideoId" + i.context, "video");
			...
			case "inner":
				...
				break;
			case "close":
				i.context && EQQ.Presenter.ChatBox.appendVideoMsg(i.uin, i.context),
				EQQ.Presenter.ChatBox.closeVideo(i.uin)
			}
		};
	...
	WebqCore.register("EQQ.util", function(b) {
		...
		h = function(d, h) {
			...
			if (h) for (var u = 0; u < d.content.length; u++) {
				...
				else if (j[0] === "cface_idx") q += d.type == "group" || d.type == "discu" ? w(j[2]) : w(j[1]);
				...
				} else j[0] === "rffile" ? q += '<div class="msgFileBox">\u60a8\u62d2\u7edd\u63a5\u6536"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "agfile" ? q += '<div class="msgFileBox">\u60a8\u540c\u610f\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '".</div>': j[0] === "sendfile" ? q += '<div class="msgFileBox">\u60a8\u53d1\u9001\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u7ed9\u5bf9\u65b9.</div>': j[0] === "sendofffile" || j[0] === "sendofffileerror" || j[0] === "refuseofffile" || j[0] === "nextofffile" || j[0] === "canceloffupload" || j[0] === "notifyagreeofffile" || j[0] === "notifyrefuseofffile" ? q += '<div class="msgFileBox">' + c.encodeHtmlSimple(j[1]) + "</div>": j[0] === "uploadingofffile" ? (q += '<div class="msgFileBox">' + c.encodeHtmlSimple(j[1]), q += '<span class="fileAct">', q += '<a href="#" id="cancal_uploadOffFile_' + d.attach.ts + '">[\u53d6\u6d88]</a>', q += "</span></div>") : j[0] === "transtimeout" ? q += '<div class="msgFileBox">\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u8d85\u65f6,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "refusedbyclient" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "transok" ? q += '<div class="msgFileBox">\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u4f20\u8f93\u6210\u529f.</div>': j[0] === "transerror" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u6216\u4f20\u8f93\u9519\u8bef,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': b.isArray(j) || (q += f(c.encodeHtmlSimple(f(j, 1)), 2))
			} else {
				...
				j = "",
				b.platform.iPad && (j = "\u4f46\u60a8\u4f7f\u7528\u7684\u8bbe\u5907\u4e0d\u652f\u6301\u89c6\u9891\u901a\u8bdd\u529f\u80fd\u3002"),
				q += '<div class="msgFileBox">\u5bf9\u65b9\u5411\u60a8\u53d1\u8d77\u89c6\u9891\u9080\u8bf7\u3002' + j + "</div>";
					...
					j = '<img src="' + EQQ.CONST.CHAT_PIC_SERVER + "cgi-bin/get_group_pic?type=" + E + "&gid=" + v + "&uin=" + C + "&rip=" + F[0] + "&rport=" + F[1] + "&fid=" + j.file_id + "&pic=" + encodeURIComponent(j.name) + "&vfwebqq=" + alloy.portal.getVfWebQQ() + "&t=" + r + '" id="_cface_' + m++ + '" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5" />';
					q += j
				} else q += g(d.msg_id, j[1], u),
				alloy.util.report2m(133157),
				alloy.util.report2m(133158);
				else j[0] === "cface_idx" ? d.type == "group" || d.type == "discu" ? (v = d.group_code || EQQ.Model.BuddyList.decodeDid(d.did), j = I[j[1]][1], C = Math.round((new Date).getTime() / 1E3), j = '<img src="' + EQQ.CONST.AVATAR_SERVER_DOMAIN + "cgi/svr/chatimg/get?pic=" + encodeURIComponent(j.name) + "&gid=" + v + "&time=" + C + '" id="_cface_' + m++ + '" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5" />', q += j) : q += g(d.msg_id, I[j[1]][1], u) : j[0] === "pic_id" ? (v = EQQ.Model.BuddyList.getUserByUin(u), ! v.type || v.type == "groupBuddy" ? A = ! 0: G = j[1]) : j[0] === "image" ? A ? q += "\u3010\u56fe\u7247\u3011\uff08\u5bf9\u65b9\u53d1\u9001\u4e86\u4e00\u5f20\u56fe\u7247\uff0cQ+ Web\u4e34\u65f6\u4f1a\u8bdd\u6682\u4e0d\u652f\u6301\u63a5\u6536\uff09": (q += '<img rdata="image" src="' + EQQ.CONST.CONN_SERVER_DOMAIN + "channel/get_image2?lcid=" + d.msg_id + "&guid={" + G + "}" + j[2] + "." + j[1] + "&to=" + u + "&count=1&time=1&psessionid=" + EQQ.getPsessionid() + "&clientid=" + EQQ.Model.ChatMsg.getClientidFromRpc() + '" id="_cface_' + m++ + '" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5" />', alloy.util.report2m(133153), alloy.util.report2m(133154)) : j[0] === "offpic" ? (q += j[1].success == 1 ? '<img rdata="offpic" src="' + EQQ.CONST.CONN_SERVER_DOMAIN + "channel/get_offpic2?file_path=" + encodeURIComponent(j[1].file_path) + "&f_uin=" + z + "&clientid=" + EQQ.Model.ChatMsg.getClientidFromRpc() + "&psessionid=" + EQQ.getPsessionid() + '" id="_cface_' + m++ + '" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5" />': '<img src="' + alloy.CONST.CDN_URL + 'style/images/img_error.gif" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5\u63a5\u6536\u9519\u8bef\u6216\u4e0d\u5b58\u5728" />', alloy.util.report2m(133167)) : j[0] === "rfile" ? (v = d.from_uin + "_" + j[2], C = EQQ.Model.ChatMsg.getFilesList(), q += '<div class="msgFileBox">\u5bf9\u65b9\u7ed9\u60a8\u53d1\u9001\u6587\u4ef6:<br />', q += '<span class="icon_' + n(j[1]) + '">&nbsp;</span>' + c.encodeHtmlSimple(j[1]), q += '<span class="fileAct">', C[v].isread ? q += "&nbsp;[\u540c\u610f][\u62d2\u7edd]": (q += '&nbsp;<a id="agree_' + v + '" href="#">[\u540c\u610f]</a>', q += '&nbsp;<a id="refuse_' + v + '" href="#">[\u62d2\u7edd]</a>'), q += "</span>", q += "</div>") : j[0] === "rffile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u53d6\u6d88\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "rtfile" ? q += '<div class="msgFileBox">\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '"\u8d85\u65f6,\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "wrfile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u5df2\u540c\u610f\u63a5\u6536"' + c.encodeHtmlSimple(j[1]) + '",\u5f00\u59cb\u4f20\u8f93\u6587\u4ef6.</div>': j[0] === "wrffile" ? q += '<div class="msgFileBox">\u5bf9\u65b9\u62d2\u7edd\u4e86\u63a5\u6536\u6587\u4ef6"' + c.encodeHtmlSimple(j[1]) + '",\u6587\u4ef6\u4f20\u8f93\u5931\u8d25.</div>': j[0] === "cvideo" ? (q += c.encodeHtmlSimple(j[1]), q += '&nbsp;<a id="video_' + d.attach.from_uin + "_" + d.attach.msg_id + '" fromuin="' + d.attach.from_uin + '" href="###">\u53d1\u8d77\u89c6\u9891</a>') : (j[0] === "video" ? j = c.encodeHtmlSimple(j[1]) : j[0] === "offfile" ? (j = d, v = j.attach.from_uin + "_" + j.attach.msg_id, C = b.date.format(new Date(j.attach.expire_time * 1E3), "YYYY-MM-DD"), r = '<div class="msgFileBox">\u5bf9\u65b9\u7ed9\u60a8\u53d1\u9001\u79bb\u7ebf\u6587\u4ef6:<br />', r += '<span class="icon_' + n(j.attach.name) + '">&nbsp;</span>' + c.encodeHtmlSimple(j.attach.name) + "(" + C + "\u5230\u671f)", r += '<span class="fileAct">', r += '&nbsp;<a id="agree_' + v + '" href="#" fuin="' + j.from_uin + '" rkey="' + j.attach.rkey + '">[\u63a5\u6536]</a>', r += '&nbsp;<a id="next_' + v + '" href="#" fuin="' + j.from_uin + '" rkey="' + j.attach.rkey + '">[\u4e0b\u6b21\u63a5\u6536]</a>', r += '&nbsp;<a id="refuse_' + v + '" href="#">[\u62d2\u7edd]</a>', r += "</span>", r += "</div>", j = r) : j = j[0] === "shake" ? '<div class="msgFileBox">' + c.encodeHtmlSimple(j[1]) + "</div>": f(c.encodeHtmlSimple(f(j, 1)), 2), q += j)
			}
			q = q.replace(/\r\n|\r|\n/ig, "<br />");
			x && (p[x] = q);
			return q
		...
		w = function(a) {
			return '<img src="' + EQQ.CONST.CONN_SERVER_DOMAIN2 + "cgi-bin/webqq_app/?cmd=2&bd=" + a + '" id="_cface_' + m++ + '" title="\u56fe\u7247\u6216\u81ea\u5b9a\u4e49\u8868\u60c5" />'
		},
		f = function(a, b) {
			if (b === 2) var c = /\[url\][\s\S]+?\[(\/|&#47;)url\]/g,
			...
			else c = /(http[s]?|ftp|(www\.)){1}[\w\.\/\?=%&@:#;\*\$\[\]\(\){}'"\-]+([0-9a-zA-Z\/#])+?/g,
			a = a.replace(c, function(a) {
				return "[url]" + a + "[/url]"
			});
			return a
		...
		this.translateFontStyle = function(a) {
			if (a[0] === "font") {
				var c = a[1].style,
				d = b.string.encodeHtmlAttributeSimple(a[1].name + ""),
...
(function() {
	WebqCore.register("EQQ.RPCService", function(b) {
		...
		(new Date).getTime();
		var h = 0,
		a = String(b.random(0, 99)) + String((new Date).getTime() % 1E6),
		g = 0,
		w = ! 1,
		f = 0,
		n = EQQ.CONST.CONN_SERVER_DOMAINS[0],
		s,
		o = function() {
			return function(a, b) {
				try {
					if (arguments.length == 2) return ! b || arguments.callee(a);
						...
						d = [c, a.status, a.responseText.replace(/[\r\t\n\s]/g, "") + ":", decodeURIComponent(a.data), a.uri].join("$");
		...
		this.onAjaxFrameLoad = function() {
			...
			if (s = window.frames.EQQ_ProxySendIframe.ajax) {
				...
				for (var a = 0; a < q.length; ++a) {
					...
					d = q[a].url;
					if (d.indexOf(EQQ.CONST.CONN_SERVER_DOMAINS[c]) == - 1) d = d.replace(/http:\/\/.*.com\//, ""),
					q[a].url = EQQ.CONST.CONN_SERVER_DOMAINS[c] + d;
					d = q[a].url;
					c = q[a].option;
					try {
						return u(d, c)
			...
			var d = {
				...
				onSuccess: function(a) {
					...
					try {
						...
						j.o = a,
						c.onSuccess.call(c.context, j, d)
					}
				},
				onError: function(a) {
		...
		this._proxy = function(c, b, d) {
			...
			alloy.rpcService.eqqSend(c, b, f, d)
		};
		d.prototype = {
			pollStop: function() {
			...
			check: function() {
				...
				if (this.POLLTICK == 2) b.out("Oooops, send..."),
				alloy.rpcService.formSend("http://tj.qstatic.com/log", {
					method: "POST",
					data: {
		...
		this.sendLoginSuccess = function(a, c) {
			...
			case 103:
				...
				break;
			case 106:
				m.notifyObservers(EQQ, "UinNotInWhitelist", a.result);
				break;
			case 111:
			...
			default:
				...
				b.out("[sendLogin] error: " + a.retcode),
				o(a, ! c)
			}
		...
		this.sendReLinkSuccess = function(a, c) {
			...
			case 112:
				...
				break;
			default:
				m.notifyObservers(EQQ, "ReLinkStop"),
				o(a, ! c)
			}
			o(a, c)
		};
		...
		this.sendMsg = function(c) {
			...
			this.send(n + "channel/send_buddy_msg2", {
				...
				onSuccess: function(a, d) {
					a.retcode === 0 ? m.notifyObservers(this, "SendMsgSuccess", a.result) : (b.out("[sendMsg] error: " + a.retcode + "-" + a.errmsg), m.notifyObservers(this, "SendMsgError", {
						uin: c.to,
						retcode: a.retcode,
						errmsg: a.errmsg,
		...
		this.sendGroupMsg = function(c) {
			...
			this.send(n + "channel/send_qun_msg2", {
				...
				onSuccess: function(a, d) {
					a.retcode === 0 ? m.notifyObservers(this, "SendGroupMsgSuccess", a.result) : (b.out("[sendGroupMsg] error: " + a.retcode + "-" + a.errmsg), m.notifyObservers(this, "SendMsgError", {
						uin: c.group_uin,
						retcode: a.retcode,
						errmsg: a.errmsg,
		...
		this.sendPoll = function(d) {
			...
			if (g < f) g++,
			d.ids = EQQ.Model.ChatMsg.getMessageRead(),
			c.pollWatcher.pollRequst = this.send(n + "channel/poll2", {
				context: this,
				cacheTime: 0,
				method: "POST",
				data: {
		...
		this.sendPollSuccess = function(a, d) {
			...
			else if (a.retcode === 116) alloy.portal.setPtwebqq(a.p),
			m.notifyObservers(this, "PollComplete");
			else {
				try {
		...
		this.sendChangeStatus = function(a) {
			...
			this.send(n + "channel/change_status2", {
				...
				onSuccess: function(a, b) {
					if (a.retcode === 0) m.notifyObservers(this, "ChangeStatusSuccess", a.arguments.newstatus),
					c._state = a.arguments.newstatus;
					a.retcode === 108 ? m.notifyObservers(this, "NotReLogin", a.result) : o(a, ! b);
					o(a, b)
				},
				onError: function(a) {
					o(a)
		...
		this.sendGetCustomFaceList = function() {
			...
			b.http.loadScript(EQQ.CONST.CONN_SERVER_DOMAIN2 + "cgi-bin/webqq_app/", {
				...
				onSuccess: function() {
					typeof custom_face !== "undefined" ? m.notifyObservers(c, "SendGetCustomFaceListSuccess", custom_face) : c.sendGetCustomFaceList()
				}
			})
		};
		...
		this.sendGetGroupCustomFaceKey = function(a) {
			this.send(n + "channel/get_gface_sig2", {
				context: this,
		...
		this.sendGetOfflinePicUrl = function(a) {
			this.send(n + "channel/apply_offline_pic_dl2", {
				...
				data: a,
				onSuccess: function(a, c) {
					a.retcode === 0 ? (m.notifyObservers(this, "sendGetOfflinePicUrlSuccess", a), alloy.util.report2m(133173)) : (m.notifyObservers(this, "getSendPicUrlError", a), b.out("[sendGetOfflinePicUrlError] error: "), o(a, ! c), alloy.util.report2m(133174));
					o(a, c)
				},
				onError: function(a) {
					o(a);
		...
		this.sendRefuseOffFile = function(a) {
			...
			this.send(n + "channel/notify_offfile2", {
				...
				arguments: a,
				onSuccess: function(a) {
					a.retcode === 0 ? (m.notifyObservers(this, "RefuseOffFileSuccess", a), b.out("RefuseOffFileSuccess.")) : b.out("RefuseOffFileFail.")
				},
				onError: function() {
...
(function() {
	WebqCore.register("EQQ.Model.BuddyList", function(b) {
		...
		p = b.dom,
		m = b.string,
		h, a, g, w, f, n, s, o, x, q, u, j, z, I, G, A, y, v = [],
		C = [],
		r = 0,
		E = new b.Class({
			init: function(i) {
			...
			setMarkName: function(i) {
				this.markName = b.string.toSingleLine(i.toString());
			...
			setSignature: function(i) {
				if (i != void 0) this.signature = i,
				this.htmlSignature = b.string.encodeHtmlSimple(i),
				this.titleSignature = b.string.encodeHtmlAttributeSimple(i);
		...
		F = new b.Class({
			...
			setType: function(i) {
				...
				this.titleTypeText = b.string.encodeHtmlAttributeSimple(this.typeText)
			},
			setLevel: function(i) {
				this.level = i || 0
			},
			setAnnouncement: function(i) {
				if (typeof i != "undefined") this.announcement = i,
				this.htmlAnnouncement = b.string.encodeHtmlSimple(i),
				this.titleAnnouncement = b.string.encodeHtmlAttributeSimple(i),
			...
			updateMembers: function(i, a) {
				if (i) this.members = i,
				this.onlineMemberCount = a,
				this.uin2members[i.uin] = i;
		...
		t = {
			...
			onGetUserInfoSuccess: function(a) {
				...
				if (e) {
					...
					if (l) l.setNick(e.nick),
					l.setFace(e.face),
					l.setGender(e.gender),
					l.setAllow(e.allow);
					else {
						a = {
							uin: a.arguments.uin,
			...
			onGetBuddySignatureSuccess: function(a) {
				...
				c.notifyObservers(d, "GetBuddySignatureSuccess", a)
			},
			...
			onGetGroupMaskConfigSuccess: function(a) {
				for (var e in a) {
					var l = parseInt(a[e]);
					e === "global" && (y = l, c.notifyObservers(d, "GroupMaskChange", y))
				}
			},
			...
			onGetBuddyListSuccess: function(a) {
				for (var e = a.categories || [], l = ! 1, c = 0; c < e.length; c++) e[c].index == 0 && (l = ! 0);
				l || e.unshift({
					index: 0,
					name: "\u6211\u7684\u597d\u53cb"
				});
				...
				alloy.rpcService.sendGetUserInfo(a.tuin, null, null, function(a) {
					if (a.retcode === 0) {
						...
						f ? (f.classId == EQQ.hash.userClassType.stranger && (b.array.remove(o, f), c.notifyObservers(d, "RemoveBuddy", {
							...
							user: f
						})), f.setNick(i.nick), f.setFace(i.face), f.setGender(i.gender), f.setClassId(e)) : f = d.createUser({
							uin: a,
							allow: i.allow,
							nick: i.nick,
							face: i.face,
		...
		this.getUserSignature = function(a) { (a = this.getUserByUin(a)) && a.getSignature()
		};
		...
		this.sendGetQQLevel = function(a) { (a = this.getUserByUin(a)) && a.getQQLevel()
		};
		...
		this.moveBuddyClass = function(a, e) {
			...
			if (l) {
				var k = function() {
					var b = this.getClassByUin(a),
					k = this.getClassById(e);
		...
		this.setUserMarkName = function(a, e) {
			...
			l && alloy.rpcService.send(alloy.CONST.API_SERVER_URL + "change_mark_name2", {
				...
				context: d,
				onSuccess: function(a) {
					a.retcode === 0 ? l.setMarkName(e) : (c.notifyObservers(d, "ManageError", "mark"), b.out("\u4fee\u6539\u5907\u6ce8\u5931\u8d25"))
				},
				onError: function() {
		...
		this.setState = function(a, e, l) {
			...
			if (b) {
				...
				b.setState(e);
				b.clientType = l;
				if (a == this.getSelfUin()) c.notifyObservers(this, "SelfStateChange", this.getSelfState()),
				c.notifyObservers(alloy.taskBar, "EQQSelfStateChange", {
					...
					if (d == b || e == b) {
						...
						if (e == b) for (e = 0; e < j.length; e++) j[e].uin == a && j.splice(e, 1);
						else j.push({
							uin: a,
							state: e,
							clientType: l
		...
		this.setBuddyList = function(a) {
			...
			d = {},
			k;
			for (k in b) d[b[k].u] = b[k].vip_level;
			for (b = 0; b < e.length; b++) e[b].uin != l && (k = a.info[b], k = this.createUser({
				uin: k.uin,
				allow: k.allow,
				nick: k.nick,
				face: k.face,
		...
		this.setGroupInfo = function(a) {
			...
			a = {},
			m;
			for (m in g) a[g[m].u] = g[m].vip_level;
			m = e.members;
			for (var g = [], H = ! 1, j = 0, n = 0; n < m.length; n++) {
				...
				p = l[n].nick;
				p == "" && (p = (l[n].ruin || s) + "");
				var q = k[s] && k[s].stat || 20,
				J = k[s] && k[s].client_type || 1E4;
				(q != 20 || s === h) && j++;
				for (var K = D, w = D, r = 0; r < d.length; r++) if (d[r].muin == s) {
					p = d[r].card;
					break
				}
				...
				r.type = "groupBuddy",
				r.setClassId(EQQ.hash.userClassType.stranger),
				r.group = f,
				r.gstate = q;
				q = p ? p: r.showName;
		...
		this.sendGetMultiGroupInfo = function(a, e) {
			...
			alloy.rpcService.send(alloy.CONST.API_SERVER_URL + "get_group_info", {
				...
				arguments: a,
				onSuccess: function(a) {
					a.retcode === 0 ? e ? e(a) : c.notifyObservers(d, "GetMultiGroupInfoSuccess", a) : b.out("\u83b7\u53d6\u7fa4\u4fe1\u606f\u5931\u8d25")
				},
				onError: function() {
					b.out("\u83b7\u53d6\u7fa4\u4fe1\u606f\u5931\u8d25")
				}
		...
		this.sendGetGroupNewestState = function(a) {
			...
			alloy.rpcService.send(alloy.CONST.API_SERVER_URL + "get_group_member_stat2", {
				...
				arguments: a,
				onSuccess: function(a) {
					if (a.retcode === 0) d.onGetGroupNewestStateSuc(a.result);
					else b.out("\u83b7\u53d6\u7fa4\u6700\u65b0\u4fe1\u606f\u5931\u8d25")
				},
				onError: function() {
					b.out("\u83b7\u53d6\u7fa4\u6700\u65b0\u4fe1\u606f\u5931\u8d25")
				}
		...
		this.getGroupInfo = function(a) {
			...
			c.notifyObservers(this, "GroupInfoChange", e),
			e;
		...
		var M = function(a) {
			...
			if (b.isArray(e)) k = d.getGroupByCode(e),
			f = a.result ? a.result.memo || " ": " ",
			k.setAnnouncement(f);
			else for (var c in e) {
				var k = e[c],
				k = d.getGroupByCode(k),
				f = a.result ? a.result.memo || " ": " ";
				k.setAnnouncement(f)
			}
		};
		...
		this.getMultiGroupAnnounce = function(a) {
			var c = [],
			b;
			for (b in a) typeof d.getGroupByCode(a[b]).announcement == "undefined" && c.push(a[b]);
			c.length && this.sendGetMultiGroupInfo({
				gcode: "[" + c.toString() + "]",
		...
		this.setGroupBuddySessionSignature = function(a) {
			...
			c.notifyObservers(this, "GroupBuddySessionSignatureChange", e.uin)
		};
		...
		var k = new b.Class({
			...
			setMembers: function(a) {
				...
				for (var e in a) {
					var c = a[e],
					b = d.getUserByUin(c.uin);
					if (b) {
						if (b.type == "stranger") b.setNick(c.nick || c.uin.toString()),
						b.did = this.did
					} else b = d.createUser({
						uin: c.uin,
						allow: ! 0,
			...
			modifyMemberStatus: function(a) {
				...
				for (d in this.members) {
					var k = this.members[d],
					f = c[k.uin];
					if (!b.isUndefined(f) && f.status != k.status) f.old_status = k.status,
					k.status = a == k.uin && f.status == "offline" ? "hidden": f.status,
					e.push(f);
		...
		this.getDiscuInfo = function(a) {
			var e = this.getDiscuById(a); ! b.isUndefined(e) && e.isLoadInfo ? c.notifyObservers(this, "DiscuInfoChange", e) : J(a)
		};
		...
		this.sendGetDiscuInfoSuccess = function(a) {
			var e = d.encodeDid(a.arguments.did),
			l = this.getDiscuById(e),
			k = a.result.mem_info,
			f = a.result.mem_status,
			h = [],
			g;
			for (g in f) {
				var H = f[g];
			...
			for (g in k) {
				var n = k[g],
				o = this.getUserByUin(n.uin);
				if (o) n.markName = o.markName,
				n.htmlMarkName = o.htmlMarkName,
				n.vip = o.vip;
		...
		var D, K = function(a, e) {
			...
			var d = p.id("eqq_verify_img_code"),
			k = p.id("eqq_verify_a_code"),
			f = p.id("eqq_verify_input_code"),
			h = null;
		...
		var S = d.sendCreateDiscu = function(a, e, c) {
			...
			EQQ.RPCService.send(EQQ.CONST.CONN_SERVER_DOMAIN + "channel/create_discu", {
				...
				onSuccess: function(e) {
					if (e.retcode === 0) {
						var c = ! 1; ! b.isUndefined(e.result.result) && e.result.result > 0 && (c = ! 0);
						setTimeout(function() {
							try {
								D && D.close()
							} catch(a) {}
		...
		this.sendCreateDiscuSuccess = function(a) {
			...
			c.notifyObservers(d, "ToStartDiscuChat", a)
		};
		this.sendModifyDiscuTopic = function(a) {
			...
			EQQ.RPCService.send(EQQ.CONST.CONN_SERVER_DOMAIN + "channel/modify_discu_info", {
				...
				arguments: a,
				onSuccess: function(e) {
					if (e.retcode === 0) if (!b.isUndefined(e.result.error) && e.result.error == 2) alloy.layout.alert("\u4fee\u6539\u8ba8\u8bba\u7ec4\u4e3b\u9898\u5931\u8d25.", null, {
						windowType: "EqqWindow"
					}),
					b.error("\u4fee\u6539\u8ba8\u8bba\u7ec4\u4e3b\u9898\u5931\u8d25,\u6709\u810f\u8bcd"),
					e = d.encodeDid(a.did),
					e = d.getDiscuById(e),
					c.notifyObservers(d, "ModifyDiscuTopicSuccess", e),
					alloy.util.report2qqweb("dicussionsmask|titlebar|theme|false");
						...
						k.setHadModified(!0);
						c.notifyObservers(d, "ModifyDiscuTopicSuccess", k);
		...
		this.getDiscuMemberStatusSuccess = function(a) {
			var e = d.encodeDid(a.arguments.did),
			a = d.getDiscuById(e).modifyMemberStatus(a.result.mem_status);
		...
		this.getAndAddDiscu = function(a) {
			...
			c.notifyObservers(d, "AddDiscuByMsgSuccess", a)
		};
		this.sendGetDiscuSessionSignature = function(a) {
		...
		var R = function(a) {
			...
			c.notifyObservers(d, "GroupBuddySessionSignatureChange", e.uin)
		},
		P = function(a) {
			alloy.layout.alert("\u8ba8\u8bba\u7ec4\u88ab\u5220\u9664!", null, {
				windowType: "EqqWindow"
			});
			a.did = d.encodeDid(a.did);
			d.removeDiscu(a);
...
(function() {
	WebqCore.register("EQQ.Model.ChatMsg", function(b) {
		...
		this.init = function() {
			...
			c.addObserver(EQQ.RPCService, "SendGetGroupCustomFaceKeySuccess", b.bind(this.onSendGetGroupCustomFaceKeySuccess, this));
		...
		this.callbackSendPic = function(a) {
			...
			a.maxFileSize = "1MB",
			c.notifyObservers(this, "uploadSendPicError", a);
		...
		this.callbackSendPicGroup = function(a) {
			...
			} else a.ret === 4 ? (b = /[A-Fa-f0-9]{32}\.[A-Za-z]{3}/, d = a.msg, d.length > 36 ? (d = d.substring(0, 36), b.test(d) ? c.notifyObservers(this, "getSendPicGroupSuccess", d) : c.notifyObservers(this, "sendPicGroupError", a)) : c.notifyObservers(this, "sendPicGroupError", a)) : c.notifyObservers(this, "sendPicGroupError", a)
		};
		this.sendMsg = function(a) {
			...
			f = b.json.stringify(a.content);
			if (a.type === "group") f = {
				group_uin: a.to,
				content: f,
				msg_id: d
			},
			EQQ.RPCService.sendGroupMsg(f),
			d = {
				type: a.type,
				from_uin: 0,
				sender_uin: g.uin,
			...
			else if (a.type === "discu")(h = EQQ.Model.BuddyList.getDiscuById(a.to)) && M(h, a.content),
			f = {
				did: EQQ.Model.BuddyList.decodeDid(a.to),
				content: f,
				msg_id: d
		...
		this.receiveMsg = function(a) {
			...
			f = ! 1,
			h = 0,
			g = typeof a.attach != "undefined" && a.attach ? a.attach: "",
			g = {
				type: "single",
				from_uin: d,
				sender_uin: d,
		...
		this.preloadGroupMessageImages = function(a, c) {
			...
			h = "",
			g = null,
			m = a.group_code || EQQ.Model.BuddyList.decodeDid(a.did),
			j = a.time,
			n = "",
			o = ! 0;
			a.did && (o = ! 1);
			...
			l = 0, p = d.length; l < p; l++) if (d[l][0] === "cface") n = d[l][1],
			h = n.server.toString().split(":"),
			h = EQQ.CONST.CHAT_PIC_SERVER + "cgi-bin/get_group_pic?type=" + c + "&gid=" + m + "&uin=" + f + "&rip=" + h[0] + "&rport=" + h[1] + "&fid=" + n.file_id + "&pic=" + n.name + "&vfwebqq=" + alloy.portal.getVfWebQQ() + "&t=" + j,
			g = new Image,
			g.src = h,
			g.onload = i,
			g.onerror = s
		...
		this.receiveShakeMsg = function(a) {
			if (EQQ.Model.BuddyList.getSelf().state != "silent" && EQQ.Model.BuddyList.getUserByUin(a.from_uin)) a.content = [["shake", "\u5bf9\u65b9\u7ed9\u60a8\u53d1\u9001\u4e86\u4e00\u4e2a\u7a97\u53e3\u6296\u52a8\u3002"]],
			a.attach = {
				type: "shake"
			},
			a.time = + new Date / 1E3,
		...
		this.receiveStrangerMsg = function(a) {
			...
			g = EQQ.Model.BuddyList.isStranger(f),
			m = function() {
				if (!g) {
		...
		this.receiveGroupBuddyMsg = function(a) {
			...
			m = EQQ.Model.BuddyList.isUser(f),
			j = function() {
				m ? h = EQQ.Model.BuddyList.getUserByUin(f) : (h = EQQ.Model.BuddyList.createUser(g), h.type = "groupBuddy", EQQ.Model.BuddyList.addStranger(h), h.setClassId(EQQ.hash.userClassType.stranger), EQQ.Model.BuddyList.setState(h.uin, "online", "10000"), c.notifyObservers(d, "NewStranger", h), EQQ.Model.BuddyList.sendGetUserInfo(f));
		...
		this.receiveFile = function(a) {
			if (a.mode === "recv") {
				...
				if (a.type !== 161) {
					if (a.cancel_type == 2 && (z[a.session_id] = ! 0, b = parseInt(a.session_id, 10).toString(2), b.length >= 12)) b = b.substr(b.length - 12, 12),
					...
					b = [["rffile", f.name]];
					f.type = "rffile";
					if (a.cancel_type == 2) b = [["wrffile", f.name]],
					f.type = "wrffile";
					else if (a.cancel_type == 3) b = [["rtfile", f.name]],
					f.type = "rtfile";
					a.content = b;
					a.attach = f;
		...
		this.receiveTransferMsg = function(a) {
			...
			if (b.file_name != "") {
				...
				! 1;
				b = j[a.from_uin + "_" + a.lc_id] || {};
				if (b.isFinished || typeof z[a.session_id] != "undefined" && z[a.session_id] === ! 0) return ! 1;
				else b.isFinished = ! 0;
				d.addMsgToList({
					type: "single",
					from_uin: 0,
		...
		this.callbackSendOffFile = function(a) {
			...
			m = f[f.length - 1],
			m = b.string.encodeHtmlSimple(m);
			a.retcode === 0 ? (f = "\u6587\u4ef6\u201c" + m + "\u201d(" + (a.filesize < 1024 ? a.filesize + "\u5b57\u8282": a.filesize / 1024 < 1024 ? Math.round(a.filesize / 1024 * 100) / 100 + "KB": a.filesize / 1048576 < 1024 ? Math.round(a.filesize / 1048576 * 100) / 100 + "MB": Math.round(a.filesize / 1073741824 * 100) / 100 + "MB") + ")\u5df2\u6210\u529f\u4e0a\u4f20\u81f3\u670d\u52a1\u5668\uff0c\u6211\u4eec\u5c06\u4e3a\u60a8\u7684\u597d\u53cb\u4fdd\u5b587\u5929\u3002", h = "sendofffile", EQQ.RPCService.sendOffFileMsg({
				to: a.to_uin,
				file_path: a.filepath,
				filename: m,
				to_uin: a.to_uin
			},
			this.sendOffFileMsgRes), alloy.util.report2m(153300)) : a.retcode === - 30008 ? (f = "\u4eca\u65e5\u79bb\u7ebf\u6587\u4ef6\u5bb9\u91cf\u4e0d\u8db3\uff0c\u670d\u52a1\u5668\u62d2\u7edd\u4e86\u60a8\u53d1\u9001\u79bb\u7ebf\u201c" + m + "\u201d\u7684\u8bf7\u6c42\u3002", alloy.util.report2m(153301), alloy.util.report2m(153302)) : a.retcode === - 30012 || a.retcode === - 30013 || a.retcode === - 30002 ? (f = "\u4eca\u65e5\u79bb\u7ebf\u6587\u4ef6\u5bb9\u91cf\u4e0d\u8db3\uff0c\u670d\u52a1\u5668\u62d2\u7edd\u4e86\u60a8\u53d1\u9001\u79bb\u7ebf\u201c" + m + "\u201d\u7684\u8bf7\u6c42\u3002", alloy.util.report2m(153301), alloy.util.report2m(153302)) : a.retcode === - 30001 ? (f = "\u79bb\u7ebf\u6587\u4ef6\u53d1\u9001\u6b21\u6570\u8d85\u51fa\u6bcf\u65e5\u9650\u5236\uff0c\u670d\u52a1\u5668\u62d2\u7edd\u4e86\u60a8\u53d1\u9001\u79bb\u7ebf\u201c" + m + "\u201d\u7684\u8bf7\u6c42\u3002", alloy.util.report2m(153301), alloy.util.report2m(153303)) : (f = a.retcode === - 30003 ? "\u79bb\u7ebf\u6587\u4ef6\u201c" + m + "\u201d\u8d85\u51fa\u6700\u5927\u4e0a\u4f20\u9650\u5236\u3002": "\u6587\u4ef6\u201c" + m + "\u201d\u4f20\u8f93\u5931\u8d25\u3002", alloy.util.report2m(153301));
			f = [[h, f]];
			h = {
				type: h,
				name: a.filename,
		...
		this.receiveNotifyOffFile = function(a) {
			var b = "",
			c = "";
			a.action == 1 ? (b = '\u5bf9\u65b9\u5df2\u6210\u529f\u63a5\u6536\u4e86\u60a8\u53d1\u9001\u7684\u79bb\u7ebf\u6587\u4ef6"' + a.filename + '"\u3002', c = "notifyagreeofffile") : (b = '\u5bf9\u65b9\u62d2\u7edd\u63a5\u6536\u60a8\u53d1\u9001\u7684\u79bb\u7ebf\u6587\u4ef6"' + a.filename + '"\u3002', c = "notifyrefuseofffile");
			b = [[c, b]];
			c = {
				type: c,
				name: a.filename,
		...
		this.receiveDiscuMsg = function(a) {
			...
			if (c) this.addMessageBoxDiscuList(a),
		...
		this.parseDiscuMsg = function(a) {
			...
			if (m[d]) {
				for (var j = m[d].msgList.length, n = 0; n < j; n++) {
					var s = m[d].msgList[n];
			...
			o != null && o != a.info_seq && c.notifyObservers(this, "ServerDiscuInfochange", {
				did: d
			});
			o = a.info_seq
		};
		...
		this.getDiscuMsgHistory = function(a) {
			m[a] && c.notifyObservers(this, "DiscuMessageListChange", {
				did: a,
				msgList: m[a].msgList
			})
		};
...
(function() {
	...
	d = function(b) {
		...
		this.getNewNode = function(a, b) {
			var b = b || ! 1,
			m = "",
			o = b ? "EQQ_RecentList_State_" + a.did: "EQQ_discuList_State_" + a.did,
			p = b ? "EQQ_RecentDiscuList_State_" + a.did: "EQQ_discuList_Name_" + a.did;
			parseInt(a.mask) > 0 && (m = " EQQ_GroupMask_State");
			m = d.template('\t\t\t\t<div class="EQQ_GroupList_AvatarContainer">\t\t\t\t\t<div class="EQQ_discuList_Avatar"></div>\t\t\t\t\t<div class="EQQ_GroupList_State ' + m + '" id="' + o + '" title="\u8ba8\u8bba\u7ec4\u5c4f\u853d"></div>\t\t\t\t</div>\t\t\t\t<div class="EQQ_GroupList_RightContainer" title="<%=titleName%>">\t\t\t\t\t<div id="' + p + '" class="EQQ_GroupList_Name"><%=htmlName%></div>\t\t\t\t</div>\t\t\t', a);
			o = c.node("div", {
		...
		this.removeDiscu = function(b) {
			...
			if (b = c.id("EQQ_Recent_" + b)) if (a.off(b), b.parentNode) g = b.parentNode,
			g.removeChild(b);
		...
		this.updateDiscuName = function(a) {
			...
			if (b = c.id("EQQ_RecentDiscuList_State_" + a.did)) b.parentNode.title = a.titleName,
			b.innerHTML = a.htmlName
		};
		this.setDiscuListMaskState = function(a, b) {
			var d = c.id("EQQ_discuList_State_" + a),
			g = c.id("EQQ_RecentList_State_" + a);
			parseInt(b) > 0 ? (d && c.addClass(d, "EQQ_GroupMask_State"), g && c.addClass(g, "EQQ_GroupMask_State")) : (d && c.removeClass(d, "EQQ_GroupMask_State"), g && c.removeClass(g, "EQQ_GroupMask_State"))
		};
		...
		this.showReloadDiscuList = function() {
			...
			g = c.id("EQQ_discuReLogining_text");
			c.show(b);
			c.show(d);
			c.hide(g);
			a.off(b, "click");
	...
	c = function(c) {
		...
		this.setUserMarkName = function(a) {
			...
			d = function(a, b) {
				...
				if (c.string.byteLength(ea, 3) > b) a.value = c.string.cutRight(ea, 1),
				d(a, b)
			},
		...
		oa = function(a) {
			var c = a.getArgument(),
			c = EQQ.Model.BuddyList.getGroupByCode(c),
			b = 6,
			a = [a.getItemAt(b++), a.getItemAt(b++), a.getItemAt(b++)],
			c = c.mask,
			d;
		...
		pa = function(a) {
			var c = 3,
			a = [a.getItemAt(c++), a.getItemAt(c++), a.getItemAt(c++), a.getItemAt(c++)],
			c = EQQ.Model.BuddyList.getGroupMask(),
			b;
		...
		qa = function() {
			...
			da() ? a.addClass(h.EQQ_recentListPanel, "EQQ_List_BigHead") : a.removeClass(h.EQQ_recentListPanel, "EQQ_List_BigHead")
		},
		...
		Ua = function(c) {
			c.preventDefault();
			if (!H) H = ! 0,
			k = h.EQQ_MySignature.value,
			g.on(h.EQQ_MySignature, "blur", na),
			a.addClass(h.EQQ_MySignature_wraper, "EQQ_MySignature_edit"),
			h.EQQ_MySignature.focus(),
			h.EQQ_MySignature.select(),
			pgvSendClick({
		...
		na = function() {
			za();
			h.EQQ_MySignature.value == k ? h.EQQ_MySignature.title = k: (h.EQQ_MySignature.title = "\u7b7e\u540d\u66f4\u65b0\u4e2d:" + h.EQQ_MySignature.value, alloy.rpcService.sendSetSignature(h.EQQ_MySignature.value), alloy.util.report2im("personalinfo|personalmsg|personalmsgedit"))
		},
		Wa = function(a) {
			switch (a.keyCode) {
			case 13:
		...
		Aa = function(a, b) {
			...
			if (d.replace(/[^\x00-\xff]/g, "aaa").length > b) a.value = c.string.cutRight(d, 1),
			Aa(a, b)
		},
		Xa = function() {
		...
		this.init = function() {
			...
			g.on(this.EQQ_SearchButton, "click", c.bind(function() {
				if (r) h.hideSearchResult(),
				g.notifyObservers(h, "StartChat", r.uin),
				r = null,
			...
			g.on(this.EQQ_createDiscuButton, "click", this.onCreateDiscu);
		...
		this.createStatePanelDom = function() {
			...
			g.on(this.EQQ_SetSound, "click", Ka);
		...
		this.setGroupMaskState = function(c) {
		...
		this.setGroupListMaskState = function(c, b) {
			var d = a.id("EQQ_GroupList_State_" + c),
			f = a.id("EQQ_RecentList_State_" + c);
		...
		this.showGroupMaskStatePanel = function(a) {
			...
			if (a) {
				var c = this.groupMaskPanel.getWidth(),
				b = this.groupMaskPanel.getHeight(),
		...
		this.createMiniCardPanelDom = function() {
			...
			p = a.id("miniCard_qzone"),
			q = a.id("miniCard_qmail"),
			...
			this.miniCardPanel.setInfo = function(b) {
				...
				f.src = b.avatarUrl;
				d ? (Q.innerHTML = "\u4fee\u6539\u8d44\u6599", f.src = alloy.util.getUserAvatar(b.uin, 1) + "&t=" + (new Date).getTime(), a.hide(s)) : (Q.innerHTML = "\u8be6\u7ec6\u8d44\u6599", a.show(s));
				c.platform.iPad && a.hide(s);
				...
				d || b.clientType == "1" || b.clientType == "10000" || b.type == "stranger" || ! b.clientType ? (k.className = "miniCard_clientType_innerWrapper", l.style.display = "block") : (k.className = "miniCard_clientType_" + EQQ.hash.clientType[b.clientType || "10000"], d = EQQ.hash.clientTypeText[b.clientType || "10000"], d = EQQ.hash.clientTypeText2readableText[d] || d, j.innerHTML = d + "\u767b\u5f55\u4e2d", l.style.display = "none");
			...
			this.miniCardPanel.setClientType = function(a) {
				if (this.uin == a.uin) a.clientType == "1" ? (k.className = "miniCard_clientType_" + EQQ.hash.clientType[a.clientType || "10000"], j.innerHTML = EQQ.hash.clientTypeText[a.clientType || "10000"] + "\u767b\u5f55\u4e2d", l.style.display = "none") : (k.className = "miniCard_clientType_innerWrapper", l.style.display = "block")
			};
			this.miniCardPanel.setQQLevel = function(a) {
				...
				n.innerHTML = l;
				n.title = "\u7b49\u7ea7: " + b;
				if (a.uin == alloy.portal.getUin()) o.innerHTML = '<div class="miniCard_level_upinfo_div" title="\u6d3b\u8dc3\u5929\u6570\uff1a' + c.days + '"><span class="icon days"></span>' + c.days + '\u5929</div><div class="miniCard_level_upinfo_div" title="\u8ddd\u5347\u7ea7\u5230' + (b + 1) + "\u7ea7\u8fd8\u6709" + c.remainDays + '\u5929"><span class="icon remainDays"></span>' + c.remainDays + "\u5929</div>"
			}
		};
		this.showMiniCardPanel = function(a, c) {
			this.miniCardPanel || this.createMiniCardPanelDom();
			if (c) {
				var b = this.miniCardPanel.getWidth() + 10,
		...
		this.onEqqResize = function(c) {
			...
			a.setStyle(this.EQQ_Logining_Container, "height", c - 2 + "px");
		...
		this.onSearchBoxKeydown = function(c) {
			...
			case 38:
				...
				break;
			case 40:
				A < E.length - 1 && (c = a.id("EQQ_SearchResultItem_" + r.uin), a.removeClass(c, "EQQ_SearchResultItemHover"), A++, r = E[A], (c = a.id("EQQ_SearchResultItem_" + r.uin)) && a.addClass(c, "EQQ_SearchResultItemHover"))
			}
		};
		...
		this.updateSelfStateChange = function(c) {
			a.setClass(this.EQQ_MyStateShow, "EQQ_myStateShow EQQ_" + c);
			c === "offline" ? a.addClass(this.EQQ_MyAvatar, "EQQ_myAvatar_offline") : a.removeClass(this.EQQ_MyAvatar, "EQQ_myAvatar_offline")
		};
		this.updateSelfSignatureChange = function(a) { (k = a = a.signature) || (a = "\u70b9\u51fb\u7f16\u8f91\u7b7e\u540d");
		...
		this.addBuddyClass = function(b, d) {
			...
			if (b.caculateName) {
				var l = p.getCharWidth(b.caculateName + ("[" + b.onlineCount + "/" + (b.count || 1) + "]"), 12);
				if (l > 120) l = {
					index: b.index,
					len: l,
					html: b.cut_htmlName
		...
		this.collapsedClass = function(c) {
			var b = a.id("EQQ_listClassHead_" + c),
			d = a.id("EQQ_listClassBody_" + c);
			c == EQQ.hash.userClassType.online ? (a.setClass(b, "EQQ_onlineClassHeadCollapsed"), a.removeClass(b, "expand_online")) : (a.setClass(b, "EQQ_listClassHeadCollapsed"), a.removeClass(b, "expand"));
		...
		var ga = this.loadBuddyListAvatar = function() {
			...
			if (aa()) {
				...
				b = a.getXY(b)[1];
				for (f = 0; f < u.length;) g = u[f],
				e = g.el,
				l = g.uin,
				g = g.classId,
				i = a.getXY(e)[1] - b,
				h.getClassExpandFlag(g) && e && i > 0 && i < d ? (e.hasSign || EQQ.Model.BuddyList.getUserSignature(l), u.splice(f, 1)) : f++
			}
		},
		fa = function() {
			la()
		...
		la = function() {
			if (fa.timer) window.clearTimeout(fa.timer),
			fa.timer = null;
		...
		this.removeBuddy = function(b) {
			...
			if (c) {
				...
				g.off(c, "click");
				g.off(c, "contextmenu");
				if (b = a.id("EQQ_BuddyList_AvatarContainer_" + b)) g.off(b, "mouseover"),
				g.off(b, "mouseout");
		...
		this.removeOnlineBuddy = function(b) {
			...
			if (c) {
				...
				g.off(c, "click");
				g.off(c, "contextmenu");
				if (b = a.id("EQQ_OnlineBuddyList_AvatarContainer_" + b.uin)) g.off(b, "mouseover"),
				g.off(b, "mouseout");
				c.parentNode && c.parentNode.removeChild(c);
				return ! 0
			} else return ! 1
		...
		this.moveBuddy = function(b) {
			...
			if (d && c) {
				...
				l = a.id("EQQ_RecentList_RightContainer_" + b.uin),
		...
		this.addRecent = function(b) {
			if (b.content) if (b.type == 0) {
				...
				a.addClass(f, "EQQ_GroupList_Group");
				e === "recent" && da() ? EQQ.Model.BuddyList.getGroupAnnouncement(b.code) : (d = a.id("EQQ_GroupRecentList_Bulletin_" + b.gid), I.push({
					gcode: b.code,
					el: d
				}))
			} else if (b.type == 2) {
		...
		this.removeRecentBuddy = function(b) {
			...
			if (c) {
				...
				g.off(c, "click");
				g.off(c, "contextmenu");
				if (b = a.id("EQQ_RecentList_AvatarContainer_" + b.uin)) g.off(b, "mouseover"),
				g.off(b, "mouseout");
				c.parentNode && c.parentNode.removeChild(c)
			}
		};
		...
		this.setMode = function(b) {
			...
			case "slave":
				...
				this.EQQ_MyState.title = "Q+ Web\u73b0\u5728\u5904\u4e8e\u8f85\u6a21\u5f0f\uff0c\u8bf7\u4ece\u5ba2\u6237\u7aefQQ\u4fee\u6539\u60a8\u7684\u5728\u7ebf\u72b6\u6001\u3002"
			}
		};
		...
		this.removeGroup = function(b) {
			...
			if (f && (g.off(f), f.parentNode)) d = f.parentNode,
			d.removeChild(f);
			c.out(f);
			if (b = a.id("EQQ_Recent_" + b)) if (g.off(b), b.parentNode) d = b.parentNode,
			d.removeChild(b);
			c.out(b)
		}
	};
	...
	p = Jx().extend(function(d) {
		...
		this.updateBuddyClassOnlineBuddy = function(a) {
			...
			h.ifFlexReady && this.flex.updateBuddyClassOnlineBuddy(a)
		};
		...
		this.setUserName = function(a) {
			...
			h.ifFlexReady ? this.flex.setUserName(a) : recent.type == 2 && (a = this.getNewNode(recent.content, ! 0), this.EQQ_recentList.insertBefore(a, this.EQQ_recentList.firstChild), g.on(a, "mouseover", onListMouseover), g.on(a, "mouseout", onListMouseout), g.on(a, "click", function() {
				h.onDiscuListClick(this)
			}), g.on(a, "contextmenu", function(a) {
				var b = this.getAttribute("did");
				h.onDiscuContextMenu(a, b)
	...
	c);
	WebqCore.register("EQQ.View.MainPanelFlex", p)
})();
(function() {
	WebqCore.register("EQQ.Presenter.MainPanel", function(b) {
		...
		this.init = function() {
			...
			if (b.browser.ie && b.browser.ie == 7) {
				var d = b.GetSwfVer();
				d != - 1 ? (d = d.split(" ")[1].split(","), parseInt(d[0]) >= 10 ? (o = ! 0, this.View = EQQ.View.MainPanelFlex, c.addObserver(EQQ.Model.ChatMsg, "flexStartJump", b.bind(this.onFlexStartJump, this)), c.addObserver(EQQ.Model.ChatMsg, "flexStopJump", b.bind(this.onFlexStopJump, this))) : q()) : q()
			}
			...
			c.addObserver(alloy.portal, "selfInfoReady", b.bind(this.onSelfInfoReady, this));
			...
			c.addObserver(EQQ.Model.BuddyList, "GetUserInfoSuccess", b.bind(this.onGetUserInfoSuccess, this));
			...
			c.addObserver(EQQ.Model.BuddyList, "AddBuddy", b.bind(this.onAddANewBuddy, this));
			...
			c.addObserver(EQQ.Model.BuddyList, "SingleGroupMaskChange", b.bind(this.onSingleGroupMaskChange, this));
			...
			c.addObserver(EQQ.Model.ChatMsg, "MessageListChange", b.bind(this.onMessageListChange, this));
			...
			c.addObserver(this.View, "ExitPortal", b.bind(this.onExitPortal, this));
			...
			c.addObserver(EQQ.Model.BuddyList, "AddNewDiscuToList", b.bind(this.onAddNewDiscuToList, this));
			...
			c.addObserver(EQQ.Model.BuddyList, "DiscuInfoChange", L);
		...
		this.onBuddyListChange = function(a) { ! s && ! o && (this.updateAllBuddyClassCount(EQQ.Model.BuddyList.getClassList()), this.createBuddyList(a))
		};
		...
		var r = function() {
			...
			return b.isUndefined(a) || ! a ? 0: ! b.isUndefined(a.option) && a.option && ! b.isUndefined(a.option.userOrGroup) ? a.option.userOrGroup.uin || a.option.userOrGroup.gid || a.option.userOrGroup.did || 0: 0
		};
		...
		this.onMessageBoxGroupListChange = function(a) {
			...
			g = [];
			for (var d = 0; d < a.length; d++) b != a[d].from_uin && EQQ.Model.BuddyList.isGroupPrompt(a[d].from_uin) && g.push(a[d].from_uin),
			EQQ.Model.BuddyList.getSelfState() == "callme" && EQQ.Model.BuddyList.isGroupPrompt(a[d].from_uin) && e(a[d].group_code);
			g.length !== 0 && (EQQ.addNeedBeat2("mainPanel"), c.addObserver(EQQ, "NotifyBeat_250", D))
		};
		this.onMessageListChange = function(a) { (a = EQQ.Model.BuddyList.getBuddyByUin(a.uin)) && this.View.updateRecentByBuddy(a)
		};
		this.onGroupMessageListChange = function(a) { (a = EQQ.Model.BuddyList.getGroupByGid(a.gid)) && this.View.updateRecentByGroup(a)
		};
		this.onDiscuMessageListChange = function(a) { (a = EQQ.Model.BuddyList.getDiscuById(a.did)) && this.View.updateRecentByDiscu(a)
		};
		var E = function() {
			EQQ.Model.BuddyList.sendGetRecentList()()
		},
		...
		this.onMessageBoxDiscuListChange = function(a) {
			...
			w.length !== 0 && (EQQ.addNeedBeat2("mainPanel"), c.addObserver(EQQ, "NotifyBeat_250", D))
		};
		var P = function(a) {
...
(function() {
	WebqCore.register("EQQ.TaskBar", function(b) {
		...
		this.init = function() {
			...
			c.addObserver(alloy.taskBar, "TaskBarNotifyBeatStop", h);
